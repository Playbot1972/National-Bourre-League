...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	function Ha(e) {
		...
		function f(e, t, n) {
			...
			if (typeof t == "object" && t) {
				...
				if (E(t) || oe(t)) return t = bi(t, e.mode, n, null), t.return = e, t;
	...
	function Nc(e, t, n) {
		switch (t.tag) {
			case 3:
				j(t, t.stateNode.containerInfo), ea(t, P, e.memoizedState.cache), Ji();
				break;
			case 27:
			case 5:
				ve(t);
	...
	function Pc(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 27: return ve(t), e === null && N && (r = t.stateNode = ff(t.type, t.pendingProps, he.current), Bi = t, Hi = !0, i = M, Zd(t.type) ? (lf = i, M = cf(r.firstChild)) : M = i), oc(e, t, t.pendingProps.children, n), gc(e, t), e === null && (t.flags |= 4194304), t.child;
			...
			case 4: return j(t, t.stateNode.containerInfo), r = t.pendingProps, e === null ? t.child = Ua(t, null, r, n) : oc(e, t, r, n), t.child;
	...
	function Bc(e, t, n) {
		...
		switch (Ri(t), t.tag) {
			...
			case 27:
				if (ye(t), n = he.current, i = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Fc(t);
				else {
					if (!r) {
						if (t.stateNode === null) throw Error(s(166));
						return H(t), null;
					}
					e = pe.current, qi(t) ? Gi(t, e) : (e = ff(i, r, n), t.stateNode = e, Fc(t));
				}
				return H(t), null;
			case 5:
			...
			case 19:
				...
				return r.tail === null ? (H(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Me(), e.sibling = null, n = F.current, A(F, i ? n & 1 | 2 : n & 1), N && Fi(t, r.treeForkCount), e);
			case 22:
	...
	function Au(e, t) {
		...
		while (1);
		return $i = Qi = null, D.H = r, D.A = i, G = n, q === null ? (K = null, J = 0, si(), X) : 0;
	}
	function ju() {
		for (; q !== null && !Ae();) Mu(q);
	}
...
function Ke({ children: e }) {
	let { settings: t } = pe(), n = t.layoutMode === "tiled", r = Ge();
	return /* @__PURE__ */ (0, g.jsx)("div", {
		className: [
			"btable-desktop",
...
}, Ye = null, Xe = null, Ze = !1, Qe = /* @__PURE__ */ new Map(), $e = /* @__PURE__ */ new Map();
function et() {
	if (typeof window > "u") return null;
	try {
		let e = window.AudioContext ?? window.webkitAudioContext;
		return e ? (Ye || (Ye = new e(), Xe = Ye.createGain(), Xe.gain.value = .55, Xe.connect(Ye.destination)), Ye) : null;
	} catch {
		return null;
	}
}
...
function nt(e) {
	...
	try {
		let t = Qe.get(e);
		return t || (t = new Audio(e), t.preload = "auto", Qe.set(e, t)), t;
	} catch {
		return null;
	}
}
async function rt(e) {
	if ($e.has(e)) return $e.get(e) === !0;
...
async function it() {
	Ze && await Promise.all(Object.values(Je).map(async (e) => {
		if (!await rt(e)) return;
		let t = nt(e);
		if (t) try {
			t.load();
		} catch {}
...
async function at(e, t = .55) {
	if (!Ze || !await rt(e)) return !1;
	let n = nt(e);
	if (!n) return !1;
	try {
...
function ot(e, t, n, r, i, a, o = "sine") {
...
function ct() {
	...
	for (let n of [
		...
		.2,
		.28
	]) st(e, Xe, t + n, .05, .08 + Math.random() * .04);
}
function lt() {
	let e = et();
	if (!e || !Xe) return;
	let t = e.currentTime;
	ot(e, Xe, 880, t, .12, .09, "sine"), ot(e, Xe, 1174.66, t + .07, .16, .07, "triangle"), ot(e, Xe, 1760, t + .14, .1, .04, "sine");
}
function ut() {
	let e = et();
	if (!e || !Xe) return;
	let t = e.currentTime;
	ot(e, Xe, 659.25, t, .14, .08, "sine"), ot(e, Xe, 830.61, t + .1, .18, .09, "triangle"), ot(e, Xe, 987.77, t + .22, .22, .1, "sine"), ot(e, Xe, 1318.51, t + .34, .28, .06, "triangle");
}
...
var ft = { current: !1 }, pt = { current: !1 }, mt = { current: !1 };
function ht() {
	dt(Je.shuffle, ct, ft, 360);
}
function gt() {
	dt(Je.trickWin, lt, pt, 320);
}
function _t() {
	dt(Je.bigWin, ut, mt, 580);
}
function vt() {
...
function St(e) {
	try {
		return bt(e) ? !0 : yt() ? navigator.vibrate(xt[e]) ?? !1 : !1;
	} catch {
		return !1;
	}
}
function Ct() {
	return yt() || !!(typeof window < "u" && window.BourreHaptics);
}
//#endregion
//#region src/table/feedback/prefs.ts
var wt = "nbl-feedback", Tt = {
	soundEnabled: !0,
	hapticsMode: "on"
};
function Et(e) {
...
function Gt(e = {}) {
	...
	Bt = window.setTimeout(() => {
		Bt = null, Lt = Date.now(), t.soundEnabled && ht(), Ut("light");
	}, n);
}
function Kt() {
	let e = Ht(), t = Date.now();
	t - Rt < Ft || (Rt = t, e.soundEnabled && gt(), Ut("medium"));
}
function qt() {
	let e = Ht(), t = Date.now();
	t - zt < It || (zt = t, e.soundEnabled && _t(), Ut("strong"));
}
//#endregion
...
function dn(e) {
	let { tricksByPlayer: t, participantIds: n, players: r, pot: i, pendingVotes: a = {} } = e, o = ge(t, n), s = e.winnerIds?.length ? e.winnerIds : o.winnerIds, c = e.maxTricks ?? o.maxTricks, l = ln(s, r), u = un(t, n), d = ln(u, r), f = j(i.maxWinThisHand), p = j(i.currentPot), m = i.carryIn > 0 ? j(i.carryIn) : null, h = `Pot this hand: ${p} (max win ${f})`;
...
function pn({ session: e, players: t, potMetrics: n, mySessionNet: r, myHandContribution: i, leaderLabel: a, showCoWinSettlement: o, splitSharePerWinner: s = 0, enrollmentActive: c = !1, enrollmentSecondsLeft: u = 0, currentUserId: d, heroCards: f = [], privateHandReady: p = !1, legalPlayIndices: m, handComplete: h = !1, actionFeedback: _, actions: v }) {
	let { settings: y } = pe(), b = Ge(), [x, S] = (0, l.useState)(!1), C = e.participantIds.length, { events: w, dismissEvent: ee, pushReaction: te } = $t({
		session: e,
		potMetrics: n,
		participantIds: e.participantIds
	}), ne = d != null && (e.pendingCoWinSettlement?.winnerIds || []).includes(d), T = t.find((e) => e.isSelf && e.canToggleInHand), ie = sn({
		phase: e.phase,
		currentTrick: e.currentTrick,
		tricksByPlayer: e.tricksByPlayer,
		participantIds: e.participantIds,
		trumpSuit: e.trumpSuit
	}), se = re(e.phase, c), ce = ie.suppressTurnPlayerId ? null : oe(e.turnPlayerId, t), E = ae(e.phase), D = !!(d && e.turnPlayerId === d) && !ie.suppressTurnPlayerId, O = {
		currentPot: n.currentPot,
		maxWinThisHand: n.maxWinThisHand,
		limEnabled: n.limEnabled,
		overflow: n.overflow,
	...
	return (0, l.useEffect)(() => {
		...
		children: [
			...
			/* @__PURE__ */ (0, g.jsx)(Ke, { children: /* @__PURE__ */ (0, g.jsxs)("div", {
...
var mn = null, hn = null;
function gn(e, t) {
	Wt(), hn !== e && (mn?.unmount(), mn = (0, u.createRoot)(e), hn = e), mn.render(/* @__PURE__ */ (0, g.jsx)(A, { children: /* @__PURE__ */ (0, g.jsx)(pn, { ...t }) }));
}
function _n() {
