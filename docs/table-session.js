...
function om(e, t, n = !1, r = 220) {
	return t.length < 1 ? im(1, n, r) : nm({
		handNumber: e,
		playerIds: t,
		reducedMotion: n,
		travelMs: r
...
function sm(e, t, n = !1) {
	return t.length < 1 ? rm(1, n) : am(e, t, n, 220);
}
var cm = 5e3, lm = 1e3, um = 12e3, dm = 4e3, fm = Xf;
function pm(e = sp()) {
...
function Am({ aspect: e, enabled: t = !0, sessionKey: n }) {
	let r = (0, l.useRef)(null), i = (0, l.useRef)(0), a = (0, l.useRef)(0), o = (0, l.useRef)(n), { settings: s } = _d(), c = Tm();
	return (0, l.useLayoutEffect)(() => {
...
function Gm({ session: e, heroCards: t, privateHandReady: n = !1, tableRootRef: r }) {
	...
	return (0, l.useLayoutEffect)(() => {
		let t = r.current;
		t && s.current !== e.handNumber && (s.current = e.handNumber, o.current = null, Um(), Hm(t), wd(!1), a(!1));
		...
		let f = Im(d, 5);
		if (!f.length) return;
		o.current = l, Um(), Hm(i), i.classList.add("btable-wrap--clockwise-dealing"), a(!0), wd(!0);
		...
		return () => {
			window.cancelAnimationFrame(m), window.clearTimeout(h), Um(), i.classList.remove("btable-wrap--clockwise-dealing"), wd(!1), a(!1);
		};
	}, [
		e.handNumber,
		e.phase,
...
function th(e, t, n, r, i, a, o, s, c) {
	...
	let u = $i(l), d = r.left + r.width / 2, f = r.top + r.height / 2, p = i.left + i.width / 2, m = i.top + i.height / 2, h = na(u, {
		...
		width: u.width,
		height: u.height
	}), g = p - d, _ = m - f, { midX: v, midY: y } = Xm(g, _);
	J.set(l, {
		x: h.x,
		y: h.y,
		scale: a ? 1 : .72,
...
function nh(e, t, n, r, i, a, o, s = 0) {
	let c = Qm(e, n), l = Zm(n);
	if ($m(c, l, s)) {
		requestAnimationFrame(() => nh(e, t, n, r, i, a, o, s + 1));
		return;
	}
	if (!c || !l) {
		eh(e, t, o);
...
function ih() {
	...
	if (Jm.clear(), kd(), typeof document < "u") for (let e of document.querySelectorAll(".bpot__ante-chip--fly")) e.remove();
}
function ah({ handNumber: e, playerIds: t, root: n, delayPlan: r, presentationKey: i, onCoinLand: a, onComplete: o }) {
	Ko(n), ih();
	let s = sp(), c = Ym(s), l = Km(r ?? nm({
		handNumber: e,
		playerIds: t,
		reducedMotion: s,
		travelMs: c,
	...
	if (Jm.add(u), i && Dd(i, () => u.time()), !t.length) return u.call(() => o?.()), u;
	for (let e of l) u.call(() => {
		nh(e.playerId, e.seatIndex, n, s, e.travelSec, e.settleSec, a);
	}, void 0, e.coinSpawnSec);
	return u;
}
//#endregion
//#region src/table/hooks/useTableAntePresentation.ts
function oh({ anteAnimActive: e, session: t, tableRootRef: n }) {
	let r = (0, l.useRef)(null), i = (0, l.useRef)(t.handNumber);
	(0, l.useLayoutEffect)(() => {
		let e = n.current;
		e && i.current !== t.handNumber && (i.current = t.handNumber, r.current = null, ih(), Ed(!1), e.classList.remove("btable-wrap--ante-coins"));
	}, [t.handNumber, n]), (0, l.useLayoutEffect)(() => {
		let i = n.current;
		if (!i || !e) return;
		let a = `${t.sessionId}:${t.handNumber}:ante`;
		if (r.current === a) return;
		let o = bp(t.participantIds, t), s = lc(t.dealerId, t.participantIds, o.length ? o : t.participantIds);
		...
		if (Rd()) {
			for (let e = 0; e < s.length; e += 1) zd("antePresentation", "bot-timing-seat", {
				handNumber: t.handNumber,
				playerId: s[e],
				actionType: "ante",
				thinkBeforeMs: l.thinkBeforeMs[e],
				delayRange: "250-700"
			});
			zd("antePresentation", "bot-timing-plan", {
				handNumber: t.handNumber,
				seatCount: s.length,
				totalThinkMs: l.totalThinkMs,
				totalDurationMs: l.totalDurationMs,
				actionType: "ante"
			});
		}
		r.current = a, ih(), i.classList.add("btable-wrap--ante-coins"), Ed(!0);
		let u = am(t.handNumber, s, c), d = om(t.handNumber, s, c) + 200, f = () => Ed(!1), p = window.setTimeout(f, u), m = window.requestAnimationFrame(() => {
			ah({
				handNumber: t.handNumber,
				playerIds: s,
				delayPlan: l,
				...
				root: i,
				onComplete: () => {
					i.classList.remove("btable-wrap--ante-coins");
				}
			});
		}), h = window.setTimeout(() => {
			ih(), i.classList.remove("btable-wrap--ante-coins"), f();
		}, d);
		return () => {
			window.cancelAnimationFrame(m), window.clearTimeout(p), window.clearTimeout(h), f();
		};
	}, [
		e,
		t.sessionId,
...
function uh({ tableRootRef: e, trumpMergeActive: t, isTrumpHolder: n, onComplete: r }) {
...
var hh = /* @__PURE__ */ new Set(), gh = /* @__PURE__ */ new Set(), _h = I.drawDiscard;
function vh(e, t) {
	return {
		midX: e * .5,
		midY: t * .5
...
function bh() {
	for (let e of gh) J.set(e, { clearProps: "opacity,transform,willChange,zIndex" });
	gh.clear();
}
function xh(e) {
	let t = e instanceof Document ? e : e.ownerDocument ?? document;
...
function Oh(e, t) {
	Ko(t.root ?? document);
	let n = z(), r = t.root ?? document, i = t.host ?? (r instanceof HTMLElement ? r : document.body), a = yh(t.winnerPlayerId, r), o = n ? .06 : 140 / 1e3, s = R(_h, n), c = n ? .03 : .05, l = [], u = (e) => {
		hh.delete(d);
	...
	hh.add(d), e.forEach((e, r) => {
		...
		l.push(f), gh.add(e), J.set(e, { opacity: 0 });
		let p = $i(f);
		J.set(f, {
			transformOrigin: "50% 50%",
			willChange: "transform,opacity",
...
var jh = new Set(["nextLeadReady", "live"]);
function Mh({ trickPresentation: e, handNumber: t, sessionPhase: n = null, handComplete: r = !1, tableRootRef: i, onTrickCollectionStart: a }) {
	...
	(0, l.useLayoutEffect)(() => {
		...
		c.current = r;
		let s = i.current;
		if (!s || (n === "collectTrick" && jh.has(r) && (o.current = null, f(s)), r !== "collectTrick")) return;
		let l = e.trickWinnerSeatId, u = e.frozenTrick;
		if (!l || !u) return;
		let p = `${u.trickNumber}:${l}:${u.plays.length}`;
		if (o.current === p) return;
		o.current = p, d(), wh(), Ph(s);
		let m = Ah(s);
		if (!m.length) return;
		let h = Math.max(0, (e.displayTricksByPlayer[l] ?? 1) - 1), g = mh({
			playerId: l,
			handNumber: t,
...
function Fh({ trickPresentation: e, currentUserId: t = null, participantCount: n, trickNumber: r, sessionPhase: i = null }) {
...
function Bh(e, t) {
	return Rh(t) ? Rh(e) ? zh(t) >= zh(e) ? t : e : t : e;
}
function Vh(e) {
	let t = e?.phase ?? null;
...
function Hh(e) {
	...
	if (Rh(t) && Rh(n)) {
		...
		return e && n?.phase === "draw" && o === 0 && a === 0 && r > 0 && i === 0 ? t : Bh(t, n);
	}
	if (Rh(t)) return t;
	if (r === "draw" || r === "play" || r === "reveal" || r === "decision") {
		if (Rh(n)) {
			let i = Df(n?.tricksByPlayer ?? {}, n?.participantIds ?? []);
			return Lh(t) && i === 0 && r === "draw" && !e?.liveEnrollment?.active ? Ih() : n;
		}
		return n?.phase ? n : Vh(t) ? t : Lh(t) ? Ih() : t;
	}
	return r && n ? n : t;
}
function Uh(e) {
	let t = Hh(e), n = t?.phase ?? null;
...
new Map(Jh.map((e) => [Yh(e.from, e.event), e.to]));
function Xh(e) {
	return typeof e == "string" && e.startsWith("bot_");
}
function Zh(e, t) {
	return !e || !t ? !1 : e === t ? !0 : Xh(e);
}
function Qh() {
	return {
		tricksByPlayer: {},
...
function $h(e) {
	let t = e.session, n = t ? Hh(t) : Qh(), r = n.phase ?? null, i = n.participantIds ?? [], a = n.tricksByPlayer ?? {}, o = Df(a, i), s = i.length > 0 && Of(a, i), c = !!t?.pendingCoWinSettlement?.winnerIds?.length, l = t ? Uh(t) : null, u = Gh(r, n.handDecision ?? null), d = Wh({
...
function lg({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: u = !1, showTrumpSuitReminder: d = !1, trumpHolderPresentation: f, privateHandReady: p = !1, currentUserId: m = null, legalPlayIndices: h, recommendedPlayIndex: _, recommendedDiscardIndices: v = [], handComplete: y = !1, actionFeedback: b, trickPresentation: x, handPresentation: S, microinteractions: C, instantTrickPlays: w = !1, turnCountdown: T = null, bigPotEvent: E = null, onDismissTableEvent: D, onToggleInHand: O, onPassEnrollment: k, onTrickDelta: A, onSubmitDraw: j, onPassDraw: M, onFoldDraw: N, onPlayCard: ee, onReaction: te, onHeroUserActivity: P }) {
	...
	})), I = xp(F, e, m), L = I.length, R = `btable--p${Math.min(8, Math.max(2, L))}`, z = Kf(L), B = Object.fromEntries(F.map((e) => [e.playerId, e.displayName])), V = pm(), H = e.sessionId, U = Am({
		aspect: z,
		sessionKey: H
	});
	(0, l.useEffect)(() => {
	...
	let se = new Set(e.participantIds.filter((t) => Af(t, x.displayTricksByPlayer, e.participantIds, e.phase))), ce = F.map((t) => {
		let r = x.displayTricksByPlayer[t.playerId] ?? 0, i = x.trickWinnerSeatId === t.playerId, a = x.suppressTurnPlayerId || S.suppressTurnIndicator, o = x.phase === "collectTrick" && i, s = S.enrollmentPulse[t.playerId], c = S.animatingDrawPlayerId === t.playerId, l = cg(t.playerId, f, e.trumpUpcard ?? null, t.holeCardCount ?? 0, t.isSelf);
		return {
			...t,
			...l,
...
var dg = "(orientation: portrait)";
function fg() {
	let e = Tm(), [t, n] = (0, l.useState)(() => typeof window < "u" && window.matchMedia(dg).matches);
	return (0, l.useEffect)(() => {
		let e = window.matchMedia(dg), t = () => n(e.matches);
...
function gg({ aspect: e, sessionKey: t }) {
	let n = (0, l.useRef)(null), r = (0, l.useRef)(0), i = (0, l.useRef)(0), a = (0, l.useRef)(t), o = fg(), { settings: s } = _d(), c = o === "mobile-portrait";
	return (0, l.useLayoutEffect)(() => {
		...
		let l = window.visualViewport, u = () => {
			if (lf()) return;
			let t = hg(o).getBoundingClientRect(), n = o.querySelector(".btable-mobile-hero-dock")?.getBoundingClientRect(), a = !!o.closest(".table-play-overlay"), u = c ? 104 : 92, d = c ? 210 : 168, f = gm(n?.height ?? 0, r.current, u, d);
			r.current = f.peak;
...
function _g({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: u = !1, showTrumpSuitReminder: d = !1, trumpHolderPresentation: f, privateHandReady: p = !1, currentUserId: m = null, legalPlayIndices: h, recommendedPlayIndex: _, recommendedDiscardIndices: v = [], handComplete: y = !1, actionFeedback: b, trickPresentation: x, handPresentation: S, microinteractions: C, instantTrickPlays: w = !1, turnCountdown: T = null, bigPotEvent: E = null, onDismissTableEvent: D, onToggleInHand: O, onPassEnrollment: k, onTrickDelta: A, onSubmitDraw: j, onPassDraw: M, onFoldDraw: N, onPlayCard: ee, onHeroUserActivity: te }) {
	let P = fg() === "mobile-landscape" ? "landscape" : "portrait", F = t.map((e) => ({
		...e,
		isSelf: e.isSelf || m != null && e.playerId === m
	})), I = xp(F, e, m), L = I.filter((e) => !e.isSelf), R = I.find((e) => e.isSelf), z = R ? qp(I.length, P) : null, B = I.length, V = `btable--p${Math.min(8, Math.max(2, B))}`, H = ug(L.length, P), U = Object.fromEntries(t.map((e) => [e.playerId, e.displayName])), ne = pm(), re = e.sessionId, W = gg({
		aspect: H,
		sessionKey: re
	});
	(0, l.useEffect)(() => {
...
var vg = new Set(["pot-cap", "hand-win"]);
function yg({ events: e, onDismiss: t }) {
	let n = [...e].reverse().find((e) => vg.has(e.kind));
	return (0, l.useEffect)(() => {
		if (!n) return;
...
function bg({ children: e }) {
	let { settings: t } = _d(), n = t.layoutMode === "tiled", r = Tm();
	return /* @__PURE__ */ (0, g.jsx)("div", {
		className: [
			"btable-desktop",
...
function Og({ session: e, potMetrics: t, participantIds: n }) {
...
function Gg(e, t) {
	...
	let r = e.displayDrawCompletedIds.includes(n) ? e.displayDrawCompletedIds : [...e.displayDrawCompletedIds, n], i = Bg(e, n), a = t == null ? e.prevSnapshot : {
		...t,
		drawCompletedIds: [...r]
	};
	return Wg("payload", e, {
...
function qg(e, t, n, r, i, a) {
	return Lg(e, n) ? (Ug(e, t, null, `consumed-skip:${n}:${a}`), e) : Rg(e) && e.animatingDrawPlayerId !== n ? (Ug(e, t, null, `in-flight-skip:${a}`), e) : (Ug(e, t, n, a), Pg(e, "drawPlayer", {
		animatingDrawPlayerId: n,
		drawAnimSubPhase: Kg(r, i),
		drawDiscardCount: r,
		drawReplaceCount: i,
		prevSnapshot: t,
		drawPresentationConsumedIds: Bg(e, n)
	}));
}
function Jg(e) {
	if (!e.pendingHandSettle || e.phase !== "play") return e;
	let t = e.handSettleSnapshot ?? e.prevSnapshot;
	return t ? Pg(e, "settle", {
		pendingHandSettle: !1,
		handSettleSnapshot: null,
		settleAnimActive: !0,
...
function Xg(e, t, n, r) {
	...
	return i ? qg(e, t, i, n, r, "beginDrawSequence") : Pg(e, "drawPlayer", {
...
function Qg(e, t) {
	switch (t.type) {
		case "reset": return Ng(t.snapshot);
		...
		case "watchdog": return e.pendingHandSettle && e.phase === "play" ? Jg(e) : Date.now() - e.phaseStartedAt < 12e3 ? e : $g({
			...e,
			pendingSnapshot: e.pendingSnapshot ?? e.prevSnapshot
		});
		case "tryBeginHandSettle": return Jg(e);
		case "advancePhase": return $g(e);
		case "serverUpdate": {
			...
			let o = kg(a.trumpUpcard), s = kg(n.trumpUpcard);
			...
			if (n.phase === "play" && e.phase !== "play") return Pg(e, "play", {
			...
			if (Ag(e.phase) && e.phase !== "drawPlayer" || e.phase === "drawPlayer" && e.drawAnimSubPhase !== "done") return {
				...e,
				pendingSnapshot: n
			};
			...
			let c = Fg(a, n), l = Object.keys(c).length > 0;
			...
			if (n.phase === "draw" && a.enrollmentActive && !n.enrollmentActive && e.phase === "enrollment") {
				let t = !!n.trumpUpcard;
				return Pg(e, t ? "trumpReveal" : "ante", {
					trumpRevealActive: t,
					anteAnimActive: !0,
			...
			if (n.phase === "draw" && (e.phase === "decision" || a.phase === "decision") && e.drawPresentationConsumedIds.length === 0 && e.displayDrawCompletedIds.length === 0 && e.phase !== "drawPlayer" && e.phase !== "drawReady") return Xg(e, n, 0, 0);
			if (n.phase === "draw") {
				let t = zg(e, n);
				t && (e = t);
				let o = Ig(e, a, n);
				if (o && e.phase !== "drawReady") {
					...
					if (!t && !Rg(e)) {
						...
						return qg(e, n, o, a, t ? i : a, "serverUpdate");
					}
					t ? Ug(e, n, null, "serverUpdate:animating-same-player") : Rg(e) && Ug(e, n, null, "serverUpdate:in-flight-other-player");
				} else o || Ug(e, n, null, "serverUpdate:no-candidate");
				if (n.drawCompletedIds.length === n.participantIds.length && n.participantIds.length > 0 && e.phase === "drawPlayer" && e.drawAnimSubPhase === "done") return Pg(e, "drawReady", { prevSnapshot: n });
			}
			return {
				...e,
				prevSnapshot: n,
...
function $g(e) {
	...
	switch (e.phase) {
		case "handReset": return Pg(e, "ante", {
			anteAnimActive: !0,
			pendingSnapshot: null
		});
		case "ante": return e.trumpRevealActive || t?.trumpUpcard ? Pg(e, "trumpReveal", {
			trumpRevealActive: !0,
			anteAnimActive: !1,
			pendingSnapshot: null
		}) : t?.phase === "draw" ? Xg(e, t, 0, 0) : Pg(e, "drawPlayer", {
			anteAnimActive: !1,
			pendingSnapshot: null
		});
		...
		case "drawPlayer": {
			...
			Wg("before", e);
			let n = e.animatingDrawPlayerId, r = Gg(e, t);
			Wg("after", r);
			let i = t ?? r.prevSnapshot;
			if (i && r.displayDrawCompletedIds.length >= i.participantIds.length) return Pg(r, "drawReady", {
				...
				drawPresentationConsumedIds: Vg(r, r.displayDrawCompletedIds)
			});
			if (i) {
				let e = {
					...i,
					drawCompletedIds: [...r.displayDrawCompletedIds]
				}, t = Hg(r, i, r.displayDrawCompletedIds);
				if (Wg("after", r, {
					playerId: n,
					nextCompleted: r.displayDrawCompletedIds,
					nextChosen: t
				}), t) return Ug(r, i, t, "advancePhase:nextPlayer"), qg(r, e, t, 1, 1, "advancePhase:nextPlayer");
				Ug(r, i, null, "advancePhase:no-next-player");
			}
			return r;
		}
		case "drawReady": return Pg(e, "play", { pendingSnapshot: null });
		case "settle": return Pg(e, "nextHandReset", {
			settleAnimActive: !1,
			nextHandResetActive: !0,
			pendingSnapshot: null
		});
		case "nextHandReset": return t ? Ng(t) : Pg(e, "idle", { nextHandResetActive: !1 });
		default: return e;
	}
}
function e_(e) {
...
function l_({ session: e, enrollmentActive: t, potAmount: n, handComplete: r, trickPipelineActive: i = !1, forceTrickHandEndDrain: a, heroCards: o = s_, enrolledIds: s = o_, declinedIds: c = o_, actionOrder: u }) {
	let d = e.participantIds.join(","), f = (e.drawCompletedIds ?? []).join(","), p = s.join(","), m = c.join(","), h = (u ?? e.participantIds).join(","), g = e.trumpUpcard ? `${e.trumpUpcard.rank}-${e.trumpUpcard.suit}` : "", _ = (0, l.useMemo)(() => jg({
		...
		m,
		h
	]), v = a_(e.sessionId, e.handNumber), y = _.phase ?? null, b = (0, l.useRef)(null), [x, S] = (0, l.useReducer)(Zg, _, Ng), C = (0, l.useRef)([]), w = (0, l.useRef)([]), T = (0, l.useRef)(null), E = (0, l.useRef)(x);
	E.current = x;
	let D = () => {
	...
	(0, l.useEffect)(() => () => D(), []), (0, l.useEffect)(() => {
		...
		let t = b.current, n = o.map((e) => `${e.rank}-${e.suit}`), r = c_(w.current, n);
		w.current = n, S({
			type: "serverUpdate",
			snapshot: _,
...
function __(e) {
	return e.handComplete ? null : e.ante?.anteAnimActive ? g_(e.ante) : h_(e);
}
function v_(e, t, n) {
...
function y_(e) {
	...
	return (0, l.useEffect)(() => {
		...
		countdown: i && o.current != null ? v_(i, o.current, c) : null,
		reducedMotion: sp()
	};
}
//#endregion
...
function M_({ currentUserId: e = null, localActionPending: t = !1, ...n }) {
	let r = n.ante?.anteAnimActive ? null : __(n), i = p_({
		...n,
		activeActorId: r
...
function J_(e, t) {
	let n = np(t.currentTrick), r = np(e.prevTrick), i = G_(e, t, n), a = e.phase === "live" && !e.pendingResolution && (n.length < e.revealedCount && r.length >= e.revealedCount || n.length < i.length && r.length >= i.length), o = t.currentTrick?.trickNumber ?? null, s = e.prevTrick?.trickNumber ?? null, c = o != null && s != null && o !== s;
	return {
		...e,
...
function av(e) {
	let { tricksByPlayer: t, participantIds: n, players: r, pot: i, pendingVotes: a = {} } = e, o = jf(t, n), s = e.winnerIds?.length ? e.winnerIds : o.winnerIds, c = e.maxTricks ?? o.maxTricks, l = rv(s, r), u = iv(t, n), d = rv(u, r), f = Mf(i.maxWinThisHand), p = Mf(i.currentPot), m = i.carryIn > 0 ? Mf(i.carryIn) : null, h = `Pot this hand: ${p} (max win ${f})`;
...
function fv(e, t, n) {
	...
	return (0, l.useEffect)(() => {
		if (f(), u.current !== t && (u.current = t, s.current = null, i(!1), o(!1), d.current = lv(n)), e) {
			if (s.current == null) {
				let e = Date.now();
				s.current = e, d.current = lv(n), i(!0), o(!1), Rd() && zd("tieResult", "shown", {
					proposalKey: t,
...
function xv({ session: e, players: t, potMetrics: n, mySessionNet: r, leaderLabel: i, showCoWinSettlement: a, splitPotEnabled: o = !1, rebuyEnabled: s = !1, splitSharePerWinner: c = 0, enrollmentActive: u = !1, currentUserId: d, heroCards: f = yv, rawHeroCards: p = yv, privateHandReady: m = !1, legalPlayIndices: h, recentBourreIds: _ = bv, handComplete: v = !1, actionFeedback: y, actions: b }) {
	let { settings: x } = _d(), S = Tm(), [C, w] = (0, l.useState)(!1), T = e.participantIds.length, { events: E, dismissEvent: D, pushReaction: O } = Og({
		session: e,
		potMetrics: n,
		participantIds: e.participantIds
	...
	let te = (0, l.useMemo)(() => {
		...
		c,
		d
	]), { visible: F, manualContinueAllowed: I } = fv(a, te, P), L = H_(e.phase, e.trumpUpcard, j.displayPlays.length), R = Jd(N.isPresenting, N.phase, e.phase), [z, B] = (0, l.useState)(0);
	...
	let V = Fs(e.phase), H = (0, l.useMemo)(() => og({
		...
		U.indexMode,
		U.trumpDisabledIndex
	]), G = j.suppressTurnPlayerId || N.suppressTurnIndicator, ae = Ns(e.phase, u), oe = G ? null : Rs(e.turnPlayerId, t), se = t.find((e) => e.isSelf), ce = d != null && e.participantIds.includes(d) && (e.phase === "draw" || e.phase === "play"), le = s && !e.isFinal && !ce && !F && se?.isOut === !0 && !!b.onRebuy, ue = ig({
		currentUserId: d,
		session: e,
		suppressTurn: !!G,
		handComplete: v,
	...
	let Se = (0, l.useCallback)((e) => {
		...
		S ? /* @__PURE__ */ (0, g.jsx)(_g, { ...we }) : /* @__PURE__ */ (0, g.jsx)(lg, { ...we })
	] }), Ee = (0, l.useRef)(!1);
	return (0, l.useEffect)(() => {
		Ee.current = !1;
		...
		children: [
			...
			S ? /* @__PURE__ */ (0, g.jsx)(xg, { children: /* @__PURE__ */ (0, g.jsxs)("div", {
			...
			}) }) : /* @__PURE__ */ (0, g.jsx)(bg, { children: /* @__PURE__ */ (0, g.jsxs)("div", {
				className: "btable-stage",
				children: [/* @__PURE__ */ (0, g.jsx)(B_, {
					actionFeedback: y,
					feedbackErrorPulse: ve.feedbackErrorPulse,
