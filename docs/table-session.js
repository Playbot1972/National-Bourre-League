...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	function oe(e) {
		V.current === e && (z(re), z(V)), U.current === e && (z(U), Qf._currentValue = te);
	}
	var se, ce;
	function le(e) {
		if (se === void 0) try {
	...
	function Dc(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 3:
				...
				return t;
			case 26: return lc(e, t), e === null ? (n = kf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : q || (n = t.type, e = t.pendingProps, r = Bd(H.current).createElement(n), r[$e] = t, r[et] = e, Pd(r, n, e), ft(r), t.stateNode = r) : t.memoizedState = kf(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
			case 27: return ae(t), e === null && q && (r = t.stateNode = ff(t.type, t.pendingProps, H.current), Ti = t, Oi = !0, i = Ei, Zd(t.type) ? (lf = i, Ei = cf(r.firstChild)) : Ei = i), $s(e, t, t.pendingProps.children, n), lc(e, t), e === null && (t.flags |= 4194304), t.child;
	...
	function Pc(e, t, n) {
		...
		switch (Ci(t), t.tag) {
			...
			case 27:
				if (oe(t), n = H.current, i = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Oc(t);
				else {
					if (!r) {
			...
			case 4: return W(), e === null && xd(t.stateNode.containerInfo), Nc(t), null;
			...
			case 19:
				...
				return r.tail === null ? (Nc(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = ye(), e.sibling = null, n = no.current, B(no, i ? n & 1 | 2 : n & 1), q && bi(t, r.treeForkCount), e);
			case 22:
	...
	function fu() {
		return Y & 2 && Z !== 0 ? Z & -Z : F.T === null ? Xe() : dd();
	}
	function pu() {
	...
	function ku(e, t) {
		...
		while (1);
		return zi = Ri = null, F.H = r, F.A = i, Y = n, X === null ? (Il = null, Z = 0, Kr(), Ul) : 0;
	}
	function Au() {
		for (; X !== null && !_e();) ju(X);
	}
	...
	function Hu() {
		...
		var e = iu, t = su;
		su = 0;
		var n = Ye(ou), r = F.T, i = I.p;
		try {
			I.p = 32 > n ? 32 : n, F.T = null, n = cu, cu = null;
			var a = iu, o = ou;
			if (ru = 0, au = iu = null, ou = 0, Y & 6) throw Error(s(331));
			var c = Y;
			if (Y |= 4, jl(a.current), Cl(a, a.current, o, n), Y = c, id(0, !1), G && typeof G.onPostCommitFiberRoot == "function") try {
...
function M({ card: e, index: t, size: n, state: r, badge: i, cardTestId: a, cardInteraction: o, onCardClick: s, onCardPeek: c, peekActive: u, slotClassFor: d, style: f }) {
	let [p, m] = (0, l.useState)(!1), h = o, v = h?.mode === "play", y = h?.mode === "draw-select", b = h?.mode === "peek", x = h?.isMyTurn === !0, S = !h?.legalPlayIndices || h.legalPlayIndices.includes(t), C = v && x && S && !h?.busy, T = v && !x && !!h?.allowPlayPreselect && S && !h?.busy, E = h?.playingIndex === t, D = v && x && !S && !h?.busy && !E, O = y && r === "draw-selected", k = y && r === "draw-recommended", A = r === "play-recommended", j = !!h?.busy || E || v && !x && !T || y && !x, M = j || v && !S && !T || y && !x, N = w({
		...
		onPressChange: m
	}), P = !!h && (h?.mode !== "none" || D), ee = v && x ? C ? a : "play-button-disabled" : a;
	return /* @__PURE__ */ (0, g.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, g.jsx)(_, {
			...
			onPlayClick: P && C ? () => h?.onPlayCard?.(t) : void 0,
...
var B = {
	...
	overwrite: !1,
	delay: 0
}, V, H, U, ie = 1e8, W = 1 / ie, ae = Math.PI * 2, oe = ae / 4, se = 0, ce = Math.sqrt, le = Math.cos, ue = Math.sin, de = function(e) {
	...
	return fe(e) || de(e);
}, ye = typeof ArrayBuffer == "function" && ArrayBuffer.isView || function() {}, be = Array.isArray, xe = /(?:-?\.?\d|\.)+/gi, Se = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Ce = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, we = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Te = /[+-]=-?[.\d]+/, Ee = /[^,'"\[\]\s]+/gi, De = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, Oe, G, ke, Ae, je = {}, Me = {}, Ne, Pe = function(e) {
	...
	return e && he(e) && "length" in e && (!t && !e.length || e.length - 1 in e && he(e[0])) && !e.nodeType && e !== G;
}, qt = function(e, t, n) {
	...
	return U && !t && U.selector ? U.selector(e) : de(e) && !n && (ke || !On()) ? Gt.call((t || Ae).querySelectorAll(e), 0) : be(e) ? qt(e, n) : Kt(e) ? Gt.call(e, 0) : e ? [e] : [];
}, Yt = function(e) {
	...
	return d = {
		...
		wake: function() {
			Ne && (!ke && _e() && (G = ke = window, Ae = G.document || {}, je.gsap = jr, (G.gsapVersions ||= []).push(jr.version), Pe(Me || G.GreenSockGlobals || !G.gsap && G || {}), hn.forEach(gn)), u = typeof requestAnimationFrame < "u" && requestAnimationFrame, c && d.sleep(), l = u || function(e) {
...
var Un = /*#__PURE__*/ function(e) {
	...
	return n.to = function(e, t, n) {
		...
		if (Oe._ts && (ot(Oe, Tt(e, Oe)), Ge = Dn.frame), Dn.frame >= Je) {
			Je += B.autoSleep || 120;
			var t = Oe._first;
...
var Wn = function(e, t, n, r, i, a, o) {
	...
	if (de(r) && (~r.indexOf("random(") && (r = cn(r)), r.charAt(1) === "=" && (p = rt(d, r) + (Ut(d) || 0), (p || p === 0) && (r = p))), !l || d !== r || Yn) return !isNaN(d * r) && r !== "" ? (p = new _r(this._pt, e, t, +d || 0, r - (d || 0), typeof u == "boolean" ? ur : lr, 0, f), c && (p.fp = c), o && p.modifier(o, this, e), this._pt = p) : (!u && !(t in e) && Fe(t, r), Wn.call(this, e, t, d, r, f, s || B.stringFilter, c));
	...
	var i = t.vars, a = i.ease, o = i.startAt, s = i.immediateRender, c = i.lazy, l = i.onUpdate, u = i.runBackwards, d = i.yoyoEase, f = i.keyframes, p = i.autoRevert, m = t._dur, h = t._startAt, g = t._targets, _ = t.parent, v = _ && _.data === "nested" ? _.vars.targets : g, y = t._overwrite === "auto" && !V, b = t.timeline, x, S, C, w, T, E, D, O, k, A, j, M, N;
	if (b && (!f || !a) && (a = "none"), t._ease = In(a, re.ease), t._yEase = d ? Pn(In(d === !0 ? a : d, re.ease)) : 0, d && t._yoyo && !t._repeat && (d = t._yEase, t._yEase = t._ease, t._ease = d), t._from = !b && !!i.runBackwards, !b || f && !i.stagger) {
		...
		for (t._pt = t._ptCache = 0, c = m && ge(c) || c && !m, S = 0; S < g.length; S++) {
			...
			t._op && t._op[S] && t.kill(T, t._op[S]), y && t._pt && (Jn = t, Oe.killTweensOf(T, A, t.globalTime(n)), N = !t.parent, Jn = 0), t._pt && c && (We[D.id] = 1);
		}
...
var rr = /*#__PURE__*/ function(e) {
	...
	function t(t, n, r, i) {
		...
		if (a._targets = _.length ? Ze(_) : Ie("GSAP target " + t + " not found. https://gsap.com", !B.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = d, f || u || ve(s) || ve(c)) {
		...
		return d === !0 && !V && (Jn = R(a), Oe.killTweensOf(_), Jn = 0), kt(g, R(a), r), n.reversed && a.reverse(), n.paused && a.paused(!0), (l || !s && !f && a._start === nt(g._time) && ge(l) && St(R(a)) && g.data !== "nested") && (a._tTime = -W, a.render(Math.max(0, -c) || 0)), m && At(R(a), m), a;
	}
	var n = t.prototype;
...
et(Xe + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", function(e) {
	return He[e] = 1;
}), je.TweenMax = je.TweenLite = rr, je.TimelineLite = je.TimelineMax = Un, Oe = new Un({
	sortChildren: !1,
	defaults: re,
...
var vr = [], yr = {}, br = [], xr = 0, Sr = 0, Cr = function(e) {
	...
	e - xr > 2 && (Cr("matchMediaInit"), vr.forEach(function(e) {
		...
		for (a in n) i = G.matchMedia(n[a]).matches, i && (o = 1), i !== r[a] && (r[a] = i, s = 1);
	...
	return t.add = function(e, t, n) {
		...
		var r = this, i = function() {
			...
			return e && e !== r && e.data.push(r), n && (r.selector = Yt(n)), U = r, a = t.apply(r, arguments), fe(a) && r._r.push(a), U = e, r.selector = i, r.isReverted = !1, a;
		};
	...
	return t.add = function(e, t, n) {
		...
		for (o in U && !r.selector && (r.selector = U.selector), this.contexts.push(r), t = r.add("onMatch", t), r.queries = e, e) o === "all" ? s = 1 : (a = G.matchMedia(e[o]), a && (vr.indexOf(r) < 0 && vr.push(r), (i[o] = a.matches) && (s = 1), a.addListener ? a.addListener(wr) : a.addEventListener("change", wr)));
...
var Mr, Nr, Pr, Fr, Ir, Lr, Rr, zr = function() {
	...
	if (o.b = n, o.e = r, n += "", r += "", r === "auto" && (m = e.style[t], e.style[t] = r, r = hi(e, t) || r, m ? e.style[t] = m : Ci(e, t)), l = [n, r], Tn(l), n = l[0], r = l[1], d = n.match(Ce) || [], b = r.match(Ce) || [], b.length) {
		for (; u = Ce.exec(r);) h = u[0], _ = r.substring(s, u.index), p ? p = (p + 1) % 5 : (_.substr(-5) === "rgba(" || _.substr(-5) === "hsla(") && (p = 1), h !== (m = d[c++] || "") && (f = parseFloat(m) || 0, y = m.substr((f + "").length), h.charAt(1) === "=" && (h = rt(f, h) + y), g = parseFloat(h), v = h.substr((g + "").length), s = Ce.lastIndex - v.length, v || (v = v || B.units[t] || y, s === r.length && (r += v, o.e += v)), y !== v && (f = q(e, t, m, v) || 0), o._pt = {
			_next: o._pt,
			p: _ || c === 1 ? _ : ",",
			s: f,
			c: g - f,
...
function ha(e, t, n, r = {}) {
	ra(r.root ?? document);
	let i = ne(), a = fa(r.root ?? document), o = L(ua, i), s = i ? .03 : .055, c = Qi.timeline({ onComplete: () => {
...
function Sa(e, t, n = I.dealStagger) {
	ga();
	let r = ne(), i = Qi.timeline(), a = L(I.deal, r);
...
function Ca(e, t) {
	ga();
	let n = ne(), r = Qi.timeline(), i = L(I.drawReceive, n), a = n ? .04 : I.drawReceiveStagger;
...
function ec({ cards: e, phase: t, enrollmentActive: n = !1, isInHand: r = !1, isDealer: i = !1, signedIn: a = !1, isMyTurn: o = !1, drawCompleted: s = !1, maxDrawDiscards: c = 4, legalPlayIndices: u, recommendedPlayIndex: d = null, recommendedDiscardIndices: f = [], handComplete: p = !1, actionFeedback: m, onSubmitDraw: h, onPassDraw: _, onFoldDraw: v, onPlayCard: y, privateHandReady: b = !1, className: x = "", dealStaggerMs: S = 120, drawAnimSubPhase: C = null, currentUserId: w = null, revealedTrumpIndex: T = null, trumpMergeActive: E = !1, trumpDisabledIndex: D = null, handNumber: O = 0, tableRootRef: k, pileIndexRef: A, onDiscardCommitted: j }) {
	let { settings: M } = Zs(), [P, ee] = (0, l.useState)(/* @__PURE__ */ new Set()), [F, I] = (0, l.useState)(null), [te, L] = (0, l.useState)(null), [ne, R] = (0, l.useState)(null), [z, B] = (0, l.useState)(!1), [re, V] = (0, l.useState)(null), [H, U] = (0, l.useState)(null), [ie, W] = (0, l.useState)(null), [ae, oe] = (0, l.useState)(() => lo()), [se, ce] = (0, l.useState)(!1), [le, ue] = (0, l.useState)(!1), [de, fe] = (0, l.useState)(!1), [pe, me] = (0, l.useState)([]), he = (0, l.useRef)(/* @__PURE__ */ new Set()), ge = (0, l.useRef)(null), _e = (0, l.useRef)(!1), ve = (0, l.useRef)(null), ye = (0, l.useRef)(null), be = (0, l.useRef)(!1), xe = (0, l.useRef)(async () => {}), Se = za(t), Ce = (0, l.useMemo)(() => e.map(Ia), [e]), we = (0, l.useMemo)(() => e.map((e) => `${e.rank}-${e.suit}`).join("|"), [e]), Te = (0, l.useMemo)(() => f.slice().sort((e, t) => e - t).join(","), [f]), Ee = t === "draw", De = t === "play", Oe = (0, l.useCallback)((e, t) => T === t ? E ? "hand__slot--trump-merge-target" : "hand__slot--trump-revealed" : "", [T, E]);
	(0, l.useEffect)(() => {
		if (!Se || e.length === 0) return;
		let t = new Set(e.map((e) => `${e.rank}-${e.suit}`)), n = he.current, r = [...t].some((e) => !n.has(e));
		if (he.current = t, !r || n.size > 0) return;
		ce(!0), L(null), I(null);
		let i = Fa(e.length, S), a = window.setTimeout(() => ce(!1), i);
	...
	(0, l.useEffect)(() => () => G(), [G]), (0, l.useEffect)(() => {
		G(), I(null), ee(/* @__PURE__ */ new Set()), be.current = !1, R(null), U(null), W(null), V(null);
	}, [
		t,
		we,
		G
	]), (0, l.useEffect)(() => {
		F !== null && (Mo(F, u) || (I(null), ye.current = null, G()));
	}, [
		u,
		F,
		G
	]);
	let ke = z || m?.status === "loading" || te !== null;
	(0, l.useEffect)(() => {
		!ae || !Ee || s || be.current || ee(new Set(f));
	}, [
		ae,
		Ee,
		s,
		...
		if (!(!De || !o || F === null || _e.current || ke)) {
			if (!Mo(F, u)) {
				I(null), ye.current = null;
				return;
			}
			ve.current ??= (ye.current = F, window.setTimeout(() => {
				ve.current = null;
				let e = ye.current;
				ye.current = null, e !== null && !_e.current && xe.current(e);
			}, J.autoPlayPreselect));
		}
	}, [
		De,
		...
		(m?.status === "success" || m?.status === "error") && (L(null), I(null), G(), _e.current = !1);
	}, [m?.status, G]);
	let Ae = M.cardScale === "lg" ? "md" : "sm", je = zs(m?.status === "error" ? m.message : re), Me = La(t, n), Ne = (0, l.useCallback)((e) => {
		ke || D === e || (be.current = !0, V(null), ee((t) => {
			let n = new Set(t);
		...
		if (_e.current || ke || !y || !Mo(e, u)) return;
		G(), _e.current = !0, I(null), L(e), V(null);
		let t = Ce[e];
		w && t && no(w, Ga({
			playerId: w,
			card: {
		...
		try {
			await Promise.resolve(y(e)), L(null), _e.current = !1;
		} catch (e) {
			V(zs(e instanceof Error ? e.message : "Could not play card")), L(null), _e.current = !1;
		}
	}, [
		ke,
		u,
		...
		if (!(_e.current || ke || !y || t !== "play")) {
			if (!Mo(e, u)) {
				o && (Ls(), G(), I(null), U(e), W(e), window.setTimeout(() => {
					U(null), W(null);
				}, J.illegalFlash), V("Illegal play"));
				return;
			}
			G(), I(e), V(null), ye.current = e, o && (ve.current = window.setTimeout(() => {
				ve.current = null;
				let t = ye.current;
				ye.current = null, t === e && !_e.current && xe.current(e);
			}, J.autoPlayPreselect));
		}
	}, [
		ke,
	...
	let Ie = (0, l.useCallback)(async (e) => {
		...
		if (!(!_ || ke)) {
			B(!0), V(null);
			try {
				await _(), ee(/* @__PURE__ */ new Set()), ue(!0), window.setTimeout(() => ue(!1), 700);
			} catch (e) {
	...
	}, [_, ke]), Re = (0, l.useCallback)(async () => {
		if (!(!v || ke)) {
			fe(!0), B(!0), V(null);
			try {
				await v(), ee(/* @__PURE__ */ new Set());
			} catch (e) {
				fe(!1), V(e instanceof Error ? e.message : "Could not fold out");
			} finally {
				B(!1);
			}
		}
	}, [v, ke]), ze = (0, l.useCallback)((e) => {
		Ls(), G(), I(null), U(e), W(e), window.setTimeout(() => {
			U(null), W(null);
		}, J.illegalFlash), V("Illegal play");
	}, [G]), Be = (0, l.useCallback)((e) => {
		if (oe(e), uo(e), e) {
			be.current = !1, Ee && !s && ee(new Set(f));
			return;
		}
		be.current || ee(/* @__PURE__ */ new Set());
	}, [
		Ee,
		s,
		f
	]), Ve = a && r && (Ee || De), He = () => Ve ? /* @__PURE__ */ (0, g.jsxs)("label", {
	...
	if (!r && !n && !Se) return /* @__PURE__ */ (0, g.jsx)($s, { className: x });
	if (Se && r && e.length === 0) return p && n ? /* @__PURE__ */ (0, g.jsx)($s, { className: x }) : /* @__PURE__ */ (0, g.jsxs)("div", {
		className: Qs(M, x),
		"aria-live": "polite",
		"data-testid": "hero-hand",
		children: [/* @__PURE__ */ (0, g.jsx)("p", {
	...
	if (Se && !r && (t === "draw" || t === "play")) return /* @__PURE__ */ (0, g.jsx)("div", {
		className: Qs(M, x),
		"data-testid": "hero-hand",
		children: /* @__PURE__ */ (0, g.jsx)("p", {
			className: "btable-hero__fallback muted small",
	...
	let Ue = Ve && De && ae && F === null && d !== null && d >= 0, We = (e, t) => T === t ? "trump" : D === t && (Ee || De) ? "muted" : te === t || ie === t || H === t ? "default" : Ee && P.has(t) ? ae && !be.current ? "draw-recommended" : "draw-selected" : De && F === t ? "play-preselected" : Ue && d === t ? "play-recommended" : De && u && !u.includes(t) ? "muted" : "default", Ge = Se && r && !(De && o), Ke = "none";
	De && r ? Ke = "play" : Ee && r && !s ? Ke = "draw-select" : Ge && (Ke = "peek");
	let qe = P.size, Je = Ee && !s && o;
		...
		children: [
			/* @__PURE__ */ (0, g.jsxs)("p", {
				...
				children: [
					...
					ae && (Ee || De) && " — green outline marks suggested cards"
				]
			}),
			/* @__PURE__ */ (0, g.jsxs)("div", {
				...
				"data-trick-play-origin-active": De && o && w ? w : void 0,
				children: [/* @__PURE__ */ (0, g.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, g.jsx)(N, {
						...
						cardInteraction: {
							...
							playingIndex: te,
							illegalShakeIndex: H,
							illegalFlashIndex: ie,
							busy: ke,
							showPlayableHint: !1,
							allowPlayPreselect: De && r && !o,
				...
				children: Je && /* @__PURE__ */ (0, g.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, g.jsx)("button", {
							...
							children: ke ? "Drawing…" : `Draw${qe > 0 ? ` (${qe})` : ""}`
						}),
						/* @__PURE__ */ (0, g.jsx)("button", {
							type: "button",
...
function hc(e) {
	let t = Number(e) || 0;
	return t > 0 ? `+${pc(t)}` : t < 0 ? `−${pc(Math.abs(t))}` : pc(0);
}
function gc(e) {
	return pc(Math.max(0, Number(e) || 0));
}
function _c(e, t, n) {
...
var xc = nc, Sc = tc;
function Cc(e, t) {
	let { rx: n, ry: r, outset: i } = yc(t), a = e / t * Math.PI * 2 + Math.PI / 2, o = Math.cos(a), s = Math.sin(a);
	return {
		x: 50 + n * o + o * i,
		y: 50 + r * s + s * i,
		region: bc(a)
...
function Ac(e = !1) {
	...
	return {
		...
		postTrickReadMs: Math.round(Ec * t),
		winnerRevealMs: Math.round(400 * t),
		trickSweepMs: Math.round(520 * t),
		nextLeadGapMs: Math.round(200 * t),
		trumpBeatReadMs: Math.round(Dc * t)
	};
}
function jc(e) {
	let t = Ac(e.reducedMotion), n = e.trumpBeat ? t.trumpBeatReadMs : t.postTrickReadMs, r = Math.min(t.winnerRevealMs, n - 200), i = Math.max(200, n - r), a = t.trickSweepMs, o = t.nextLeadGapMs;
	return {
...
function Rc(e) {
	let { prevTricks: t, nextTricks: n, prevTrick: r, playedCards: i } = e, a = Nc(e.participantIds, t, n), o = lc(t, a), s = lc(n, a);
	if (s <= o) return null;
	let c = Mc(t, n, a), l = r?.trickNumber ?? s, u = Ic({
		prevTrick: r,
		playedCards: i,
		trickNumber: l
	});
...
var Bc = "nbl-game-flow-debug", Vc = !1, Hc = null;
function Uc() {
	if (Vc) return !0;
	if (typeof window > "u") return !1;
	try {
		return window.localStorage?.getItem(Bc) === "1" ? !0 : new URLSearchParams(window.location.search).has("gameFlowDebug");
	} catch {
		return !1;
	}
}
...
function Gc(e, t, n, r, i) {
	r.current = !1, e(!0), t("static"), n(null), i && Uc() && Wc("TrickPlaySlot", "fly-complete", i);
}
function Kc({ play: e, index: t, presentationPhase: n, displayCount: r, playerName: i, leaderPlayerId: a = null, winnerPlayerId: o = null, instantPlace: s = !1 }) {
	...
	(0, l.useLayoutEffect)(() => {
		Uc() && Wc("TrickPlaySlot", "play-enter", {
			playKey: y,
			index: t,
			instantPlace: s,
			isLanding: C
		...
		let a = zc(), o = a ? 187 : 340, l = a ? 77 : 140;
		v.current = !0, p(ro(i, n.getBoundingClientRect(), r.getBoundingClientRect())), d("pending"), Uc() && Wc("TrickPlaySlot", "fly-start", {
			playKey: y,
			index: t,
			travelMs: o,
			settleMs: l
...
function qc({ displayPlays: e = [], leaderPlayerId: t = null, winnerPlayerId: n = null, showWinnerTag: r = !1, presentationPhase: i = "live", playerNames: a = {}, variant: o = "live", instantTrickPlays: s = !1 }) {
	if ((0, l.useEffect)(() => {
		Uc() && Wc("TrickRow", e.length === 0 ? "trick-empty" : "trick-cards", {
			count: e.length,
			phase: i
		});
	...
	return /* @__PURE__ */ (0, g.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, g.jsxs)("div", {
			...
			children: [r && c && /* @__PURE__ */ (0, g.jsxs)("div", {
				...
				children: e.map((r, o) => /* @__PURE__ */ (0, g.jsx)(Kc, {
					play: r,
					index: o,
...
function Yc({ potMetrics: e, participantCount: t, trumpUpcard: n, trumpSuit: r, phase: i, enrollmentActive: a = !1, remainingDeckCount: o, trickDisplayPlays: s = [], trickLeadSuit: c = null, trickLeaderPlayerId: u = null, trickWinnerPlayerId: f = null, trickShowWinnerTag: p = !1, trickPresentationPhase: m = "live", trickEchoPlays: h = [], trickEchoWinnerId: v = null, trickEchoPhase: y = "live", showFinalTrickEcho: b = !1, playerNames: x = {}, anteAnimActive: S = !1, trumpRevealActive: C = !1, drawAnimPlayerId: w = null, drawAnimSubPhase: T = "done", drawDiscardCount: E = 0, settleAnimActive: D = !1, settleCarryOver: O = !1, potTick: k = 0, trumpReminderPulse: A = 0, hideCenterTrump: j = !1, showTrumpSuitReminder: M = !1, instantTrickPlays: N = !1, peakTrickPlayCount: P = 0, discardPileCards: ee = [] }) {
	...
	let B = !!R && !j, re = M || !B && !!r && i === "play", V = B ? `${R.rank}-${R.suit}` : "trump-slot", H = b || D && h.length > 0 && L === 0;
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, g.jsxs)("div", {
			...
			children: [
				...
				i === "draw" ? /* @__PURE__ */ (0, g.jsx)(Jc, { cards: ee }) : null,
				/* @__PURE__ */ (0, g.jsxs)("div", {
				...
				/* @__PURE__ */ (0, g.jsxs)("dl", {
					...
					children: [
						/* @__PURE__ */ (0, g.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, g.jsx)("dt", { children: "Table pot" }), /* @__PURE__ */ (0, g.jsx)("dd", { children: pc(e.currentPot) })]
						}, k > 0 ? `pot-${k}` : "pot-static"),
						/* @__PURE__ */ (0, g.jsxs)("div", {
							className: "bpot__stat",
							"data-testid": "ante-display",
							children: [/* @__PURE__ */ (0, g.jsx)("dt", { children: "Ante / hand" }), /* @__PURE__ */ (0, g.jsx)("dd", { children: mc(e.anteAmount) })]
						}),
						e.limEnabled && /* @__PURE__ */ (0, g.jsxs)(g.Fragment, { children: [/* @__PURE__ */ (0, g.jsxs)("div", {
							className: "bpot__stat",
							children: [/* @__PURE__ */ (0, g.jsx)("dt", { children: "Cap" }), /* @__PURE__ */ (0, g.jsxs)("dd", { children: [pc(e.potCap), /* @__PURE__ */ (0, g.jsx)("span", {
								className: "bpot__lim-tag",
								children: "LmT"
							})] })]
						}), /* @__PURE__ */ (0, g.jsxs)("div", {
							className: "bpot__stat bpot__stat--highlight",
							children: [/* @__PURE__ */ (0, g.jsx)("dt", { children: "Max win" }), /* @__PURE__ */ (0, g.jsx)("dd", { children: pc(e.maxWinThisHand) })]
						})] })
					]
				}),
...
function Zc({ player: e, compact: t = !1 }) {
...
var Qc = 22, $c = 2 * Math.PI * Qc;
function el({ progress: e, segment: t, reducedMotion: n = zc() }) {
	let r = $c * (1 - Math.max(0, Math.min(1, e)));
...
function tl({ player: e, region: t, handLane: n = "below", style: r, onToggleInHand: i, onPassEnrollment: a, onTrickDelta: o, onReaction: s }) {
				...
				children: /* @__PURE__ */ (0, g.jsxs)("div", {
					...
					children: [
							...
							children: [
								...
								/* @__PURE__ */ (0, g.jsxs)("div", {
									...
									children: [
										...
										e.turnCountdown && /* @__PURE__ */ (0, g.jsx)(el, {
						...
						h && /* @__PURE__ */ (0, g.jsx)("span", {
							...
							"aria-label": `Chips ${gc(e.bankroll ?? 0)}`,
							title: `Chips ${gc(e.bankroll ?? 0)}`,
							children: gc(e.bankroll ?? 0)
						}),
...
function rl(e, t, n) {
	let r = new Map(e.map((e) => [e.playerId, e])), i = nl(e.map((e) => e.playerId), t);
...
function ol(e, t) {
	return e < 0 || e > 6 ? null : il(t)[e] ?? null;
}
function sl(e, t, n) {
	let r = ol(e, t);
	return r ? {
...
function ul(e, t) {
	return e < 0 || e > 7 ? null : cl(t)[e] ?? null;
}
function dl(e, t, n) {
	let r = ul(e, t);
	return r ? {
...
function _l(e, t) {
	let n = hl(e.x, fl.min, fl.max), r = t === "portrait" ? pl : ml, i = hl(e.y, 8, r);
	return {
		...e,
		x: n,
		y: i
...
function vl(e, t, n) {
	if (n.isMobile && n.orientation && al(t)) {
		let t = sl(e, n.orientation, { isSelf: n.isSelf });
		if (t) return t;
	}
	...
	let r = wc(e, t), i = n.isMobile && n.orientation ? _l(r, n.orientation) : r;
	return {
		...i,
		seatIndex: e,
		handLane: gl(i, {
...
function bl(e, t = "portrait") {
	if (al(e)) {
		let e = sl(0, t, { isSelf: !0 });
		if (e) return e;
	}
	if (ll(e)) {
...
var xl = 5e3, Sl = 1e3, Cl = 12e3, wl = 4e3, Tl = 4e3;
function El(e = zc()) {
...
function Dl(e, t, n = zc()) {
	let r = El(n), i = Math.max(0, e), a = Math.max(0, t);
...
function kl(e, t, n, r) {
	let i = Ol(e, t, n), a = Math.max(152, n);
	return {
...
function zl({ aspect: e, enabled: t = !0, sessionKey: n }) {
	let r = (0, l.useRef)(null), i = (0, l.useRef)(0), a = (0, l.useRef)(n), { settings: o } = Zs(), s = Il();
	return (0, l.useLayoutEffect)(() => {
		...
		let l = c.closest(".btable-desktop__viewport") ?? c.closest(".table-play-overlay__main") ?? c.closest(".btable-session"), u = window.visualViewport, d = () => {
			let t = !!c.closest(".table-play-overlay"), n = typeof window < "u" && window.matchMedia("(orientation: portrait)").matches, r = Rl(c, s).getBoundingClientRect(), a = c.querySelector(".hand-panel")?.getBoundingClientRect(), l = t && s && n ? 100 : t && !s ? 120 : s ? 112 : 148, d = t && s && n || t && !s ? 200 : s ? 210 : 280, f = a?.height ?? 0, p = kl(f, i.current, l, d);
			i.current = p.peak;
			...
			let S = Math.max(.85, Math.min(1.35, o.tableScale || 1)), C = t && s ? 1 : S, w = s ? Al(e, { portrait: n }) : e, T = parseInt(getComputedStyle(c).getPropertyValue("--player-count").trim(), 10) || 4, E = t && s && !n, D = E ? {
				...Ml({
					availWidth: b,
					availHeight: x,
					aspect: w,
			...
			if (c.style.setProperty("--stage-fit-width", `${Math.round(k)}px`), c.style.setProperty("--stage-fit-height", `${Math.round(A)}px`), c.style.setProperty("--stage-fit-scale", String(D.fitScale)), c.style.setProperty("--stage-effective-scale", String(j)), (c.closest(".btable-desktop__scale") ?? c.parentElement)?.style.setProperty("--stage-effective-scale", String(j)), localStorage.getItem("stageFitDebug") === "1") {
				let e = c.querySelector(".table-stage"), a = c.querySelectorAll(".bseat__avatar-wrap"), o = e ? Pl(e.getBoundingClientRect()) : null, l = Pl(document.documentElement.getBoundingClientRect()), u = [...a].filter((e) => !Fl(Pl(e.getBoundingClientRect()), l, 1)).length;
...
var Gl = /* @__PURE__ */ new Set(), Kl = /* @__PURE__ */ new Set(), ql = I.drawDiscard;
function Jl(e, t) {
	return {
		midX: e * .42,
...
function Xl() {
	for (let e of Kl) Qi.set(e, { clearProps: "opacity,transform,willChange,zIndex" });
	Kl.clear();
}
function Zl(e) {
...
function iu(e, t) {
	ra(t.root ?? document);
	let n = ne(), r = t.root ?? document, i = t.host ?? (r instanceof HTMLElement ? r : document.body), a = Yl(t.winnerPlayerId, r), o = n ? .06 : 140 / 1e3, s = L(ql, n), c = n ? .03 : .05, l = [], u = (e) => {
		Gl.delete(d);
	...
	Gl.add(d), e.forEach((e, r) => {
		...
		l.push(f), Kl.add(e), Qi.set(e, { opacity: 0 });
		let p = $i(f);
		Qi.set(f, {
			transformOrigin: "50% 50%",
			willChange: "transform,opacity",
...
function mu({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: l = !1, showTrumpSuitReminder: u = !1, trumpHolderPresentation: d, privateHandReady: f = !1, currentUserId: p = null, legalPlayIndices: m, recommendedPlayIndex: h, recommendedDiscardIndices: _ = [], handComplete: v = !1, actionFeedback: y, trickPresentation: b, handPresentation: x, microinteractions: S, instantTrickPlays: C = !1, turnCountdown: w = null, onToggleInHand: T, onPassEnrollment: E, onTrickDelta: D, onSubmitDraw: O, onPassDraw: k, onFoldDraw: A, onPlayCard: j, onReaction: M }) {
	...
	})), P = rl(N, e, p), ee = P.length, F = `btable--p${Math.min(8, Math.max(2, ee))}`, I = Tc(ee), te = Object.fromEntries(N.map((e) => [e.playerId, e.displayName])), L = El(), ne = e.sessionId, R = zl({
		aspect: I,
		sessionKey: ne
	}), { cards: z, pileIndexRef: B, commitDiscardCards: re } = Da({
	...
	let V = new Set(e.participantIds.filter((t) => fc(t, b.displayTricksByPlayer, e.participantIds, e.phase))), H = N.map((t) => {
		...
		return {
			...t,
			...l,
			bankroll: _c(t.bankroll, n.anteAmount, {
				inHand: t.inHand,
	...
	}), U = N.find((e) => e.isSelf), ie = b.suppressTurnPlayerId || x.suppressTurnIndicator, W = !!(p && e.drawCompletedIds?.includes(p));
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		ref: R,
		className: [
		...
		style: {
			...
			"--trick-post-read-ms": `${Ec}ms`,
			"--trick-next-lead-gap-ms": "200ms",
			"--trick-final-pipeline-ms": `${Ec + 400 + 520 + 200}ms`,
...
function _u() {
	let e = Il(), [t, n] = (0, l.useState)(() => typeof window < "u" && window.matchMedia(gu).matches);
	return (0, l.useEffect)(() => {
...
function xu({ aspect: e, sessionKey: t }) {
	let n = (0, l.useRef)(null), r = (0, l.useRef)(0), i = (0, l.useRef)(t), a = _u(), { settings: o } = Zs(), s = a === "mobile-portrait";
	return (0, l.useLayoutEffect)(() => {
		...
		let c = window.visualViewport, l = () => {
			let t = bu(a).getBoundingClientRect(), n = a.querySelector(".btable-mobile-hero-dock")?.getBoundingClientRect(), i = !!a.closest(".table-play-overlay"), l = s ? 104 : 92, u = s ? 210 : 168, d = kl(n?.height ?? 0, r.current, l, u);
			r.current = d.peak;
...
function Su({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: l = !1, showTrumpSuitReminder: u = !1, trumpHolderPresentation: d, privateHandReady: f = !1, currentUserId: p = null, legalPlayIndices: m, recommendedPlayIndex: h, recommendedDiscardIndices: _ = [], handComplete: v = !1, actionFeedback: y, trickPresentation: b, handPresentation: x, microinteractions: S, instantTrickPlays: C = !1, turnCountdown: w = null, onToggleInHand: T, onPassEnrollment: E, onTrickDelta: D, onSubmitDraw: O, onPassDraw: k, onFoldDraw: A, onPlayCard: j }) {
	let M = _u() === "mobile-landscape" ? "landscape" : "portrait", N = t.map((e) => ({
		...e,
		isSelf: e.isSelf || p != null && e.playerId === p
	})), P = rl(N, e, p), ee = P.filter((e) => !e.isSelf), F = P.find((e) => e.isSelf), I = F ? bl(P.length, M) : null, te = P.length, L = `btable--p${Math.min(8, Math.max(2, te))}`, ne = hu(ee.length, M), R = Object.fromEntries(t.map((e) => [e.playerId, e.displayName])), z = El(), B = e.sessionId, re = xu({
		aspect: ne,
		sessionKey: B
	}), { cards: V, pileIndexRef: H, commitDiscardCards: U } = Da({
		handNumber: e.handNumber,
		sessionPhase: e.phase,
		tableRootRef: re
	});
	...
	let ie = new Set(e.participantIds.filter((t) => fc(t, b.displayTricksByPlayer, e.participantIds, e.phase))), W = N.map((t) => {
		let r = b.displayTricksByPlayer[t.playerId] ?? 0, i = b.trickWinnerSeatId === t.playerId, a = b.suppressTurnPlayerId || x.suppressTurnIndicator, o = b.phase === "collectTrick" && i, s = x.enrollmentPulse[t.playerId], c = x.animatingDrawPlayerId === t.playerId, l = pu(t.playerId, d, e.trumpUpcard ?? null, t.holeCardCount ?? 0, t.isSelf);
		return {
			...t,
			...l,
	...
	}), ae = N.find((e) => e.isSelf), oe = b.suppressTurnPlayerId || x.suppressTurnIndicator, se = !!(p && e.drawCompletedIds?.includes(p));
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		ref: re,
		className: [
					...
					children: /* @__PURE__ */ (0, g.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, g.jsxs)("div", {
								...
								"aria-label": "Players at the table",
								children: [ee.map((e, t) => {
									let n = yl(t, P.length, M), r = W.find((t) => t.playerId === e.playerId) ?? e;
									return /* @__PURE__ */ (0, g.jsx)("div", {
										className: `btable__seat-slot btable__seat-slot--${t}`,
										"data-seat-index": t + 1,
										children: /* @__PURE__ */ (0, g.jsx)(tl, {
									...
									"data-seat-index": 0,
									children: /* @__PURE__ */ (0, g.jsx)(tl, {
										player: W.find((e) => e.playerId === F.playerId) ?? F,
										region: I.region,
										handLane: I.handLane,
										style: {
											left: `${I.x}%`,
...
function Tu({ children: e }) {
	let { settings: t } = Zs(), n = t.layoutMode === "tiled", r = Il();
	return /* @__PURE__ */ (0, g.jsx)("div", {
		className: [
			"btable-desktop",
...
function Uu(e, t) {
	...
	return !n || !r || t.drawCompletedIds.includes(r) || n === r && !t.drawCompletedIds.includes(n) ? null : (Uc() && Wc("handPresentation", "fast-forward-stale-draw", {
		animating: n,
		turnId: r,
...
function qu(e, t, n, r) {
	Uc() && Wc("handPresentation", "draw-candidate-resolve", {
		handNumber: e.handNumber,
...
function Ju(e, t, n) {
	Uc() && Wc("handPresentation", `draw-receive-commit-${e}`, {
...
function Yu(e, t) {
	...
	let r = e.displayDrawCompletedIds.includes(n) ? e.displayDrawCompletedIds : [...e.displayDrawCompletedIds, n], i = Wu(e, n), a = t == null ? e.prevSnapshot : {
		...t,
		drawCompletedIds: [...r]
	};
	return Ju("payload", e, {
...
function Xu(e, t, n, r, i, a) {
	return Vu(e, n) ? (qu(e, t, null, `consumed-skip:${n}:${a}`), e) : Hu(e) && e.animatingDrawPlayerId !== n ? (qu(e, t, null, `in-flight-skip:${a}`), e) : (qu(e, t, n, a), Ru(e, "drawPlayer", {
		animatingDrawPlayerId: n,
		drawAnimSubPhase: "discard",
		drawDiscardCount: r,
		drawReplaceCount: i,
		prevSnapshot: t,
		drawPresentationConsumedIds: Wu(e, n)
	}));
}
function Zu(e) {
...
function $u(e, t, n, r) {
	...
	return i ? Xu(e, t, i, n, r, "beginDrawSequence") : Ru(e, "drawPlayer", {
...
function ed(e, t) {
	let n = td(e, t);
	return Uc() && (e.phase !== n.phase || e.handNumber !== n.handNumber || e.trumpRevealActive !== n.trumpRevealActive || t.type === "serverUpdate") && Wc("handPresentation", t.type, {
...
function td(e, t) {
	switch (t.type) {
		...
		case "watchdog": return e.pendingHandSettle && e.phase === "play" ? Zu(e) : Date.now() - e.phaseStartedAt < 12e3 ? e : nd({
			...e,
			pendingSnapshot: e.pendingSnapshot ?? e.prevSnapshot
		});
		case "tryBeginHandSettle": return Zu(e);
		case "advancePhase": return nd(e);
		case "serverUpdate": {
			let { snapshot: n, heroDrawDiscardCount: r = 0, heroDrawReplaceCount: i = 0 } = t, a = e.prevSnapshot ?? n;
			if (e.sessionKey !== n.sessionKey) {
				let e = Lu(n);
				return n.phase === "reveal" ? Qu(e, n) : e;
			}
			...
			if (n.phase === "reveal" && a.phase !== "reveal" && (e.phase === "idle" || e.phase === "nextHandReset" || e.phase === "enrollment" || e.phase === "settle" || e.phase === "play")) return Qu(e, n);
			...
			if (n.phase === "draw" && (e.phase === "decision" || a.phase === "decision") && e.drawPresentationConsumedIds.length === 0 && e.displayDrawCompletedIds.length === 0 && e.phase !== "drawPlayer" && e.phase !== "drawReady") return $u(e, n, 0, 0);
			if (n.phase === "draw") {
				let t = Uu(e, n);
				t && (e = t);
				let o = Bu(e, a, n);
				if (o && e.phase !== "drawReady") {
					...
					if (!t && !Hu(e)) {
						...
						return Xu(e, n, o, a, t ? i : a, "serverUpdate");
					}
					t ? qu(e, n, null, "serverUpdate:animating-same-player") : Hu(e) && qu(e, n, null, "serverUpdate:in-flight-other-player");
...
function nd(e) {
	...
	switch (e.phase) {
		...
		case "ante": return e.trumpRevealActive || t?.trumpUpcard ? Ru(e, "trumpReveal", {
			...
			anteAnimActive: !1,
			pendingSnapshot: null
		}) : t?.phase === "draw" ? $u(e, t, 0, 0) : Ru(e, "drawPlayer", {
			anteAnimActive: !1,
			pendingSnapshot: null
		});
		...
		case "drawPlayer": {
			...
			Ju("before", e);
			let n = e.animatingDrawPlayerId, r = Yu(e, t);
			Ju("after", r);
			...
			if (i && r.displayDrawCompletedIds.length >= i.participantIds.length) return Ru(r, "drawReady", {
				...
				drawPresentationConsumedIds: Gu(r, r.displayDrawCompletedIds)
			});
			if (i) {
				let e = {
					...i,
					drawCompletedIds: [...r.displayDrawCompletedIds]
				}, t = Ku(r, i, r.displayDrawCompletedIds);
				if (Ju("after", r, {
					playerId: n,
					nextCompleted: r.displayDrawCompletedIds,
					nextChosen: t
				}), t) return qu(r, i, t, "advancePhase:nextPlayer"), Xu(r, e, t, 1, 1, "advancePhase:nextPlayer");
...
function id(e, t = !1) {
	...
	switch (e.phase) {
		...
		case "drawPlayer": return e.drawAnimSubPhase === "done" && !e.animatingDrawPlayerId ? 0 : Dl(e.drawAnimSubPhase === "receive" ? 0 : e.drawDiscardCount, e.drawAnimSubPhase === "receive" ? e.drawReplaceCount : 0, t);
...
function cd({ session: e, enrollmentActive: t, potAmount: n, handComplete: r, trickPipelineActive: i = !1, forceTrickHandEndDrain: a, heroCards: o = od, enrolledIds: s = ad, declinedIds: c = ad, actionOrder: u }) {
	let d = (0, l.useMemo)(() => Fu({
		...
		c,
		u
	]), [f, p] = (0, l.useReducer)(ed, d, Lu), m = (0, l.useRef)([]), h = (0, l.useRef)([]), g = (0, l.useRef)(null), _ = (0, l.useRef)(f);
	_.current = f;
	let v = () => {
	...
	return (0, l.useEffect)(() => () => v(), []), (0, l.useEffect)(() => {
		let e = o.map((e) => `${e.rank}-${e.suit}`), t = sd(h.current, e);
		h.current = e, p({
			type: "serverUpdate",
			snapshot: d,
			heroDrawDiscardCount: t.discardCount,
			heroDrawReplaceCount: t.replaceCount
		}), Uc() && Wc("useHandPresentation", "serverUpdate-effect", {
		...
		let e = zc(), t = `${f.handNumber}:${f.phase}:${f.animatingDrawPlayerId ?? ""}:${f.drawAnimSubPhase}:${f.phaseStartedAt}`;
		if (g.current === t) {
			Uc() && Wc("useHandPresentation", "advancePhase-timer-skip-duplicate", { phaseKey: t });
			return;
		}
		v();
		let n = id(f, e);
		...
		g.current = t, Uc() && Wc("useHandPresentation", "advancePhase-timer-armed", {
			phaseKey: t,
			delay: n,
			fromPhase: f.phase,
			drawAnimSubPhase: f.drawAnimSubPhase
			...
			if (e.handNumber !== r.handNumber || e.phase !== r.phase || e.animatingDrawPlayerId !== r.animatingDrawPlayerId || e.drawAnimSubPhase !== r.drawAnimSubPhase || e.phaseStartedAt !== r.phaseStartedAt) {
				Uc() && Wc("useHandPresentation", "advancePhase-timer-stale", {
					armedAt: r,
					current: {
						handNumber: e.handNumber,
						phase: e.phase,
			...
			Uc() && Wc("useHandPresentation", "advancePhase-timer", {
				fromPhase: r.phase,
				delay: n,
				animatingDrawPlayerId: r.animatingDrawPlayerId,
				drawAnimSubPhase: r.drawAnimSubPhase
			}), p({ type: "advancePhase" });
		}, n), y(() => p({ type: "watchdog" }), f.phase === "drawPlayer" || f.phase === "drawReady" ? wl : Cl);
	}, [
		f.handNumber,
		f.phase,
		...
		let e = window.setTimeout(() => {
			let e = _.current;
			e.phase !== "play" || !e.pendingHandSettle || (Uc() && Wc("useHandPresentation", "hand-end-convergence-force", { trickPipelineActive: !0 }), a?.(), p({ type: "tryBeginHandSettle" }));
		}, Tl);
		return () => window.clearTimeout(e);
	}, [
		f.phase,
...
function pd(e, t) {
	return dd(t) ? dd(e) ? fd(t) >= fd(e) ? t : e : t : e;
}
function md(e) {
	let t = e?.phase ?? null;
...
function hd(e) {
	let t = e?.currentHand ?? ld(), n = e?.liveEnrollment?.deal?.publicHand, r = n?.phase ?? null;
	if (ud(t) && n && !dd(n)) return ld();
	if (dd(t) && dd(n)) {
		...
		return e && n?.phase === "draw" && o === 0 && a === 0 && r > 0 && i === 0 ? t : pd(t, n);
	}
	if (dd(t)) return t;
	if (r === "draw" || r === "play" || r === "reveal" || r === "decision") {
		if (dd(n)) {
			let i = lc(n?.tricksByPlayer ?? {}, n?.participantIds ?? []);
			return ud(t) && i === 0 && r === "draw" && !e?.liveEnrollment?.active ? ld() : n;
		}
		return n?.phase ? n : md(t) ? t : ud(t) ? ld() : t;
	}
	return r && n ? n : t;
}
function gd(e) {
	let t = hd(e), n = t?.phase ?? null;
...
function Td(e) {
	let t = e.session, n = t ? hd(t) : wd(), r = n.phase ?? null, i = n.participantIds ?? [], a = n.tricksByPlayer ?? {}, o = lc(a, i), s = i.length > 0 && uc(a, i), c = !!t?.pendingCoWinSettlement?.winnerIds?.length, l = t ? gd(t) : null, u = vd(r, n.handDecision ?? null), d = _d({
...
function Id(e) {
	...
	return (0, l.useEffect)(() => {
		...
		let e = () => o(Date.now()), n = zc() ? 250 : 100, i = window.setInterval(e, n);
...
function Qd(e) {
	return Math.max(e.pendingResolution?.frozen.plays.length ?? 0, Pc(e.prevTrick).length, e.peakTrickPlays?.length ?? 0);
}
function $d(e, t) {
	let n = Pc(t.currentTrick), r = Pc(e.prevTrick), i = Xd(e, t, n), a = e.phase === "live" && !e.pendingResolution && (n.length < e.revealedCount && r.length >= e.revealedCount || n.length < i.length && r.length >= i.length), o = t.currentTrick?.trickNumber ?? null, s = e.prevTrick?.trickNumber ?? null, c = o != null && s != null && o !== s;
	return {
		...e,
...
function tf(e, t) {
	let n = nf(e, t);
	if (Uc()) {
		let r = Pc(e.prevTrick).length, i = Pc(n.prevTrick).length;
		(e.phase !== n.phase || e.revealedCount !== n.revealedCount || r !== i || !!e.pendingResolution != !!n.pendingResolution || t.type === "serverUpdate") && Wc("trickPresentation", t.type, {
			phase: `${e.phase} -> ${n.phase}`,
...
function nf(e, t) {
	switch (t.type) {
		...
		case "forceHandEndDrain": {
			...
			let n = t.pendingServer, r = n?.tricksByPlayer ?? {}, i = Object.values(r).some((e) => (e ?? 0) > 0), a = i ? { ...r } : { ...t.displayTricksByPlayer }, o = Pc(n?.currentTrick).length;
			return {
				...t,
				phase: "live",
				frozenTrick: null,
				...
				peakTrickPlays: Pc(n?.currentTrick),
		...
		case "advancePhase": switch (e.phase) {
			...
			case "nextLeadReady": {
				...
				return {
					...
					peakTrickPlays: Pc(t?.currentTrick),
...
function af(e, t) {
	...
	return {
		...
		suppressTurnPlayerId: kc(e.phase),
...
function of({ phase: e, currentTrick: t, tricksByPlayer: n, participantIds: r, trumpSuit: i, playedCards: a, turnPlayerId: o, handComplete: s = !1 }) {
	...
	(0, l.useEffect)(() => () => S(), []), (0, l.useEffect)(() => {
		...
		if (c || !b && !m.current && !l) {
			...
			}), Uc() && Wc("useTrickPresentation", c ? "reinit-play-entry" : "reinit-idle", {
		...
		u({
			...
			trumpSuit: i,
			reducedMotion: zc()
		}), Uc() && Wc("useTrickPresentation", "serverUpdate-effect", {
			sessionPhase: e,
			trickNumber: t?.trickNumber,
		...
		f.current = e, S();
		let t = c.frozenTrick, n = jc({
			trumpBeat: Lc(t.plays, t.leadSuit, i),
			reducedMotion: zc()
		});
		...
		let t = zc() ? 264 : 480, n = window.setTimeout(() => u({ type: "commitTrickResolution" }), t);
		return () => window.clearTimeout(n);
	}, [
		b,
		y,
		...
		if (!y || !t || b && !s) return;
		let n = zc(), i = n ? 60 : 160, a = n ? 80 : 220, o = [], l = (e, t) => {
			o.push(window.setTimeout(e, t));
		};
		Uc() && Wc("useTrickPresentation", "hand-end-drain-armed", {
			phase: c.phase,
		...
		return l(() => {
			let e = v.current;
			e.phase === "live" && !e.pendingResolution || (Uc() && Wc("useTrickPresentation", "hand-end-drain-force", {
				phase: e.phase,
	...
	let T = () => {
		...
		h.current = window.setTimeout(() => {
			h.current = null, Uc() && Wc("useTrickPresentation", "revealNextCard-timer", {
...
function gf(e) {
	...
	uf = Date.now() + 1500, df = null, Uc() && Wc("trickAnimationBridge", "table-presentation-force-release", {
		source: e,
		blockedMs: n,
		from: t,
		to: r
...
function _f(e = Date.now()) {
	...
	let n = e - df.since;
	return n >= 4e3 ? (Uc() && !df.blockedLogged && Wc("trickAnimationBridge", "gate-force-release", {
		reason: t,
		blockedMs: n
	}), gf("gate-timeout"), {
		blocked: !1,
		...
		softUnblock: !0,
		forceReleased: !0
	}) : n >= 3500 ? (Uc() && !df.blockedLogged && (Wc("trickAnimationBridge", "gate-soft-unblock", {
		reason: t,
		blockedMs: n
	}), df.blockedLogged = !0), {
		blocked: !1,
		...
		softUnblock: !0,
		forceReleased: !1
	}) : (Uc() && !df.blockedLogged && (Wc("trickAnimationBridge", "gate-blocked", {
		reason: t,
		blockedMs: n
	}), df.blockedLogged = !0), {
		blocked: !0,
...
function yf(e) {
	if (!ff(cf, e)) {
		Uc() && Wc("trickAnimationBridge", "busy-state", {
			from: cf,
			to: e,
			busy: mf(e),
			blockReason: pf(e),
...
function Df({ session: e, players: t, splitSharePerWinner: n, currentUserId: r, isCoWinner: i, onAgreeSplit: a, onDeclineSplit: o, onCarryover: s }) {
	let c = e.pendingCoWinSettlement?.winnerIds ?? [], u = e.pendingCoWinSettlement?.votes ?? {}, [d, f] = (0, l.useState)(Tf), [p, m] = (0, l.useState)(!1), h = (0, l.useRef)(null), _ = (0, l.useRef)(!1), v = (0, l.useMemo)(() => `${c.join(",")}:${e.handNumber ?? 0}`, [c, e.handNumber]);
	(0, l.useEffect)(() => {
		h.current = Date.now(), _.current = !1, f(Tf), m(!1);
	}, [v]);
	...
	if ((0, l.useEffect)(() => {
		...
		let e = window.setInterval(() => {
			let e = h.current ?? Date.now(), t = Date.now() - e, n = Math.max(0, Tf - t);
			f(n), n <= 0 && !y && b();
		}, 100);
	...
	let x = Math.max(0, Math.ceil(d / 1e3)), S = c.map((e) => Ef(e, t)).join(" & "), C = (e) => {
	...
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, g.jsxs)("p", {
				...
				children: [pc(n), " each if all agree"]
			}),
...
var jf = [], Mf = [], Nf = [];
function Pf({ session: e, players: t, potMetrics: n, mySessionNet: r, leaderLabel: i, showCoWinSettlement: a, splitPotEnabled: o = !1, rebuyEnabled: s = !1, splitSharePerWinner: c = 0, enrollmentActive: u = !1, currentUserId: d, heroCards: f = Mf, rawHeroCards: p = Mf, privateHandReady: m = !1, legalPlayIndices: h, recentBourreIds: _ = Nf, handComplete: v = !1, actionFeedback: y, actions: b }) {
	let { settings: x } = Zs(), S = Il(), [C, w] = (0, l.useState)(!1), T = e.participantIds.length, { events: E, dismissEvent: D, pushReaction: O } = Nu({
		session: e,
		potMetrics: n,
		participantIds: e.participantIds
	}), k = d != null && (e.pendingCoWinSettlement?.winnerIds || []).includes(d), A = of({
		phase: e.phase,
	...
	}), N = qd(e.phase, e.trumpUpcard, A.displayPlays.length), P = hf(M.isPresenting, M.phase, e.phase);
	(0, l.useEffect)(() => {
		yf({
	...
	let ee = za(e.phase), F = (0, l.useMemo)(() => du({
		...
		M.trumpMergeActive,
		M.trumpMergedIntoHand
	]), te = I.displayCards, L = (0, l.useMemo)(() => !h?.length || I.indexMode === "effective" ? h : Of(h, I.trumpDisabledIndex), [
		h,
		I.indexMode,
		...
		return t == null ? null : I.indexMode === "effective" ? t : Of([t], I.trumpDisabledIndex)[0] ?? null;
	}, [
		h,
		f,
		e.trumpSuit,
		...
		let t = f.map(Ia), n = I.indexMode === "display" && I.trumpDisabledIndex != null ? kf([I.trumpDisabledIndex], I.trumpDisabledIndex) : I.trumpDisabledIndex == null ? [] : [I.trumpDisabledIndex], r = Po(t, e.trumpSuit ?? "clubs", e.maxDrawDiscards ?? 4, e.remainingDeckCount ?? Infinity, n);
		return I.indexMode === "effective" ? r : Of(r, I.trumpDisabledIndex);
	}, [
		e.phase,
		f,
		e.trumpSuit,
		...
		I.indexMode,
		I.trumpDisabledIndex
	]), z = A.suppressTurnPlayerId || M.suppressTurnIndicator, B = La(e.phase, u), re = z ? null : Ha(e.turnPlayerId, t), V = t.find((e) => e.isSelf), H = d != null && e.participantIds.includes(d) && (e.phase === "draw" || e.phase === "play"), U = s && !e.isFinal && !H && !a && V?.isOut === !0 && !!b.onRebuy, ie = !!(d && e.turnPlayerId === d) && !z, W = Wd({
		currentUserId: d,
		enrollmentActive: u,
		selfPlayer: V,
		session: e,
		...
		suppressTurn: !!z,
		handComplete: v
	}), se = F.showTrumpSuitReminder || !e.trumpUpcard && !!e.trumpSuit && e.phase === "play", ce = (0, l.useMemo)(() => ({ ...A.displayTricksByPlayer }), [A.displayTricksByPlayer]), le = (0, l.useMemo)(() => Object.fromEntries(t.map((e) => [e.playerId, Math.max(0, Number(e.bankroll) || 0)])), [t]), ue = Ld({
		turnPlayerId: e.turnPlayerId ?? null,
		dealerId: e.dealerId,
		...
		trickPhase: A.phase
	}), de = !!V?.playerId && (_ ?? []).includes(V.playerId) && ue.bourreAlerts[V.playerId] === "pulse", fe = (0, l.useRef)(0), pe = (0, l.useRef)(0);
	(0, l.useEffect)(() => {
		ue.feedbackErrorPulse > fe.current && Ls(), fe.current = ue.feedbackErrorPulse;
	}, [ue.feedbackErrorPulse]), (0, l.useEffect)(() => {
		ue.feedbackSuccessPulse > pe.current && Rs(), pe.current = ue.feedbackSuccessPulse;
	}, [ue.feedbackSuccessPulse]);
	let me = (0, l.useCallback)((e) => {
		...
		onSubmitDraw: (e) => {
			...
			let t = I.indexMode === "display" ? kf(e, I.trumpDisabledIndex) : e;
		...
		onPlayCard: (e) => {
			...
			let t = kf([e], I.trumpDisabledIndex)[0];
		...
		currentUserId: d,
		legalPlayIndices: L,
		recommendedPlayIndex: ne,
		recommendedDiscardIndices: R,
		handComplete: v,
		actionFeedback: y,
		trickPresentation: A,
		handPresentation: M,
		microinteractions: ue,
		instantTrickPlays: N,
		turnCountdown: oe,
		...he
		...
		S ? /* @__PURE__ */ (0, g.jsx)(Su, { ...ge }) : /* @__PURE__ */ (0, g.jsx)(mu, { ...ge })
	] }), ve = (0, l.useRef)(!1);
	return (0, l.useEffect)(() => {
		ve.current = !1;
	}, [e.handNumber, e.sessionId]), (0, l.useEffect)(() => {
		if (e.phase !== "reveal" || !M.trumpMergedIntoHand || M.phase !== "drawPlayer" || ve.current || !b.onAdvanceReveal) return;
		...
		children: [
			y && y.status !== "idle" && /* @__PURE__ */ (0, g.jsx)("div", {
				...
				"aria-live": "polite",
				children: y.message
			}, y.status === "error" ? `feedback-error-${ue.feedbackErrorPulse}` : y.status === "success" ? `feedback-success-${ue.feedbackSuccessPulse}` : `feedback-${y.status}`),
			/* @__PURE__ */ (0, g.jsxs)("header", {
				...
				children: [
					...
					re && ee && A.phase === "live" && /* @__PURE__ */ (0, g.jsx)("p", {
						className: "btable-session__turn muted small",
						"aria-live": "polite",
						children: re
					}),
					...
					u && !Va(e.phase) && /* @__PURE__ */ (0, g.jsx)("p", {
			...
			S ? /* @__PURE__ */ (0, g.jsx)(Eu, { children: /* @__PURE__ */ (0, g.jsx)("div", {
			...
			a && !e.isFinal && o && /* @__PURE__ */ (0, g.jsx)(Df, {
				session: e,
				players: t,
			...
			/* @__PURE__ */ (0, g.jsxs)("footer", {
				...
				children: [
					...
					r == null ? /* @__PURE__ */ (0, g.jsx)(g.Fragment, { children: "Shared pot and game state only · sign in to track your ledger" }) : /* @__PURE__ */ (0, g.jsxs)(g.Fragment, { children: ["Your session profit/loss ", hc(r)] })
				]
			})
		]
	});
...
var Ff = null, If = null;
function Lf(e, t) {
	Ns(), ra(e), If !== e && (Ff?.unmount(), Ff = (0, u.createRoot)(e), If = e), Ff.render(/* @__PURE__ */ (0, g.jsx)(Xs, { children: /* @__PURE__ */ (0, g.jsx)(Pf, { ...t }) }));
}
function Rf() {
	If && $l(If), Ff?.unmount(), Ff = null, If = null, bf();
}
//#endregion
export { $l as clearWonTrickCollectionArtifacts, _f as evaluateBotPresentationGate, gf as forceReleasePresentationForBots, ms as getFeedbackPrefs, pf as getTablePresentationBlockReason, xf as getTrickAnimationBusyState, hf as handPresentingBlocksBots, Ns as initGameFeedback, Cf as isTablePresentationBusy, vf as isTablePresentationBusyForBots, Sf as isTrickAnimationBusy, Lf as mountTableSession, Is as playBigWinFeedback, Ps as playShuffleFeedback, Fs as playTrickWinFeedback, hs as saveFeedbackPrefs, _s as subscribeFeedbackPrefs, wf as subscribeTrickAnimationBusy, Rf as unmountTableSession };
