...
function ot({ session: e, players: t, potMetrics: n, mySessionNet: r, myHandContribution: i, leaderLabel: a, showCoWinSettlement: o, splitSharePerWinner: s = 0, voteStatus: c, enrollmentActive: l = !1, enrollmentSecondsLeft: u = 0, currentUserId: d, heroCards: f = [], privateHandReady: p = !1, legalPlayIndices: m, actionFeedback: g, actions: _ }) {
	let v = e.participantIds.length, y = d != null && (e.pendingCoWinSettlement?.winnerIds || []).includes(d), x = t.find((e) => e.isSelf && e.canToggleInHand), C = b(e.phase, l), ne = S(e.turnPlayerId, t), T = ee(e.phase), re = !!(d && e.turnPlayerId === d);
	return /* @__PURE__ */ (0, h.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, h.jsxs)("header", {
				...
				children: [
					...
					ne && T && /* @__PURE__ */ (0, h.jsx)("p", {
						className: "btable-session__turn muted small",
						"aria-live": "polite",
						children: ne
					}),
					e.phase === "draw" && re && /* @__PURE__ */ (0, h.jsx)("p", {
