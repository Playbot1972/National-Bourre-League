...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	var V = R(null), re = R(null), H = R(null), ie = R(null);
	function U(e, t) {
		switch (B(H, t), B(re, e), B(V, null), t.nodeType) {
			case 9:
			case 11:
	...
	function se(e) {
		re.current === e && (z(V), z(re)), ie.current === e && (z(ie), $f._currentValue = I);
	}
	var ce, le;
	function ue(e) {
		if (ce === void 0) try {
	...
	function Ec(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 3:
				...
				return t;
			case 26: return cc(e, t), e === null ? (n = Af(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : q || (n = t.type, e = t.pendingProps, r = Vd(H.current).createElement(n), r[$e] = t, r[et] = e, Fd(r, n, e), ft(r), t.stateNode = r) : t.memoizedState = Af(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
	...
	function Nc(e, t, n) {
		...
		switch (Ci(t), t.tag) {
			...
			case 19:
				...
				return r.tail === null ? (Mc(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = be(), e.sibling = null, n = to.current, B(to, i ? n & 1 | 2 : n & 1), q && bi(t, r.treeForkCount), e);
			case 22:
	...
	function Iu(e, t, n, r, i, a, o, c, l) {
		...
		if (t !== null) {
			...
			if (a = t.lanes | t.childLanes, a |= Gr, We(e, n, a, o, c, l), e === Il && (X = Il = null, Z = 0), au = t, iu = e, ou = n, su = a, cu = i, lu = r, t.subtreeFlags & 10256 || t.flags & 10256 ? (e.callbackNode = null, e.callbackPriority = 0, Xu(we, function() {
				return Hu(), null;
...
function ee({ card: e, index: t, size: n, state: r, badge: i, cardTestId: a, cardInteraction: o, onCardClick: s, onCardPeek: c, peekActive: u, slotClassFor: d, dealSeatPlayerId: f, style: p }) {
	let [m, h] = (0, l.useState)(!1), v = o, y = v?.mode === "play", b = v?.mode === "draw-select", x = v?.mode === "peek", S = v?.isMyTurn === !0, C = !v?.legalPlayIndices || v.legalPlayIndices.includes(t), { playInteractive: T, playableOutline: E } = j({
		...
		index: t
	}), D = v?.playingIndex === t, O = y && S && !C && !v?.busy && !D, k = b && r === "draw-selected", A = b && r === "draw-recommended", M = r === "play-preselected", ee = r === "play-recommended", N = !!v?.busy || D || y && !S && !T || b && !S, te = N || y && !C && !T || b && !S, P = w({
		disabled: N || !T && !b && !x && !O,
...
var V = {
	...
	overwrite: !1,
	delay: 0
}, H, ie, U, ae = 1e8, oe = 1 / ae, se = Math.PI * 2, ce = se / 4, le = 0, ue = Math.sqrt, de = Math.cos, fe = Math.sin, pe = function(e) {
	...
	return U && !t && U.selector ? U.selector(e) : pe(e) && !n && (je || !kn()) ? Kt.call((t || Me).querySelectorAll(e), 0) : Se(e) ? Jt(e, n) : qt(e) ? Kt.call(e, 0) : e ? [e] : [];
}, Xt = function(e) {
	...
	var n = Se(e), r, i;
	return !n && _e(e) && (r = n = e.radius || ae, e.values ? (e = Yt(e.values), (i = !he(e[0])) && (r *= r)) : e = $t(e.increment)), Ht(t, n ? me(e) ? function(t) {
...
}), Rn("Back", Vn("in"), Vn("out"), Vn()), K.SteppedEase = K.steps = Ne.SteppedEase = { config: function(e, t) {
	e === void 0 && (e = 1);
...
var Hn = function(e, t) {
	...
	return t.delay = function(e) {
		...
		return this.play().totalTime(e ? -this._delay : 0, ve(t)), this._dur || (this._zTime = -oe), this;
	}, t.play = function(e, t) {
...
var Gn = function(e, t, n, r, i, a, o) {
	...
	if (pe(r) && (~r.indexOf("random(") && (r = ln(r)), r.charAt(1) === "=" && (p = it(d, r) + (Wt(d) || 0), (p || p === 0) && (r = p))), !l || d !== r || Xn) return !isNaN(d * r) && r !== "" ? (p = new vr(this._pt, e, t, +d || 0, r - (d || 0), typeof u == "boolean" ? dr : ur, 0, f), c && (p.fp = c), o && p.modifier(o, this, e), this._pt = p) : (!u && !(t in e) && Le(t, r), Gn.call(this, e, t, d, r, f, s || V.stringFilter, c));
	...
	if (b && (!f || !a) && (a = "none"), t._ease = Ln(a, re.ease), t._yEase = d ? Fn(Ln(d === !0 ? a : d, re.ease)) : 0, d && t._yoyo && !t._repeat && (d = t._yEase, t._yEase = t._ease, t._ease = d), t._from = !b && !!i.runBackwards, !b || f && !i.stagger) {
		if (O = g[0] ? $e(g[0]).harness : 0, M = O && i[O.prop], x = mt(i, Ue), h && (h._zTime < 0 && h.progress(1), n < 0 && u && s && !p ? h.render(-1, !0) : h.revert(u && m ? Ve : Be), h._lazy = 0), o) {
			...
			if (n && (s = !1), C = ut({
				...
				stagger: 0,
				parent: _
			}, x), M && (C[O.prop] = M), yt(t._startAt = ir.set(g, C)), t._startAt._dp = 0, t._startAt._sat = t, n < 0 && (ie ? t._startAt.revert(Ve) : t._startAt.render(-1, !0)), t._zTime = n, !s) e(t._startAt, oe, oe);
			else if (!n) return;
		}
		for (t._pt = t._ptCache = 0, c = m && ve(c) || c && !m, S = 0; S < g.length; S++) {
			...
			t._op && t._op[S] && t.kill(T, t._op[S]), y && t._pt && (Yn = t, W.killTweensOf(T, A, t.globalTime(n)), ee = !t.parent, Yn = 0), t._pt && c && (Ge[D.id] = 1);
		}
	...
	if (!c) for (c = e._ptCache[t] = [], d = e._ptLookup, f = e._targets.length; f--;) {
		...
		if (!l) return Xn = 1, e.vars[t] = "+=0", Zn(e, o), Xn = 0, s ? G(t + " not eligible for reset") : 1;
		c.push(l);
	}
...
var ir = /*#__PURE__*/ function(e) {
	...
	function t(t, n, r, i) {
		...
		if (a._targets = _.length ? Qe(_) : G("GSAP target " + t + " not found. https://gsap.com", !V.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = d, f || u || be(s) || be(c)) {
		...
		return d === !0 && !H && (Yn = z(a), W.killTweensOf(_), Yn = 0), At(g, z(a), r), n.reversed && a.reverse(), n.paused && a.paused(!0), (l || !s && !f && a._start === rt(g._time) && ve(l) && Ct(z(a)) && g.data !== "nested") && (a._tTime = -oe, a.render(Math.max(0, -c) || 0)), m && jt(z(a), m), a;
	}
	var n = t.prototype;
...
tt(Ze + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", function(e) {
	return Ue[e] = 1;
}), Ne.TweenMax = Ne.TweenLite = ir, Ne.TimelineLite = Ne.TimelineMax = Wn, W = new Wn({
	sortChildren: !1,
	defaults: re,
...
var yr = [], br = {}, xr = [], Sr = 0, Cr = 0, wr = function(e) {
	...
	return t.add = function(e, t, n) {
		...
		var r = this, i = function() {
			...
			return e && e !== r && e.data.push(r), n && (r.selector = Xt(n)), U = r, a = t.apply(r, arguments), me(a) && r._r.push(a), U = e, r.selector = i, r.isReverted = !1, a;
		};
	...
	exportRoot: function(e, t) {
		e === void 0 && (e = {});
		var n = new Wn(e), r, i;
		for (n.smoothChildTiming = ve(e.smoothChildTiming), W.remove(n), n._dp = 0, n._time = n._tTime = W._time, r = W._first; r;) i = r._next, (t || !(!r._dur && r instanceof ir && r.vars.onComplete === r._targets[0])) && At(n, r, r._start - r._delay), r = i;
		return At(W, n, 0), n;
	},
...
ir.version = Wn.version = Mr.version = "3.12.7", Fe = 1, ye() && kn(), K.Power0, K.Power1, K.Power2, K.Power3, K.Power4, K.Linear, K.Quad, K.Cubic, K.Quart, K.Quint, K.Strong, K.Elastic, K.Back, K.SteppedEase, K.Bounce, K.Sine, K.Expo, K.Circ;
//#endregion
...
var Nr, Pr, Fr, Ir, Lr, Rr, zr, Br = function() {
	...
	if (o.b = n, o.e = r, n += "", r += "", r === "auto" && (m = e.style[t], e.style[t] = r, r = gi(e, t) || r, m ? e.style[t] = m : wi(e, t)), l = [n, r], En(l), n = l[0], r = l[1], d = n.match(Te) || [], b = r.match(Te) || [], b.length) {
		for (; u = Te.exec(r);) h = u[0], _ = r.substring(s, u.index), p ? p = (p + 1) % 5 : (_.substr(-5) === "rgba(" || _.substr(-5) === "hsla(") && (p = 1), h !== (m = d[c++] || "") && (f = parseFloat(m) || 0, y = m.substr((f + "").length), h.charAt(1) === "=" && (h = it(f, h) + y), g = parseFloat(h), v = h.substr((g + "").length), s = Te.lastIndex - v.length, v || (v = v || V.units[t] || y, s === r.length && (r += v, o.e += v)), y !== v && (f = Di(e, t, m, v) || 0), o._pt = {
			_next: o._pt,
			p: _ || c === 1 ? _ : ",",
			s: f,
			c: g - f,
...
function Wa(e, t, n, r, i, a, o, s, c) {
	if (!(e === s && t === c)) {
		...
		C < 0 && (C = 0);
		var w = (a === o ? -1 : 1) * fa(C), T = w * (n * _ / r), E = w * -(r * g / n), D = (e + s) / 2, O = (t + c) / 2, k = D + (u * T - d * E), A = O + (d * T + u * E), j = (g - T) / n, M = (_ - E) / r, ee = (-g - T) / n, N = (-_ - E) / r, te = j * j + M * M, P = (M < 0 ? -1 : 1) * Math.acos(j / fa(te)), F = (j * N - M * ee < 0 ? -1 : 1) * Math.acos((j * ee + M * N) / fa(te * (ee * ee + N * N)));
		isNaN(F) && (F = f), !o && F > 0 ? F -= p : o && F < 0 && (F += p), P %= p, F %= p;
		var I = Math.ceil(da(F) / (p / 4)), ne = [], L = F / I, R = 4 / 3 * la(L / 2) / (1 + ua(L / 2)), z = u * n, B = d * n, V = d * -r, re = u * r, H;
		for (H = 0; H < I; H++) i = P + H * L, g = ua(i), _ = la(i), j = ua(i += L), M = la(i), ne.push(g - R * _, _ + R * g, j + R * M, M - R * j, j, M);
		for (H = 0; H < ne.length; H += 2) g = ne[H], _ = ne[H + 1], ne[H] = g * z + _ * V + k, ne[H + 1] = g * B + _ * re + A;
...
function as(e, t, n, r = {}) {
	Ko(r.root ?? document);
	let i = R(), a = ns(r.root ?? document), o = L(es, i), s = i ? .03 : .055, c = J.timeline({ onComplete: () => {
...
function nf({ cards: e, phase: t, enrollmentActive: n = !1, isInHand: r = !1, isDealer: i = !1, signedIn: a = !1, isMyTurn: o = !1, drawCompleted: s = !1, maxDrawDiscards: c = 4, legalPlayIndices: u, recommendedPlayIndex: d = null, recommendedDiscardIndices: f = [], handComplete: p = !1, actionFeedback: m, onSubmitDraw: h, onPassDraw: _, onFoldDraw: v, onPlayCard: y, privateHandReady: b = !1, className: x = "", dealStaggerMs: S = 120, drawAnimSubPhase: C = null, drawDiscardCount: w = 0, drawReplaceCount: T = 0, currentUserId: E = null, revealedTrumpIndex: D = null, trumpMergeActive: O = !1, trumpDisabledIndex: k = null, handNumber: A = 0, trickNumber: j = null, turnPlayerId: M = null, tableRootRef: ee, pileIndexRef: te, onDiscardCommitted: P, onUserActivity: F, skipHeroDealMotion: I = !1 }) {
	let { settings: ne } = hd(), [L, R] = (0, l.useState)(/* @__PURE__ */ new Set()), [z, B] = (0, l.useState)(null), [V, re] = (0, l.useState)(null), [H, ie] = (0, l.useState)(null), [U, ae] = (0, l.useState)(!1), [oe, se] = (0, l.useState)(null), [ce, le] = (0, l.useState)(null), [ue, de] = (0, l.useState)(null), [fe, pe] = (0, l.useState)(() => oc()), [me, he] = (0, l.useState)(!1), [ge, _e] = (0, l.useState)(!1), [ve, ye] = (0, l.useState)(!1), [be, xe] = (0, l.useState)([]), Se = (0, l.useRef)(/* @__PURE__ */ new Set()), Ce = (0, l.useRef)(null), we = (0, l.useRef)(!1), Te = (0, l.useRef)(null), Ee = (0, l.useRef)(null), De = (0, l.useRef)(0), Oe = (0, l.useRef)({
		handNumber: 0,
		trickNumber: null,
		turnPlayerId: null,
		isMyTurn: !1,
		...
		turnPlayerId: M,
		phase: t ?? null
	}), [W, Ae] = (0, l.useState)(!1), je = (0, l.useRef)(async () => {}), Me = Fs(t), Ne = (0, l.useMemo)(() => e.map(Ms), [e]), Pe = (0, l.useMemo)(() => e.map((e) => `${e.rank}-${e.suit}`).join("|"), [e]), Fe = (0, l.useMemo)(() => f.slice().sort((e, t) => e - t).join(","), [f]), Ie = t === "draw", Le = t === "play", G = U || m?.status === "loading" || V !== null;
	Oe.current = {
		handNumber: A,
		trickNumber: j,
		turnPlayerId: M,
	...
	(0, l.useEffect)(() => {
		...
		he(!0), re(null), B(null);
		let i = js(e.length, S), a = window.setTimeout(() => he(!1), i);
		...
		(C === "done" || C === null) && xe([]);
	}, [C]), (0, l.useEffect)(() => (Zd(V !== null), () => Zd(!1)), [V]), As(Ce, {
		dealing: me,
		dealStaggerMs: S,
		drawAnimSubPhase: C,
		drawDiscardCount: w,
	...
	(0, l.useEffect)(() => () => ze(), [ze]), (0, l.useEffect)(() => {
		ze(), B(null), R(/* @__PURE__ */ new Set()), Ae(!1), ie(null), le(null), de(null), se(null);
	}, [
		t,
		Pe,
		ze
	]), (0, l.useEffect)(() => {
		z !== null && (Lc(z, u) || (B(null), Ee.current = null, ze()));
	}, [
		u,
		z,
		ze
	...
	(0, l.useEffect)(() => {
		...
		let e = Pc(He.current), t = Pc(ke);
		He.current = ke, Be(), ze("play-activity-change"), Nc(e, t) && B(null);
	}, [
		ke,
		Be,
		ze,
		...
		m?.status === "success" ? (re(null), ze(), we.current = !1) : m?.status === "error" && (re(null), we.current = !1);
	}, [m?.status, ze]);
	...
	let We = ne.cardScale === "lg" ? "md" : "sm", Ge = ed(m?.status === "error" ? m.message : oe), Ke = Ns(t, n);
	(0, l.useEffect)(() => {
		F && Ie && L.size > 0 && F();
	}, [
		Ie,
	...
	let qe = (0, l.useCallback)(() => {
		...
		if (!Lc(e, u)) return;
		Be(), ze(), we.current = !0, re(e), se(null), De.current;
		let n = Ne[e];
		E && n && Qs(E, Vs({
			playerId: E,
			card: {
		...
		try {
			await Promise.resolve(y(e)), re(null), B(null), we.current = !1;
		} catch {
		...
		let n = Lc(e, u);
		if (!n) {
			o && (qu(), Be(), ze("illegal"), B(null), le(e), de(e), window.setTimeout(() => {
				le(null), de(null);
			}, tc.illegalFlash), se("Illegal play"));
			return;
		}
		let r = Ac({
			selectedPlay: z,
		...
		B(r.nextSelection), se(null), qe(), r.nextSelection !== null && Xu(), r.shouldQueueSelection, r.nextSelection;
	}, [
		Be,
		G,
		ze,
		...
		if (we.current || G || !y || t !== "play") return;
		let n = Lc(e, u);
		we.current, jc(o, n) && (Be(), ze("swipe"), B(e), Ye(e, "swipe"));
	}, [
		Be,
		G,
		ze,
	...
	let $e = (0, l.useCallback)(async (e) => {
		if (!(!h || G)) {
			if (Jl("draw-button"), Zu(), qe(), e.length > c) {
				se(`You may discard at most ${c} cards`);
				return;
			}
			ae(!0), se(null), xe([...e]), Bu(e.length);
			try {
		...
		qu(), ze(), B(null), le(e), de(e), window.setTimeout(() => {
			le(null), de(null);
		}, tc.illegalFlash), se("Illegal play");
	...
	}, [W]), it = a && r && (Ie || Le), at = (0, l.useMemo)(() => Bc({
		selectedDraw: L,
	...
	if (!r && !n && !Me) return /* @__PURE__ */ (0, g.jsx)(tf, { className: x });
	if (Me && r && e.length === 0) return p && n ? /* @__PURE__ */ (0, g.jsx)(tf, { className: x }) : /* @__PURE__ */ (0, g.jsxs)("div", {
		className: ef(ne, x),
		"aria-live": "polite",
		"data-testid": "hero-hand",
		children: [/* @__PURE__ */ (0, g.jsx)("p", {
	...
	if (e.length === 0 && !i) return it ? /* @__PURE__ */ (0, g.jsx)("div", {
		className: ef(ne, x, ["btable-hero--reserved"]),
		"data-testid": "hero-hand",
		"aria-live": "polite",
		children: /* @__PURE__ */ (0, g.jsx)("div", {
			className: "btable-hero__hand-3d btable-hero__hand-3d--chrome-only",
...
var Lf = 1080, Rf = 5250 + Vf({}).pipelineMs + 500;
function zf(e) {
...
function Bf(e = !1) {
	...
	return {
		...
		trickSweepMs: Math.round(Lf * t),
		nextLeadGapMs: Math.round(230 * t),
		trumpBeatReadMs: Math.round(625 * t)
	};
}
function Vf(e) {
	let t = Bf(e.reducedMotion), n = e.trumpBeat ? t.trumpBeatReadMs : t.postTrickReadMs, r = Math.min(t.winnerRevealMs, n - 200), i = Math.max(200, n - r), a = t.trickSweepMs, o = t.nextLeadGapMs;
	return {
...
function Kf(e) {
	let t = Wf(e.prevTrick), n = e.playedCards?.filter((t) => t.trickNumber === e.trickNumber).map((e) => ({
		playerId: e.playerId,
		card: e.card
	})) ?? [];
...
function Jf(e) {
	let { prevTricks: t, nextTricks: n, prevTrick: r, playedCards: i } = e, a = Uf(e.participantIds, t, n), o = _f(t, a), s = _f(n, a);
	if (s <= o) return null;
	let c = Hf(t, n, a), l = r?.trickNumber ?? s, u = Kf({
		prevTrick: r,
		playedCards: i,
		trickNumber: l
	});
...
function Zf({ play: e, index: t, presentationPhase: n, displayCount: r, playerName: i, leaderPlayerId: a = null, winnerPlayerId: o = null, instantPlace: s = !1, currentUserId: c = null, onCardLanded: u }) {
	...
	let O = Vs(e), k = a != null && e.playerId === a, A = o != null && e.playerId === o, j = n === "live", M = t === r - 1 && j, ee = v, N = k && (n === "live" || n === "trickComplete"), te = N || A && n !== "live" && n !== "trickComplete";
	(0, l.useLayoutEffect)(() => {
...
function $f({ displayPlays: e = [], leaderPlayerId: t = null, winnerPlayerId: n = null, showWinnerTag: r = !1, presentationPhase: i = "live", playerNames: a = {}, variant: o = "live", instantTrickPlays: s = !1, peakCardCount: c = 0, participantCount: u = 0, currentUserId: d = null, onCardLanded: f }) {
	(0, l.useEffect)(() => {
	...
	let { layoutCardCount: p, trickActive: m } = Qf(e.length, c, u);
	...
	return /* @__PURE__ */ (0, g.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, g.jsxs)("div", {
			...
			children: [r && h && /* @__PURE__ */ (0, g.jsxs)("div", {
				...
				style: { "--trick-card-count": p },
				children: e.map((r, o) => /* @__PURE__ */ (0, g.jsx)(Zf, {
					play: r,
					index: o,
...
function tp({ potMetrics: e, participantCount: t, trumpUpcard: n, trumpSuit: r, phase: i, enrollmentActive: a = !1, remainingDeckCount: o, trickDisplayPlays: s = [], trickLeadSuit: c = null, trickLeaderPlayerId: u = null, trickWinnerPlayerId: f = null, trickShowWinnerTag: p = !1, trickPresentationPhase: m = "live", trickEchoPlays: h = [], trickEchoWinnerId: v = null, trickEchoPhase: y = "live", showFinalTrickEcho: b = !1, playerNames: x = {}, anteAnimActive: S = !1, trumpRevealActive: C = !1, drawAnimPlayerId: w = null, drawAnimSubPhase: T = "done", drawDiscardCount: E = 0, settleAnimActive: D = !1, settleCarryOver: O = !1, potTick: k = 0, trumpReminderPulse: A = 0, hideCenterTrump: j = !1, trumpMergeActive: M = !1, showTrumpSuitReminder: ee = !1, instantTrickPlays: N = !1, peakTrickPlayCount: te = 0, discardPileCards: P = [], currentUserId: F = null, onCardLanded: I }) {
	...
	let H = !!V && !j, ie = ee || !H && !!r && i === "play", U = H ? `${V.rank}-${V.suit}` : "trump-slot", ae = b || D && h.length > 0 && z === 0;
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, g.jsxs)("div", {
			...
			children: [
				...
				i === "draw" ? /* @__PURE__ */ (0, g.jsx)(ep, { cards: P }) : null,
				/* @__PURE__ */ (0, g.jsxs)("div", {
				...
				/* @__PURE__ */ (0, g.jsxs)("dl", {
					...
					children: [
						/* @__PURE__ */ (0, g.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, g.jsx)("dt", { children: "Table pot" }), /* @__PURE__ */ (0, g.jsx)("dd", { children: Sf(e.currentPot) })]
...
function np({ label: e, value: t, accent: n, title: r }) {
...
function rp({ player: e, compact: t = !1 }) {
	...
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		...
		children: [n && /* @__PURE__ */ (0, g.jsxs)(g.Fragment, { children: [
			...
			e.apeClass && /* @__PURE__ */ (0, g.jsx)(np, {
				label: "Class",
				value: e.apeClass,
				title: "Ape Class"
			}),
			e.apeStatus && /* @__PURE__ */ (0, g.jsx)(np, {
				label: "Status",
				value: e.apeStatus,
				title: "Ape Status"
			})
		] }), e.sessionStreak != null && e.sessionStreak > 0 && /* @__PURE__ */ (0, g.jsx)(np, {
			label: "Streak",
...
var ip = 22, ap = 2 * Math.PI * ip;
function op({ progress: e, segment: t, reducedMotion: n = Yf() }) {
...
function sp({ player: e, region: t, handLane: n = "below", style: r, clockwiseDealing: i = !1, onToggleInHand: a, onPassEnrollment: o, onTrickDelta: s, onReaction: c }) {
							...
							children: [
								...
								/* @__PURE__ */ (0, g.jsxs)("div", {
									...
									children: [
										...
										e.turnCountdown && /* @__PURE__ */ (0, g.jsx)(op, {
...
function lp(e, t, n) {
	let r = new Map(e.map((e) => [e.playerId, e])), i = cp(e.map((e) => e.playerId), t);
...
function fp(e, t) {
	return e < 0 || e > 6 ? null : up(t)[e] ?? null;
}
function pp(e, t, n) {
	let r = fp(e, t);
	return r ? {
...
function gp(e, t) {
	return e < 0 || e > 7 ? null : mp(t)[e] ?? null;
}
function _p(e, t, n) {
	let r = gp(e, t);
	return r ? {
...
function Mp(e, t) {
	let n = Ap(e.x, Dp.min, Dp.max), r = t === "portrait" ? Op : kp, i = Ap(e.y, 8, r);
	return {
		...e,
		x: n,
		y: i
...
function Np(e, t, n) {
	...
	if (n.isMobile && n.orientation && hp(t)) {
		let t = _p(e, n.orientation, { isSelf: n.isSelf });
		if (t) return t;
	}
	let r = Ff(e, t), i = n.isMobile && n.orientation ? Mp(r, n.orientation) : r;
	return {
		...i,
		seatIndex: e,
		handLane: jp(i, {
...
var Ip = 1e3, Lp = 1e3, Rp = 12e3, zp = 4e3, Bp = Rf;
function Vp(e = Yf()) {
...
function Hp(e, t, n = Yf()) {
	let r = Vp(n), i = Math.max(0, e), a = Math.max(0, t);
...
function Wp(e, t, n, r) {
	let i = Up(e, t, n), a = Math.max(152, n);
	return {
		height: i.peak > 0 ? Math.min(i.height, r) : Math.min(a, r),
		peak: i.peak
	};
}
function Gp(e, t, n = 72) {
	return Up(e, t, n);
}
function Kp(e, t) {
	let n = Math.max(.75, e);
...
function im({ aspect: e, enabled: t = !0, sessionKey: n }) {
	let r = (0, l.useRef)(null), i = (0, l.useRef)(0), a = (0, l.useRef)(0), o = (0, l.useRef)(n), { settings: s } = hd(), c = $p();
	return (0, l.useLayoutEffect)(() => {
		...
		let u = l.closest(".btable-desktop__viewport") ?? l.closest(".table-play-overlay__main") ?? l.closest(".btable-session"), d = window.visualViewport, f = () => {
			if (Qd()) return;
			let t = !!l.closest(".table-play-overlay"), n = typeof window < "u" && window.matchMedia("(orientation: portrait)").matches, r = rm(l, c).getBoundingClientRect(), o = l.querySelector(".hand-panel")?.getBoundingClientRect(), u = t && c && n ? 100 : t && !c ? 120 : c ? 112 : 148, f = t && c && n || t && !c ? 200 : c ? 210 : 280, p = o?.height ?? 0, m = Wp(p, i.current, u, f);
			i.current = m.peak;
			...
			if (t && c) {
				...
				if (e) x = e.width, S = e.height;
					...
					let e = Gp(tm(l, c), a.current, 72);
					a.current = e.peak, S = Math.max(160, S - e.height);
				}
			}
			let C = Math.max(.85, Math.min(1.35, s.tableScale || 1)), w = t && c ? 1 : C, T = c ? Kp(e, { portrait: n }) : e, E = parseInt(getComputedStyle(l).getPropertyValue("--player-count").trim(), 10) || 4, D = t && c && !n, O = D ? {
				...Jp({
					availWidth: x,
					availHeight: S,
					aspect: T,
			...
			if (l.style.setProperty("--stage-fit-width", `${Math.round(A)}px`), l.style.setProperty("--stage-fit-height", `${Math.round(j)}px`), l.style.setProperty("--stage-fit-scale", String(O.fitScale)), l.style.setProperty("--stage-effective-scale", String(M)), (l.closest(".btable-desktop__scale") ?? l.parentElement)?.style.setProperty("--stage-effective-scale", String(M)), localStorage.getItem("stageFitDebug") === "1") {
				let e = l.querySelector(".table-stage"), a = l.querySelectorAll(".bseat__avatar-wrap"), o = e ? Xp(e.getBoundingClientRect()) : null, s = Xp(document.documentElement.getBoundingClientRect()), u = [...a].filter((e) => !Zp(Xp(e.getBoundingClientRect()), s, 1)).length;
		...
		}, h = new ResizeObserver(m), g = rm(l, c);
...
function om({ handPresentation: e, handNumber: t, currentUserId: n, tableRootRef: r }) {
...
function cm({ handNumber: e, sessionPhase: t, turnPlayerId: n, drawCompletedIds: r, currentUserId: i, handPresentation: a, tableRootRef: o }) {
...
function vm({ steps: e, root: t, trumpHolderId: n = null, onStepComplete: r, onComplete: i }) {
	...
	if (lm.add(u), !l || e.length === 0) {
		for (let r of e) hm(r.playerId, r.roundIndex, t, n);
		return u.call(() => i?.()), u;
	}
	e.forEach((e, i) => {
		...
		u.call(() => {
			if (!f) {
				hm(e.playerId, e.roundIndex, t, n), r?.(e);
				return;
			}
			let i = mm(l);
			t.appendChild(i);
			let c = $i(i), { x: u, y: d } = na(c, l), p = f.left + f.width / 2, m = f.top + f.height / 2, h = c.left + c.width / 2, g = c.top + c.height / 2, _ = p - h, v = m - g, { midX: y, midY: b } = pm(_, v);
			J.set(i, {
				transformOrigin: "50% 80%",
				willChange: "transform,opacity",
				x: u,
			...
			let x = J.timeline({ onComplete: () => {
				i.remove(), hm(e.playerId, e.roundIndex, t, n), r?.(e);
			} });
			a ? x.to(i, {
				x: _,
				y: v,
	...
	let d = dm(e.length, a) + 120, f = window.setTimeout(() => {
...
function ym({ session: e, heroCards: t, privateHandReady: n = !1, dealPresentationAllowed: r = !0, tableRootRef: i }) {
	let [a, o] = (0, l.useState)(!1), s = (0, l.useRef)(null), c = (0, l.useRef)(e.handNumber);
	return (0, l.useLayoutEffect)(() => {
		let t = i.current;
		t && c.current !== e.handNumber && (c.current = e.handNumber, s.current = null, _m(), gm(t), Q(!1), o(!1));
		...
		let d = cp(e.participantIds, e), f = lc(e.dealerId, e.participantIds, d.length ? d : e.participantIds);
		if (f.length < 2) return;
		let p = um(f, 5);
		if (!p.length) return;
		s.current = u, _m(), gm(a), a.classList.add("btable-wrap--clockwise-dealing"), o(!0), Q(!0);
		let m = Yf(), h = window.requestAnimationFrame(() => {
			vm({
				steps: p,
				root: a,
		...
		return () => {
			window.cancelAnimationFrame(h), window.clearTimeout(g), _m(), a.classList.remove("btable-wrap--clockwise-dealing"), Q(!1), o(!1);
		};
	}, [
		e.handNumber,
		e.phase,
...
function Sm(e, t = {}) {
	...
	let d = L(I.trumpMerge), f = a * .45, p = o * .45 - Math.max(24, Math.hypot(a, o) * .18), m = J.timeline({
		onComplete: () => {
			s.remove(), J.set(r, { clearProps: "opacity" }), c && J.set(c, { clearProps: "opacity" }), J.set(n, { clearProps: "opacity" }), bm = null, t.onComplete?.();
		},
		onInterrupt: () => {
			s.remove(), J.set(r, { clearProps: "opacity" }), c && J.set(c, { clearProps: "opacity" }), J.set(n, { clearProps: "opacity" }), bm = null;
		}
	});
	return m.add(qo(s, {
		path: [
...
function Cm({ tableRootRef: e, trumpMergeActive: t, isTrumpHolder: n, onComplete: r }) {
	...
	a.current = r, (0, l.useEffect)(() => {
		...
		return () => {
			s = !0, window.cancelAnimationFrame(l), xm();
		};
	}, [
		t,
		n,
...
function Em(e, t) {
	let n = wm(`${e}@book${t}`), r = Tm(n, 0), i = Tm(n, 9), a = Tm(n, 17), o = r >= .5 ? 1 : -1, s = i >= .5 ? 1 : -1;
	return {
...
var Om = /* @__PURE__ */ new Set(), km = /* @__PURE__ */ new Set(), Am = I.drawDiscard;
function jm(e, t) {
	return {
		midX: e * .5,
		midY: t * .5
...
function Nm() {
	for (let e of km) J.set(e, { clearProps: "opacity,transform,willChange,zIndex" });
	km.clear();
}
function Pm(e) {
	let t = e instanceof Document ? e : e.ownerDocument ?? document;
...
function Vm(e, t) {
	Ko(t.root ?? document);
	let n = R(), r = t.root ?? document, i = t.host ?? (r instanceof HTMLElement ? r : document.body), a = Mm(t.winnerPlayerId, r), o = n ? .06 : 140 / 1e3, s = L(Am, n), c = n ? .03 : .05, l = [], u = (e) => {
		Om.delete(d);
		for (let e of l) e.remove();
		Nm(), e && Bm(t.winnerPlayerId, r), t.onComplete?.();
	}, d = J.timeline({
		onComplete: () => u(!0),
		onInterrupt: () => u(!1)
	});
	Om.add(d), e.forEach((e, r) => {
		let u = Em(t.trickKey, t.bookIndex), f = zm(e, i);
		l.push(f), km.add(e), J.set(e, { opacity: 0 });
		let p = $i(f);
		J.set(f, {
			transformOrigin: "50% 50%",
			willChange: "transform,opacity",
		...
		let h = a.left + a.width / 2 + u.offsetX, g = a.top + a.height / 2 + u.offsetY, _ = p.left + p.width / 2, v = p.top + p.height / 2, y = h - _, b = g - v, { midX: x, midY: S } = jm(y, b);
		d.to(f, {
			scale: .98,
			duration: o,
			ease: te
	...
	return Rm(d, Math.min(760, Math.max(300, f))), d;
}
function Hm() {
	return Om.size > 0;
}
...
var Wm = new Set(["nextLeadReady", "live"]);
function Gm({ trickPresentation: e, handNumber: t, sessionPhase: n = null, handComplete: r = !1, tableRootRef: i, onTrickCollectionStart: a }) {
	...
	(0, l.useLayoutEffect)(() => {
		...
		if (s.current !== t) {
			if (c) return;
			s.current = t, o.current = null, d(), Im(a);
			return;
		}
		if (r || n != null && n !== "play") {
			if (c) return;
			o.current = null, d(), Im(a);
		}
	}, [
		t,
		r,
		...
		c.current = r;
		let s = i.current;
		if (!s || (n === "collectTrick" && Wm.has(r) && (o.current = null, f(s)), r !== "collectTrick")) return;
		let l = e.trickWinnerSeatId, u = e.frozenTrick;
		if (!l || !u) return;
		let p = `${u.trickNumber}:${l}:${u.plays.length}`;
		if (o.current === p) return;
		o.current = p, d(), Lm(), qm(s);
		let m = Um(s);
		if (!m.length) return;
		let h = Math.max(0, (e.displayTricksByPlayer[l] ?? 1) - 1), g = Dm({
			playerId: l,
			handNumber: t,
...
function Jm({ trickPresentation: e, currentUserId: t = null, participantCount: n, trickNumber: r, sessionPhase: i = null }) {
...
function $m(e, t) {
	return Zm(t) ? Zm(e) ? Qm(t) >= Qm(e) ? t : e : t : e;
}
function eh(e) {
	let t = e?.phase ?? null;
...
function th(e) {
	let t = e?.currentHand ?? Ym(), n = e?.liveEnrollment?.deal?.publicHand, r = n?.phase ?? null;
	if (Xm(t) && n && !Zm(n)) return Ym();
	if (Zm(t) && Zm(n)) {
		...
		return e && n?.phase === "draw" && o === 0 && a === 0 && r > 0 && i === 0 ? t : $m(t, n);
	}
	if (Zm(t)) return t;
	if (r === "draw" || r === "play" || r === "reveal" || r === "decision") {
		if (Zm(n)) {
			let i = _f(n?.tricksByPlayer ?? {}, n?.participantIds ?? []);
			return Xm(t) && i === 0 && r === "draw" && !e?.liveEnrollment?.active ? Ym() : n;
		}
		return n?.phase ? n : eh(t) ? t : Xm(t) ? Ym() : t;
	}
	return r && n ? n : t;
}
function nh(e) {
	let t = th(e), n = t?.phase ?? null;
...
new Map(sh.map((e) => [ch(e.from, e.event), e.to]));
function lh(e) {
...
function fh(e) {
	let t = e.session, n = t ? th(t) : dh(), r = n.phase ?? null, i = n.participantIds ?? [], a = n.tricksByPlayer ?? {}, o = _f(a, i), s = i.length > 0 && vf(a, i), c = !!t?.pendingCoWinSettlement?.winnerIds?.length, l = t ? nh(t) : null, u = ih(r, n.handDecision ?? null), d = rh({
...
function xh(e, t, n, r, i) {
	...
	let a = t.showRevealedTrumpAtHolder ? bh(r) : null;
	return {
...
function Sh({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: u = !1, showTrumpSuitReminder: d = !1, trumpHolderPresentation: f, privateHandReady: p = !1, currentUserId: m = null, legalPlayIndices: h, recommendedPlayIndex: _, recommendedDiscardIndices: v = [], handComplete: y = !1, actionFeedback: b, trickPresentation: x, handPresentation: S, microinteractions: C, instantTrickPlays: w = !1, turnCountdown: T = null, bigPotEvent: E = null, onDismissTableEvent: D, onToggleInHand: O, onPassEnrollment: k, onTrickDelta: A, onSubmitDraw: j, onPassDraw: M, onFoldDraw: ee, onPlayCard: N, onReaction: te, onHeroUserActivity: P }) {
	...
	let { cards: H, pileIndexRef: ie, commitDiscardCards: U } = Cs({
	...
	let le = new Set(e.participantIds.filter((t) => bf(t, x.displayTricksByPlayer, e.participantIds, e.phase))), ue = F.map((t) => {
		let r = x.displayTricksByPlayer[t.playerId] ?? 0, i = x.trickWinnerSeatId === t.playerId, a = x.suppressTurnPlayerId || S.suppressTurnIndicator, o = x.phase === "collectTrick" && i, s = S.enrollmentPulse[t.playerId], c = S.animatingDrawPlayerId === t.playerId, l = xh(t.playerId, f, e.trumpUpcard ?? null, t.holeCardCount ?? 0, t.isSelf);
		return {
			...t,
			...l,
	...
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		...
		style: {
			...
			"--trick-sweep-ms": `${Lf}ms`,
			"--trick-rake-ms": "240ms",
			"--trick-post-read-ms": "525ms",
			"--trick-next-lead-gap-ms": "230ms",
			"--trick-final-pipeline-ms": `${925 + Lf + 230}ms`,
...
var wh = "(orientation: portrait)";
function Th() {
	let e = $p(), [t, n] = (0, l.useState)(() => typeof window < "u" && window.matchMedia(wh).matches);
	return (0, l.useEffect)(() => {
		let e = window.matchMedia(wh), t = () => n(e.matches);
...
function kh({ aspect: e, sessionKey: t }) {
	let n = (0, l.useRef)(null), r = (0, l.useRef)(0), i = (0, l.useRef)(0), a = (0, l.useRef)(t), o = Th(), { settings: s } = hd(), c = o === "mobile-portrait";
	return (0, l.useLayoutEffect)(() => {
		...
		let l = window.visualViewport, u = () => {
			if (Qd()) return;
			let t = Oh(o).getBoundingClientRect(), n = o.querySelector(".btable-mobile-hero-dock")?.getBoundingClientRect(), a = !!o.closest(".table-play-overlay"), u = c ? 104 : 92, d = c ? 210 : 168, f = Wp(n?.height ?? 0, r.current, u, d);
			r.current = f.peak;
			let p = f.height, m = parseInt(getComputedStyle(o).getPropertyValue("--player-count").trim(), 10) || 4, h = m <= 4, g = !c, _ = (g && h ? Eh("--mobile-fit-pad-x", 4) : Eh("--mobile-fit-pad-x", 8)) + (g && a ? 4 : 12), v = (g && h ? Eh("--mobile-fit-pad-y", 2) : Eh("--mobile-fit-pad-y", 6)) + (g && a ? 4 : 10), y = Eh("--mobile-fit-gap", c ? 8 : 6), b = l, x = Math.min(t.width, b?.width ?? window.innerWidth), S = Math.min(t.height, b?.height ?? window.innerHeight);
			if (a) {
				let e = Gp(Dh(o), i.current, 72);
...
function Ah({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: u = !1, showTrumpSuitReminder: d = !1, trumpHolderPresentation: f, privateHandReady: p = !1, currentUserId: m = null, legalPlayIndices: h, recommendedPlayIndex: _, recommendedDiscardIndices: v = [], handComplete: y = !1, actionFeedback: b, trickPresentation: x, handPresentation: S, microinteractions: C, instantTrickPlays: w = !1, turnCountdown: T = null, bigPotEvent: E = null, onDismissTableEvent: D, onToggleInHand: O, onPassEnrollment: k, onTrickDelta: A, onSubmitDraw: j, onPassDraw: M, onFoldDraw: ee, onPlayCard: N, onHeroUserActivity: te }) {
	let P = Th() === "mobile-landscape" ? "landscape" : "portrait", F = t.map((e) => ({
		...e,
		isSelf: e.isSelf || m != null && e.playerId === m
	})), I = lp(F, e, m), ne = I.filter((e) => !e.isSelf), L = I.find((e) => e.isSelf), R = L ? Fp(I.length, P) : null, z = I.length, B = `btable--p${Math.min(8, Math.max(2, z))}`, V = Ch(ne.length, P), re = Object.fromEntries(t.map((e) => [e.playerId, e.displayName])), H = Vp(), ie = e.sessionId, U = kh({
		aspect: V,
		sessionKey: ie
	});
	(0, l.useEffect)(() => {
	...
	let fe = new Set(e.participantIds.filter((t) => bf(t, x.displayTricksByPlayer, e.participantIds, e.phase))), pe = F.map((t) => {
		let r = x.displayTricksByPlayer[t.playerId] ?? 0, i = x.trickWinnerSeatId === t.playerId, a = x.suppressTurnPlayerId || S.suppressTurnIndicator, o = x.phase === "collectTrick" && i, s = S.enrollmentPulse[t.playerId], c = S.animatingDrawPlayerId === t.playerId, l = xh(t.playerId, f, e.trumpUpcard ?? null, t.holeCardCount ?? 0, t.isSelf);
		return {
			...t,
			...l,
					...
					children: /* @__PURE__ */ (0, g.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, g.jsxs)("div", {
								...
								"aria-label": "Players at the table",
								children: [ne.map((e, t) => {
									let n = Pp(t, I.length, P), r = pe.find((t) => t.playerId === e.playerId) ?? e;
									return /* @__PURE__ */ (0, g.jsx)("div", {
										className: `btable__seat-slot btable__seat-slot--${t}`,
										"data-seat-index": t + 1,
										children: /* @__PURE__ */ (0, g.jsx)(sp, {
...
var jh = new Set(["pot-cap", "hand-win"]);
function Mh({ events: e, onDismiss: t }) {
	let n = [...e].reverse().find((e) => jh.has(e.kind));
	return (0, l.useEffect)(() => {
		if (!n) return;
...
function Nh({ children: e }) {
	let { settings: t } = hd(), n = t.layoutMode === "tiled", r = $p();
	return /* @__PURE__ */ (0, g.jsx)("div", {
		className: [
			"btable-desktop",
...
function Fh({ events: e, onDismiss: t }) {
...
function Vh({ session: e, potMetrics: t, participantIds: n }) {
...
function qh(e) {
	...
	return e.phase === "reveal" ? lg(t, e) : t;
}
function Jh(e, t, n = {}) {
	return {
		...e,
...
function Xh(e, t, n) {
	for (let r of n.drawCompletedIds) if (!Zh(e, r) && !e.displayDrawCompletedIds.includes(r) && !t.drawCompletedIds.includes(r)) return r;
	return null;
}
function Zh(e, t) {
...
function eg(e, t) {
	return !t || Zh(e, t) ? e.drawPresentationConsumedIds : [...e.drawPresentationConsumedIds, t];
}
function tg(e, t) {
	return [...new Set([...e.drawPresentationConsumedIds, ...t])];
}
function ng(e, t, n) {
	for (let r of t.actionOrder) if (t.participantIds.includes(r) && t.drawCompletedIds.includes(r) && !n.includes(r) && !Zh(e, r)) return r;
	return null;
}
function rg(e, t, n, r) {
...
function ag(e, t) {
	...
	let r = e.displayDrawCompletedIds.includes(n) ? e.displayDrawCompletedIds : [...e.displayDrawCompletedIds, n], i = eg(e, n), a = t == null ? e.prevSnapshot : {
		...t,
		drawCompletedIds: [...r]
	};
	return ig("payload", e, {
...
function sg(e, t, n, r, i, a) {
	return Zh(e, n) ? (rg(e, t, null, `consumed-skip:${n}:${a}`), e) : Qh(e) && e.animatingDrawPlayerId !== n ? (rg(e, t, null, `in-flight-skip:${a}`), e) : (rg(e, t, n, a), Jh(e, "drawPlayer", {
		animatingDrawPlayerId: n,
		drawAnimSubPhase: og(r, i),
		drawDiscardCount: r,
		drawReplaceCount: i,
		prevSnapshot: t,
		drawPresentationConsumedIds: eg(e, n)
	}));
}
function cg(e) {
	if (!e.pendingHandSettle || e.phase !== "play") return e;
	let t = e.handSettleSnapshot ?? e.prevSnapshot;
	return t ? Jh(e, "settle", {
		pendingHandSettle: !1,
		handSettleSnapshot: null,
		settleAnimActive: !0,
...
function ug(e, t, n, r) {
	...
	return i ? sg(e, t, i, n, r, "beginDrawSequence") : Jh(e, "drawPlayer", {
...
function fg(e, t) {
	switch (t.type) {
		...
		case "watchdog": return e.pendingHandSettle && e.phase === "play" ? cg(e) : Date.now() - e.phaseStartedAt < 12e3 ? e : pg({
			...e,
			pendingSnapshot: e.pendingSnapshot ?? e.prevSnapshot
		});
		case "tryBeginHandSettle": return cg(e);
		...
		case "serverUpdate": {
			...
			if (e.sessionKey !== n.sessionKey) {
				let e = qh(n);
				return n.phase === "reveal" ? lg(e, n) : e;
			}
			...
			let o = Hh(a.trumpUpcard), s = Hh(n.trumpUpcard);
			...
			if (n.phase === "play" && e.phase !== "play") return Jh(e, "play", {
			...
			if (n.phase === "reveal" && e.phase === "ante" && !e.anteAnimActive && !e.trumpRevealActive) return lg(e, n);
			if (Wh(e.phase) && e.phase !== "drawPlayer" || e.phase === "drawPlayer" && e.drawAnimSubPhase !== "done") return {
				...e,
				pendingSnapshot: n
			};
			...
			if (n.phase === "reveal" && a.phase !== "reveal" && (e.phase === "idle" || e.phase === "nextHandReset" || e.phase === "enrollment" || e.phase === "settle" || e.phase === "play")) return lg(e, n);
			if (n.phase === "draw" && a.enrollmentActive && !n.enrollmentActive && e.phase === "enrollment") {
				let t = !!n.trumpUpcard;
				return Jh(e, t ? "trumpReveal" : "ante", {
					trumpRevealActive: t,
					anteAnimActive: !0,
			...
			if (n.phase === "draw" && (e.phase === "decision" || a.phase === "decision") && e.drawPresentationConsumedIds.length === 0 && e.displayDrawCompletedIds.length === 0 && e.phase !== "drawPlayer" && e.phase !== "drawReady") return ug(e, n, 0, 0);
			if (n.phase === "draw") {
				let t = $h(e, n);
				t && (e = t);
				let o = Xh(e, a, n);
				if (o && e.phase !== "drawReady") {
					...
					if (!t && !Qh(e)) {
						...
						return sg(e, n, o, a, t ? i : a, "serverUpdate");
					}
					t ? rg(e, n, null, "serverUpdate:animating-same-player") : Qh(e) && rg(e, n, null, "serverUpdate:in-flight-other-player");
				} else o || rg(e, n, null, "serverUpdate:no-candidate");
				if (n.drawCompletedIds.length === n.participantIds.length && n.participantIds.length > 0 && e.phase === "drawPlayer" && e.drawAnimSubPhase === "done") return Jh(e, "drawReady", { prevSnapshot: n });
			}
			return {
				...e,
				prevSnapshot: n,
...
function pg(e) {
	...
	switch (e.phase) {
		case "handReset": return Jh(e, "ante", {
			anteAnimActive: !0,
			pendingSnapshot: null
		});
		case "ante": return e.trumpRevealActive || t?.trumpUpcard ? Jh(e, "trumpReveal", {
			trumpRevealActive: !0,
			anteAnimActive: !1,
			pendingSnapshot: null
		}) : t?.phase === "draw" ? ug(e, t, 0, 0) : Jh(e, "drawPlayer", {
			anteAnimActive: !1,
			pendingSnapshot: null
		});
		...
		case "drawPlayer": {
			...
			if (i && r.displayDrawCompletedIds.length >= i.participantIds.length) return Jh(r, "drawReady", {
			...
			if (i) {
				let e = {
					...i,
					drawCompletedIds: [...r.displayDrawCompletedIds]
				}, t = ng(r, i, r.displayDrawCompletedIds);
				if (ig("after", r, {
					playerId: n,
					nextCompleted: r.displayDrawCompletedIds,
					nextChosen: t
				}), t) return rg(r, i, t, "advancePhase:nextPlayer"), sg(r, e, t, 1, 1, "advancePhase:nextPlayer");
				rg(r, i, null, "advancePhase:no-next-player");
			}
			return r;
		}
		case "drawReady": return Jh(e, "play", { pendingSnapshot: null });
		case "settle": return Jh(e, "nextHandReset", {
			settleAnimActive: !1,
			nextHandResetActive: !0,
			pendingSnapshot: null
		});
		case "nextHandReset": return t ? qh(t) : Jh(e, "idle", { nextHandResetActive: !1 });
		default: return e;
	}
}
function mg(e) {
...
function hg(e, t = !1) {
	...
	switch (e.phase) {
		...
		case "drawPlayer": return e.drawAnimSubPhase === "done" ? 0 : Hp(e.drawAnimSubPhase === "receive" ? 0 : e.drawDiscardCount, e.drawAnimSubPhase === "receive" ? e.drawReplaceCount : 0, t);
...
function Cg({ session: e, enrollmentActive: t, potAmount: n, handComplete: r, trickPipelineActive: i = !1, forceTrickHandEndDrain: a, heroCards: o = xg, enrolledIds: s = bg, declinedIds: c = bg, actionOrder: u }) {
	let d = e.participantIds.join(","), f = (e.drawCompletedIds ?? []).join(","), p = s.join(","), m = c.join(","), h = (u ?? e.participantIds).join(","), g = e.trumpUpcard ? `${e.trumpUpcard.rank}-${e.trumpUpcard.suit}` : "", _ = (0, l.useMemo)(() => Gh({
		...
		m,
		h
	]), v = yg(e.sessionId, e.handNumber), y = _.phase ?? null, b = (0, l.useRef)(null), [x, S] = (0, l.useReducer)(dg, _, qh), C = (0, l.useRef)([]), w = (0, l.useRef)([]), T = (0, l.useRef)(null), E = (0, l.useRef)(x);
	E.current = x;
	let D = () => {
	...
	(0, l.useEffect)(() => () => D(), []), (0, l.useEffect)(() => {
		...
		let t = b.current, n = o.map((e) => `${e.rank}-${e.suit}`), r = Sg(w.current, n);
		w.current = n, S({
			type: "serverUpdate",
			snapshot: _,
		...
		let e = Yf(), t = `${x.handNumber}:${x.phase}:${x.animatingDrawPlayerId ?? ""}:${x.drawAnimSubPhase}:${x.phaseStartedAt}`;
		if (T.current === t) {
		...
		}, n), O(() => S({ type: "watchdog" }), x.phase === "drawPlayer" || x.phase === "drawReady" ? zp : Rp);
	}, [
		x.handNumber,
		x.phase,
...
function kg(e) {
	...
	return Tg.has(t.phase) ? t.turnPlayerId : null;
}
function Ag(e, t, n) {
	let r = wg - Math.max(0, n - t) % wg;
	return {
		playerId: e,
		remainingMs: r,
		progress: r / wg,
...
function jg(e) {
	...
	return (0, l.useEffect)(() => {
		...
		let e = () => o(Date.now()), n = Yf() ? 250 : 100, i = window.setInterval(e, n);
		return () => window.clearInterval(i);
	}, [t, n]), {
		countdown: t && r.current != null ? Ag(t, r.current, a) : null,
		reducedMotion: Yf()
	};
}
//#endregion
//#region src/table/feedback/turnTimerAudio.ts
var Mg = .48, Ng = 90, Pg = null, Fg = null;
function Ig() {
	return Pg ||= new Gc.Howl({
		src: [`/sounds/${Zc.timer}`],
		loop: !0,
		volume: Mg,
		preload: !0
...
function Rg(e, t = {}) {
	...
	let i = t.fadeMs ?? Ng;
	if (i > 0 && e !== "overlap") {
		n.fade(Mg, 0, i, r), window.setTimeout(() => {
			n.stop(r);
		}, i + 20);
		return;
	}
...
function zg(e) {
	...
	Fg != null && Rg("overlap", { fadeMs: 0 }), Jl("turn-timer-warning"), Ml.get().unlock();
	let t = Ig().play();
	return typeof t == "number" ? (Fg = t, e.turnKey, e.turnKey, e.actorId, e.ringStartedAtMs, e.elapsedMs, !0) : !1;
}
//#endregion
...
function Wg({ currentUserId: e = null, localActionPending: t = !1, ...n }) {
	let r = kg(n), i = Dg({
		...n,
		activeActorId: r
	...
	(0, l.useEffect)(() => {
		if (!r) {
			u(), Lg() && Rg("turnChange"), s.current = !1, a.current = null, o.current = i;
			return;
		}
		if (i !== o.current || a.current == null) {
			u(), Lg() && Rg("turnChange"), s.current = !1, a.current = Date.now(), o.current = i;
			let e = a.current, t = i, n = Vg(e, Date.now()), l = () => {
				if (o.current !== t || s.current) return;
				let n = Hg(e, Date.now());
				Ug(n, s.current) && (s.current = !0, zg({
					turnKey: t,
					actorId: r,
					ringStartedAtMs: e,
					elapsedMs: n
		...
		u(), Lg() && Rg("cleanup"), s.current = !1;
	}, []), (0, l.useEffect)(() => {
		!t || !Lg() || r == null || e == null || r !== e || (Rg("playerAction"), s.current = !1, u());
	}, [
		t,
		r,
		e
...
function Kg({ active: e, displayName: t }) {
	let [n, r] = (0, l.useState)(!1), i = Yf();
	return (0, l.useEffect)(() => {
		if (!e) {
			r(!1);
			return;
...
function Yg(e) {
	...
	let d = () => {
		...
		let e = c.current;
		if (e === 0) return;
		let t = Jg[Math.min(e - 1, Jg.length - 1)];
	...
	}, qg), d) : (n("hidden"), i(0), d)), [e.activityKey, e.actionRequired]), (0, l.useEffect)(() => {
		if (t !== "pop") return;
		let e = Yf() ? 280 : 420;
...
function Zg({ actionRequired: e, activityKey: t }) {
	let { phase: n, beat: r } = Yg({
		actionRequired: e,
		activityKey: t
	});
	if (n === "hidden") return null;
	let i = Xg(), a = Math.min(r, 5);
	return /* @__PURE__ */ (0, g.jsx)("div", {
		className: [
			"byour-turn",
...
function Qg({ actionFeedback: e, feedbackErrorPulse: t = 0, feedbackSuccessPulse: n = 0, turnLabel: r = null, isMyTurn: i = !1, showTurn: a = !1 }) {
...
function a_(e) {
	return Math.max(e.pendingResolution?.frozen.plays.length ?? 0, Wf(e.prevTrick).length, e.peakTrickPlays?.length ?? 0);
}
function o_(e, t) {
	let n = Wf(t.currentTrick), r = Wf(e.prevTrick), i = r_(e, t, n), a = e.phase === "live" && !e.pendingResolution && (n.length < e.revealedCount && r.length >= e.revealedCount || n.length < i.length && r.length >= i.length), o = t.currentTrick?.trickNumber ?? null, s = e.prevTrick?.trickNumber ?? null, c = o != null && s != null && o !== s;
	return {
		...e,
...
function c_(e, t) {
	let n = l_(e, t);
	if (Od()) {
		let r = Wf(e.prevTrick).length, i = Wf(n.prevTrick).length;
...
function l_(e, t) {
	switch (t.type) {
		...
		case "forceHandEndDrain": {
			let t = e;
			if (t.phase === "live" && t.pendingResolution && (t = s_({
				...t,
				pendingResolution: null
			...
			for (let e = 0; e < 8 && t.phase !== "live"; e++) t = l_(t, { type: "advancePhase" });
			return t;
		}
		case "advancePhase": switch (e.phase) {
			...
			case "nextLeadReady": {
				let t = e.pendingServer, n = Wf(t?.currentTrick).length, r = t != null && t.currentTrick == null && e.frozenTrick != null;
				return {
					...e,
					phase: "live",
					frozenTrick: null,
					...
					peakTrickPlays: Wf(t?.currentTrick),
...
function m_({ phase: e, handNumber: t = 0, currentTrick: n, tricksByPlayer: r, participantIds: i, trumpSuit: a, playedCards: o, turnPlayerId: s, handComplete: c = !1 }) {
	let [u, d] = (0, l.useReducer)(c_, r, (e) => t_(e, n)), f = (0, l.useRef)([]), p = (0, l.useRef)(null), m = (0, l.useRef)(/* @__PURE__ */ new Set()), h = (0, l.useRef)(!1), g = (0, l.useRef)(null), _ = (0, l.useRef)(0), v = (0, l.useRef)(!1), y = (0, l.useRef)(t), b = (0, l.useRef)(u);
	b.current = u;
	...
	(0, l.useEffect)(() => () => w(), []), (0, l.useEffect)(() => {
		...
		v.current = S;
		let u = t !== y.current;
		if (y.current = t, u && t > 0) if (f_(b.current)) Od() && kd("useTrickPresentation", "reinit-hand-number-deferred", {
			handNumber: t,
		...
		p.current = e, w();
		let t = u.frozenTrick, n = Vf({
			trumpBeat: qf(t.plays, t.leadSuit, a),
			reducedMotion: Yf()
		});
		...
		let t = Yf() ? 308 : 560, n = window.setTimeout(() => d({ type: "commitTrickResolution" }), t);
		return () => window.clearTimeout(n);
	}, [
		S,
		x,
		...
		if (!x || !t || S && !c) return;
		let n = Yf() ? Math.max(3e3, Math.round(Rf * .55)) : Rf;
	...
	let k = d_(u, n), A = (0, l.useCallback)(() => d({ type: "forceHandEndDrain" }), []), j = (0, l.useCallback)(() => d({ type: "clearHandEndEcho" }), []);
	return {
		...k,
		forceHandEndDrain: A,
		clearHandEndEcho: j
...
function g_(e, t) {
	return e.map((e) => h_(e, t)).join(" & ");
}
function __(e, t) {
	return vf(e, t) ? t.filter((t) => (e[t] ?? 0) === 0) : [];
}
function v_(e) {
	let { tricksByPlayer: t, participantIds: n, players: r, pot: i, pendingVotes: a = {} } = e, o = xf(t, n), s = e.winnerIds?.length ? e.winnerIds : o.winnerIds, c = e.maxTricks ?? o.maxTricks, l = g_(s, r), u = __(t, n), d = g_(u, r), f = Sf(i.maxWinThisHand), p = Sf(i.currentPot), m = i.carryIn > 0 ? Sf(i.carryIn) : null, h = `Pot this hand: ${p} (max win ${f})`;
	m && (h += ` — includes ${m} carried in`), i.limEnabled && i.overflow > 0 && (h += ` · LIM overflow ${Sf(i.overflow)} stays out of play`);
	let g = s.map((e) => {
		let n = t[e] ?? 0;
		return `${h_(e, r)} — ${n} trick${n === 1 ? "" : "s"}`;
...
function y_({ session: e, players: t, potMetrics: n, splitSharePerWinner: r, currentUserId: i, isCoWinner: a, manualContinueAllowed: o = !0, onSettle: s }) {
	let c = v_({
		tricksByPlayer: e.tricksByPlayer,
		participantIds: e.participantIds,
		players: t.map((e) => ({
...
var b_ = 3e3, x_ = 6e3;
function S_(e = "") {
	let t = String(e).trim().length, n = b_ + Math.min(t * 35, x_ - b_);
	return Math.max(b_, Math.min(n, x_));
}
//#endregion
...
function w_({ session: e, players: t, splitSharePerWinner: n, currentUserId: r, isCoWinner: i, resultMessage: a = "", manualContinueAllowed: o = !0, onAgreeSplit: s, onDeclineSplit: c, onCarryover: u }) {
	let d = e.pendingCoWinSettlement?.winnerIds ?? [], f = e.pendingCoWinSettlement?.votes ?? {}, p = (0, l.useMemo)(() => S_(a || "Tie — split the pot?"), [a]), [m, h] = (0, l.useState)(p), [_, v] = (0, l.useState)(!1), y = (0, l.useRef)(null), b = (0, l.useRef)(!1), x = (0, l.useMemo)(() => `${d.join(",")}:${e.handNumber ?? 0}`, [d, e.handNumber]);
	(0, l.useEffect)(() => {
	...
	let w = Math.max(0, Math.ceil(m / 1e3)), T = d.map((e) => C_(e, t)).join(" & "), E = o && !b.current, D = (e) => {
		!i || !E || (v(e), e ? s() : c());
	};
	return /* @__PURE__ */ (0, g.jsxs)("div", {
...
function T_(e, t, n) {
	let [r, i] = (0, l.useState)(!1), [a, o] = (0, l.useState)(!1), s = (0, l.useRef)(null), c = (0, l.useRef)(null), u = (0, l.useRef)(null), d = (0, l.useRef)(S_(n)), f = () => {
		c.current != null && (window.clearTimeout(c.current), c.current = null);
	};
	return (0, l.useEffect)(() => {
		if (f(), u.current !== t && (u.current = t, s.current = null, i(!1), o(!1), d.current = S_(n)), e) {
			if (s.current == null) {
				let e = Date.now();
				s.current = e, d.current = S_(n), i(!0), o(!1), Od() && kd("tieResult", "shown", {
					proposalKey: t,
...
function O_(e, t) {
	return e.map((e) => E_(e, t));
}
function k_(e, t) {
	return e.map((e) => D_(e, t)).filter((e) => e != null).sort((e, t) => e - t);
}
function A_(e) {
...
var j_ = [], M_ = [], N_ = [];
function P_({ session: e, players: t, potMetrics: n, mySessionNet: r, leaderLabel: i, showCoWinSettlement: a, splitPotEnabled: o = !1, rebuyEnabled: s = !1, splitSharePerWinner: c = 0, enrollmentActive: u = !1, currentUserId: d, heroCards: f = M_, rawHeroCards: p = M_, privateHandReady: m = !1, legalPlayIndices: h, recentBourreIds: _ = N_, handComplete: v = !1, actionFeedback: y, actions: b, watchOnly: x = !1, watchOnlyMessage: S, idleStatusBanner: C }) {
	let { settings: w } = hd(), T = $p(), [E, D] = (0, l.useState)(!1), O = e.participantIds.length, { events: k, dismissEvent: A, pushReaction: j } = Vh({
		session: e,
		potMetrics: n,
		participantIds: e.participantIds
	}), M = (0, l.useMemo)(() => [...k].reverse().find((e) => e.kind === "big-pot") ?? null, [k]), ee = d != null && (e.pendingCoWinSettlement?.winnerIds || []).includes(d), N = m_({
		phase: e.phase,
		handNumber: e.handNumber,
		...
		heroCards: f,
		enrolledIds: e.handEnrollment?.enrolledIds ?? j_,
		declinedIds: e.handEnrollment?.declinedIds ?? j_,
	...
	let I = (0, l.useMemo)(() => {
	...
	}, [e.handNumber, e.pendingCoWinSettlement?.winnerIds]), ne = (0, l.useMemo)(() => {
		if (!a) return "";
		let r = v_({
			tricksByPlayer: e.tricksByPlayer,
			participantIds: e.participantIds,
		...
		c,
		d
	]), { visible: L, manualContinueAllowed: R } = T_(a, I, ne), z = e_(e.phase, e.trumpUpcard, N.displayPlays.length), B = Rd(P.isPresenting, P.phase, e.phase), [V, re] = (0, l.useState)(0);
	(0, l.useEffect)(() => Cd(() => re((e) => e + 1)), []), (0, l.useEffect)(() => {
		Hd({
	...
	let H = Fs(e.phase), ie = (0, l.useMemo)(() => yh({
		...
		P.trumpMergeActive,
		P.trumpMergedIntoHand
	]), ae = U.displayCards, oe = (0, l.useMemo)(() => !h?.length || U.indexMode === "effective" ? h : O_(h, U.trumpDisabledIndex), [
		h,
		U.indexMode,
		...
		return t == null ? null : U.indexMode === "effective" ? t : O_([t], U.trumpDisabledIndex)[0] ?? null;
	}, [
		h,
		f,
		e.trumpSuit,
		...
		let t = f.map(Ms), n = U.indexMode === "display" && U.trumpDisabledIndex != null ? k_([U.trumpDisabledIndex], U.trumpDisabledIndex) : U.trumpDisabledIndex == null ? [] : [U.trumpDisabledIndex], r = zc(t, e.trumpSuit ?? "clubs", e.maxDrawDiscards ?? 4, e.remainingDeckCount ?? Infinity, n);
		return U.indexMode === "effective" ? r : O_(r, U.trumpDisabledIndex);
	}, [
		e.phase,
		f,
		e.trumpSuit,
		...
		U.indexMode,
		U.trumpDisabledIndex
	]), le = N.suppressTurnPlayerId || P.suppressTurnIndicator, ue = Ns(e.phase, u), de = le ? null : Rs(e.turnPlayerId, t), fe = t.find((e) => e.isSelf), pe = d != null && e.participantIds.includes(d) && (e.phase === "draw" || e.phase === "play"), me = !x && s && !e.isFinal && !pe && !L && fe?.isOut === !0 && !!b.onRebuy, he = _h({
		currentUserId: d,
		session: e,
		suppressTurn: !!le,
		handComplete: v,
	...
	let ye = ie.showTrumpSuitReminder || !e.trumpUpcard && !!e.trumpSuit && e.phase === "play", be = (0, l.useMemo)(() => ({ ...N.displayTricksByPlayer }), [N.displayTricksByPlayer]), xe = (0, l.useMemo)(() => Object.fromEntries(t.map((e) => [e.playerId, Math.max(0, Number(e.bankroll) || 0)])), [t]), Se = Gg({
		turnPlayerId: e.turnPlayerId ?? null,
		dealerId: e.dealerId,
		...
		trickPhase: N.phase
	}), Ce = !!fe?.playerId && (_ ?? []).includes(fe.playerId) && Se.bourreAlerts[fe.playerId] === "pulse", we = (0, l.useRef)(0), Te = (0, l.useRef)(0);
	(0, l.useEffect)(() => {
		Se.feedbackErrorPulse > we.current && qu(), we.current = Se.feedbackErrorPulse;
	}, [Se.feedbackErrorPulse]), (0, l.useEffect)(() => {
		Se.feedbackSuccessPulse > Te.current && $u(), Te.current = Se.feedbackSuccessPulse;
	...
	let Ee = (0, l.useCallback)((e) => {
		...
		onSubmitDraw: (e) => {
			...
			let t = U.indexMode === "display" ? k_(e, U.trumpDisabledIndex) : e;
		...
		onPlayCard: (e) => {
			...
			let t = k_([e], U.trumpDisabledIndex)[0];
		...
		T ? /* @__PURE__ */ (0, g.jsx)(Ah, { ...Oe }) : /* @__PURE__ */ (0, g.jsx)(Sh, { ...Oe })
	] }), W = (0, l.useRef)(!1);
	return (0, l.useEffect)(() => {
		W.current = !1;
	}, [e.handNumber, e.sessionId]), (0, l.useEffect)(() => {
		if (x || e.phase !== "reveal" || P.anteAnimActive || P.trumpRevealActive || P.phase !== "drawPlayer" && P.phase !== "drawReady" || W.current || !b.onAdvanceReveal) return;
		...
		let e = (e) => {
			(e.key === w.hotkeys.toggleSettings || e.key === "," && e.metaKey) && D((e) => !e), e.key === w.hotkeys.focusTable && document.querySelector(".btable-wrap")?.scrollIntoView({
				block: "center",
				behavior: "smooth"
			});
		};
		return window.addEventListener("keydown", e), () => window.removeEventListener("keydown", e);
	}, [w.hotkeys]), (0, l.useEffect)(() => {
		let e = () => D(!0);
		return window.addEventListener("nbl-open-table-settings", e), () => window.removeEventListener("nbl-open-table-settings", e);
	}, []), /* @__PURE__ */ (0, g.jsxs)("div", {
		className: [
			"btable-session",
			T ? "btable-session--native-mobile btable-session--mobile-layout" : "",
			E ? "btable-session--settings-open" : "",
		...
		children: [
			...
			T ? /* @__PURE__ */ (0, g.jsx)(Ph, { children: /* @__PURE__ */ (0, g.jsxs)("div", {
				className: "btable-stage",
				children: [/* @__PURE__ */ (0, g.jsx)(Qg, {
					actionFeedback: y,
					feedbackErrorPulse: Se.feedbackErrorPulse,
					feedbackSuccessPulse: Se.feedbackSuccessPulse,
					turnLabel: de,
					isMyTurn: he,
					showTurn: !!(de && H && N.phase === "live")
				}), ke]
			}) }) : /* @__PURE__ */ (0, g.jsx)(Nh, { children: /* @__PURE__ */ (0, g.jsxs)("div", {
				className: "btable-stage",
				children: [/* @__PURE__ */ (0, g.jsx)(Qg, {
					actionFeedback: y,
					feedbackErrorPulse: Se.feedbackErrorPulse,
			...
			L && !e.isFinal && o && /* @__PURE__ */ (0, g.jsx)(w_, {
				session: e,
				players: t,
				splitSharePerWinner: c,
				currentUserId: d,
			...
			L && !e.isFinal && !o && /* @__PURE__ */ (0, g.jsx)(y_, {
				session: e,
				players: t,
				potMetrics: n,
				splitSharePerWinner: c,
...
var F_ = null, I_ = null;
function L_(e, t) {
	Ru(), Ko(e), I_ !== e && (F_?.unmount(), F_ = (0, u.createRoot)(e), I_ = e), F_.render(/* @__PURE__ */ (0, g.jsx)(md, { children: /* @__PURE__ */ (0, g.jsx)(P_, { ...t }) }));
}
function R_() {
	I_ && (Im(I_), sm(I_)), F_?.unmount(), F_ = null, I_ = null, Ud(), wd();
}
//#endregion
export { sm as clearDrawFlyGhosts, Im as clearWonTrickCollectionArtifacts, Bd as evaluateBotPresentationGate, zd as forceReleasePresentationForBots, gl as getFeedbackPrefs, Id as getTablePresentationBlockReason, Wd as getTrickAnimationBusyState, Rd as handPresentingBlocksBots, Ru as initGameFeedback, Kd as isTablePresentationBusy, Vd as isTablePresentationBusyForBots, Gd as isTrickAnimationBusy, L_ as mountTableSession, Uu as playBigWinFeedback, Wu as playBourreFeedback, Gu as playBourrePrivatePunishmentFeedback, Xu as playCardSelectFeedback, Yu as playDeleteRoomFeedback, Vu as playDrawFeedback, Qu as playFoldFeedback, Ku as playGameStartFeedback, Ju as playOpenRoomFeedback, zu as playShuffleFeedback, Hu as playTrickWinFeedback, Zu as playUiButtonFeedback, _l as saveFeedbackPrefs, bl as subscribeFeedbackPrefs, qd as subscribeTrickAnimationBusy, R_ as unmountTableSession };
