...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	function se(e) {
		ie.current === e && (z(re), z(ie)), H.current === e && (z(H), Qf._currentValue = ne);
	}
	var ce, le;
	function ue(e) {
		if (ce === void 0) try {
	...
	function Pc(e, t, n) {
		...
		switch (Ci(t), t.tag) {
			...
			case 4: return U(), e === null && Sd(t.stateNode.containerInfo), Nc(t), null;
	...
	function zu() {
		if (ru === 4 || ru === 3) {
			...
			if (i === 0 && (nu = null), Ye(n), t = t.stateNode, ke && typeof ke.onCommitFiberRoot == "function") try {
...
var B = {
	...
	return pe(e) || fe(e);
}, be = typeof ArrayBuffer == "function" && ArrayBuffer.isView || function() {}, xe = Array.isArray, Se = /(?:-?\.?\d|\.)+/gi, Ce = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, we = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Te = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Ee = /[+-]=-?[.\d]+/, De = /[^,'"\[\]\s]+/gi, Oe = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, W, ke, Ae, G, je = {}, Me = {}, Ne, Pe = function(e) {
	...
	var t = e.parent || W, n = e.keyframes ? ut(xe(e.keyframes)) : lt;
	...
	return t.parent && vt(t), t._start = nt((me(n) ? n : n || e !== W ? zt(e, n, t) : e._time) + t._delay), t._end = nt(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), gt(e, t, "_first", "_last", e._sort ? "_start" : 0), Nt(t) || (e._recent = t), r || Ot(e, t), e._ts < 0 && Dt(e, e._tTime), e;
}, At = function(e, t) {
	...
	return d = {
		...
		wake: function() {
			Ne && (!Ae && ve() && (ke = Ae = window, G = ke.document || {}, je.gsap = jr, (ke.gsapVersions ||= []).push(jr.version), Pe(Me || ke.GreenSockGlobals || !ke.gsap && ke || {}), hn.forEach(gn)), u = typeof requestAnimationFrame < "u" && requestAnimationFrame, c && d.sleep(), l = u || function(e) {
...
var Un = /*#__PURE__*/ function(e) {
	...
	function t(t, n) {
		var r;
		return t === void 0 && (t = {}), r = e.call(this, t) || this, r.labels = {}, r.smoothChildTiming = !!t.smoothChildTiming, r.autoRemoveChildren = !!t.autoRemoveChildren, r._sort = _e(t.sortChildren), W && kt(t.parent || W, R(r), n), t.reversed && r.reverse(), t.paused && r.paused(!0), t.scrollTrigger && At(R(r), t.scrollTrigger), r;
	}
	var n = t.prototype;
	return n.to = function(e, t, n) {
		...
		if (n._dirty) {
			...
			It(n, n === W && n._time > t ? n._time : t, 1, 1), n._dirty = 0;
		}
		return n._tDur;
	}, t.updateRoot = function(e) {
		if (W._ts && (ot(W, Tt(e, W)), Ge = Dn.frame), Dn.frame >= Je) {
			Je += B.autoSleep || 120;
			var t = W._first;
...
var Wn = function(e, t, n, r, i, a, o) {
	...
	if (b && (!f || !a) && (a = "none"), t._ease = In(a, re.ease), t._yEase = d ? Pn(In(d === !0 ? a : d, re.ease)) : 0, d && t._yoyo && !t._repeat && (d = t._yEase, t._yEase = t._ease, t._ease = d), t._from = !b && !!i.runBackwards, !b || f && !i.stagger) {
		...
		for (t._pt = t._ptCache = 0, c = m && _e(c) || c && !m, S = 0; S < g.length; S++) {
			...
			t._op && t._op[S] && t.kill(T, t._op[S]), y && t._pt && (Jn = t, W.killTweensOf(T, A, t.globalTime(n)), ee = !t.parent, Jn = 0), t._pt && c && (We[D.id] = 1);
		}
...
var rr = /*#__PURE__*/ function(e) {
	...
	function t(t, n, r, i) {
		...
		var o = a.vars, s = o.duration, c = o.delay, l = o.immediateRender, u = o.stagger, d = o.overwrite, f = o.keyframes, p = o.defaults, m = o.scrollTrigger, h = o.yoyoEase, g = n.parent || W, _ = (xe(t) || be(t) ? me(t[0]) : "length" in n) ? [t] : Jt(t), v, y, b, x, S, C, w, T;
		if (a._targets = _.length ? Ze(_) : Ie("GSAP target " + t + " not found. https://gsap.com", !B.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = d, f || u || ye(s) || ye(c)) {
			if (n = a.vars, v = a.timeline = new Un({
				...
				for (y = 0; y < x; y++) b = pt(n, nr), b.stagger = 0, h && (b.yoyoEase = h), T && dt(b, T), C = _[y], b.duration = +er(s, R(a), y, C, _), b.delay = (+er(c, R(a), y, C, _) || 0) - a._delay, !u && x === 1 && b.delay && (a._delay = c = b.delay, a._start += c, b.delay = 0), v.to(C, b, w ? w(y, C, _) : 0), v._ease = K.none;
		...
		return d === !0 && !ie && (Jn = R(a), W.killTweensOf(_), Jn = 0), kt(g, R(a), r), n.reversed && a.reverse(), n.paused && a.paused(!0), (l || !s && !f && a._start === nt(g._time) && _e(l) && St(R(a)) && g.data !== "nested") && (a._tTime = -U, a.render(Math.max(0, -c) || 0)), m && At(R(a), m), a;
	}
	var n = t.prototype;
...
et(Xe + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", function(e) {
	return He[e] = 1;
}), je.TweenMax = je.TweenLite = rr, je.TimelineLite = je.TimelineMax = Un, W = new Un({
	sortChildren: !1,
	defaults: re,
...
var vr = [], yr = {}, br = [], xr = 0, Sr = 0, Cr = function(e) {
	...
	return t.add = function(e, t, n) {
		...
		for (o in H && !r.selector && (r.selector = H.selector), this.contexts.push(r), t = r.add("onMatch", t), r.queries = e, e) o === "all" ? s = 1 : (a = ke.matchMedia(e[o]), a && (vr.indexOf(r) < 0 && vr.push(r), (i[o] = a.matches) && (s = 1), a.addListener ? a.addListener(wr) : a.addEventListener("change", wr)));
	...
	exportRoot: function(e, t) {
		e === void 0 && (e = {});
		var n = new Un(e), r, i;
		for (n.smoothChildTiming = _e(e.smoothChildTiming), W.remove(n), n._dp = 0, n._time = n._tTime = W._time, r = W._first; r;) i = r._next, (t || !(!r._dur && r instanceof rr && r.vars.onComplete === r._targets[0])) && kt(n, r, r._start - r._delay), r = i;
		return kt(W, n, 0), n;
	},
...
}, Ro = null, zo = null, Bo = !1, Vo = /* @__PURE__ */ new Map(), Ho = /* @__PURE__ */ new Map();
function Uo() {
	if (typeof window > "u") return null;
	try {
		let e = window.AudioContext ?? window.webkitAudioContext;
		return e ? (Ro || (Ro = new e(), zo = Ro.createGain(), zo.gain.value = .55, zo.connect(Ro.destination)), Ro) : null;
	} catch {
		return null;
	}
}
...
async function qo() {
	Bo && await Promise.all(Object.values(Lo).map(async (e) => {
		if (!await Ko(e)) return;
		let t = Go(e);
		if (t) try {
			t.load();
		} catch {}
...
async function Jo(e, t = .55) {
	if (!Bo || !await Ko(e)) return !1;
	let n = Go(e);
	if (!n) return !1;
	try {
...
function Yo(e, t, n, r, i, a, o = "sine") {
...
function Zo() {
	...
	for (let n of [
		...
		.2,
		.28
	]) Xo(e, zo, t + n, .05, .08 + Math.random() * .04);
}
function Qo() {
	let e = Uo();
	if (!e || !zo) return;
	let t = e.currentTime;
	Yo(e, zo, 880, t, .12, .09, "sine"), Yo(e, zo, 1174.66, t + .07, .16, .07, "triangle"), Yo(e, zo, 1760, t + .14, .1, .04, "sine");
}
function $o() {
	let e = Uo();
	if (!e || !zo) return;
	let t = e.currentTime;
	Yo(e, zo, 659.25, t, .14, .08, "sine"), Yo(e, zo, 830.61, t + .1, .18, .09, "triangle"), Yo(e, zo, 987.77, t + .22, .22, .1, "sine"), Yo(e, zo, 1318.51, t + .34, .28, .06, "triangle");
}
...
var ts = { current: !1 }, ns = { current: !1 }, rs = { current: !1 };
function is() {
	es(Lo.shuffle, Zo, ts, 360);
}
function as() {
	es(Lo.trickWin, Qo, ns, 320);
}
function os() {
	es(Lo.bigWin, $o, rs, 580);
}
function ss() {
...
function ds(e) {
	try {
		return ls(e) ? !0 : cs() ? navigator.vibrate(us[e]) ?? !1 : !1;
	} catch {
		return !1;
	}
}
function fs() {
	return cs() || !!(typeof window < "u" && window.BourreHaptics);
}
//#endregion
//#region src/table/feedback/prefs.ts
var ps = "nbl-feedback", ms = {
	soundEnabled: !0,
	hapticsMode: "on"
};
function hs(e) {
...
function _s(e) {
	...
	try {
		localStorage.setItem(ps, JSON.stringify(t));
	} catch {}
	return bs(t), t;
}
...
var Cs = 700, ws = 450, Ts = 1200, Es = 280, Ds = 0, Os = 0, ks = 0, As = 0, js = null, Ms = !1;
function Ns() {
	return gs();
}
function Ps(e) {
	Ss(Ns().hapticsMode, e) && ds(e);
}
function Fs() {
	if (Ms || typeof window > "u") return;
	Ms = !0;
	let e = () => {
		Wo();
	};
...
function Is(e = {}) {
	let t = Ns();
	if (Date.now() - Ds < Cs) return;
	js &&= (clearTimeout(js), null);
	let n = e.delayMs ?? (xs() ? 0 : 40);
	js = window.setTimeout(() => {
		js = null, Ds = Date.now(), t.soundEnabled && is(), Ps("light");
	}, n);
}
function Ls() {
	let e = Ns(), t = Date.now();
	t - Os < ws || (Os = t, e.soundEnabled && as(), Ps("medium"));
}
function Rs() {
	let e = Ns(), t = Date.now();
	t - ks < Ts || (ks = t, e.soundEnabled && os(), Ps("strong"));
}
function zs() {
	let e = Date.now();
	e - As < Es || (As = e, Ps("light"));
}
function Bs() {
	Ps("light");
}
...
function nc({ cards: e, phase: t, enrollmentActive: n = !1, isInHand: r = !1, isDealer: i = !1, signedIn: a = !1, isMyTurn: o = !1, drawCompleted: s = !1, maxDrawDiscards: c = 4, legalPlayIndices: u, recommendedPlayIndex: d = null, recommendedDiscardIndices: f = [], handComplete: p = !1, actionFeedback: m, onSubmitDraw: h, onPassDraw: _, onFoldDraw: v, onPlayCard: y, privateHandReady: b = !1, className: x = "", dealStaggerMs: S = 120, drawAnimSubPhase: C = null, currentUserId: w = null, revealedTrumpIndex: T = null, trumpMergeActive: E = !1, trumpDisabledIndex: D = null, handNumber: O = 0, tableRootRef: k, pileIndexRef: A, onDiscardCommitted: j, onUserActivity: M }) {
	let { settings: N } = $s(), [te, P] = (0, l.useState)(/* @__PURE__ */ new Set()), [F, ne] = (0, l.useState)(null), [I, L] = (0, l.useState)(null), [R, z] = (0, l.useState)(null), [B, re] = (0, l.useState)(!1), [ie, V] = (0, l.useState)(null), [H, ae] = (0, l.useState)(null), [U, oe] = (0, l.useState)(null), [se, ce] = (0, l.useState)(() => fo()), [le, ue] = (0, l.useState)(!1), [de, fe] = (0, l.useState)(!1), [pe, me] = (0, l.useState)(!1), [he, ge] = (0, l.useState)([]), _e = (0, l.useRef)(/* @__PURE__ */ new Set()), ve = (0, l.useRef)(null), ye = (0, l.useRef)(!1), be = (0, l.useRef)(null), xe = (0, l.useRef)(null), Se = (0, l.useRef)(!1), Ce = (0, l.useRef)(async () => {}), we = Va(t), Te = (0, l.useMemo)(() => e.map(Ia), [e]), Ee = (0, l.useMemo)(() => e.map((e) => `${e.rank}-${e.suit}`).join("|"), [e]), De = (0, l.useMemo)(() => f.slice().sort((e, t) => e - t).join(","), [f]), Oe = t === "draw", W = t === "play", ke = (0, l.useCallback)((e, t) => T === t ? E ? "hand__slot--trump-merge-target" : "hand__slot--trump-revealed" : "", [T, E]);
	(0, l.useEffect)(() => {
		...
		ue(!0), L(null), ne(null);
		let i = Fa(e.length, S), a = window.setTimeout(() => ue(!1), i);
	...
	(0, l.useEffect)(() => () => Ae(), [Ae]), (0, l.useEffect)(() => {
		Ae(), ne(null), P(/* @__PURE__ */ new Set()), Se.current = !1, z(null), ae(null), oe(null), V(null);
	}, [
		t,
		Ee,
		Ae
	]), (0, l.useEffect)(() => {
		F !== null && (Po(F, u) || (ne(null), xe.current = null, Ae()));
	}, [
		u,
		F,
		Ae
	]);
	let G = B || m?.status === "loading" || I !== null;
	(0, l.useEffect)(() => {
		!se || !Oe || s || Se.current || P(new Set(f));
	}, [
		se,
		Oe,
		s,
		...
		if (!(!W || !o || F === null || ye.current || G)) {
			if (!Po(F, u)) {
				ne(null), xe.current = null;
				return;
			}
			be.current ??= (xe.current = F, window.setTimeout(() => {
				be.current = null;
				let e = xe.current;
		...
		(m?.status === "success" || m?.status === "error") && (L(null), ne(null), Ae(), ye.current = !1);
	}, [m?.status, Ae]);
	let je = N.cardScale === "lg" ? "md" : "sm", Me = Vs(m?.status === "error" ? m.message : ie), Ne = La(t, n);
	(0, l.useEffect)(() => {
		M && Oe && te.size > 0 && M();
	}, [
		Oe,
	...
	let Pe = (0, l.useCallback)(() => {
		M?.();
	}, [M]), Fe = (0, l.useCallback)((e) => {
		G || D === e || (Se.current = !0, Pe(), V(null), P((t) => {
			let n = new Set(t);
		...
		D,
		Pe
	]), Ie = (0, l.useCallback)(async (e) => {
		if (ye.current || G || !y || !Po(e, u)) return;
		Ae(), ye.current = !0, ne(null), L(e), V(null);
		let t = Te[e];
		w && t && io(w, qa({
			playerId: w,
			card: {
		...
		try {
			await Promise.resolve(y(e)), L(null), ye.current = !1;
		} catch (e) {
			V(Vs(e instanceof Error ? e.message : "Could not play card")), L(null), ye.current = !1;
		}
	}, [
		G,
		u,
		...
		if (!(ye.current || G || !y || t !== "play")) {
			if (!Po(e, u)) {
				o && (zs(), Ae(), ne(null), ae(e), oe(e), window.setTimeout(() => {
					ae(null), oe(null);
				}, oo.illegalFlash), V("Illegal play"));
				return;
			}
			Ae(), ne(e), V(null), Pe(), xe.current = e, o && (be.current = window.setTimeout(() => {
				be.current = null;
				let t = xe.current;
	...
	Ce.current = Ie;
	let Re = (0, l.useCallback)(async (e) => {
		if (!(!h || G)) {
			if (Pe(), e.length > c) {
			...
			try {
				...
				V(e instanceof Error ? e.message : "Draw failed");
			} finally {
				re(!1);
			}
		}
		...
		if (!(!_ || G)) {
			Pe(), re(!0), V(null);
			try {
				await _(), P(/* @__PURE__ */ new Set()), fe(!0), window.setTimeout(() => fe(!1), 700);
			} catch (e) {
				V(e instanceof Error ? e.message : "Could not stand pat");
			} finally {
				re(!1);
			}
		}
		...
		if (!(!v || G)) {
			...
			try {
				...
				me(!1), V(e instanceof Error ? e.message : "Could not fold out");
			} finally {
				re(!1);
			}
		}
		...
		zs(), Ae(), ne(null), ae(e), oe(e), window.setTimeout(() => {
			ae(null), oe(null);
		}, oo.illegalFlash), V("Illegal play");
	}, [Ae]), He = (0, l.useCallback)((e) => {
		if (ce(e), po(e), e) {
			Se.current = !1, Oe && !s && P(new Set(f));
			return;
		}
		Se.current || P(/* @__PURE__ */ new Set());
	}, [
		Oe,
		s,
		f
	]), Ue = a && r && (Oe || W), We = () => Ue ? /* @__PURE__ */ (0, g.jsxs)("label", {
	...
	if (!r && !n && !we) return /* @__PURE__ */ (0, g.jsx)(tc, { className: x });
	if (we && r && e.length === 0) return p && n ? /* @__PURE__ */ (0, g.jsx)(tc, { className: x }) : /* @__PURE__ */ (0, g.jsxs)("div", {
		className: ec(N, x),
		"aria-live": "polite",
		"data-testid": "hero-hand",
		children: [/* @__PURE__ */ (0, g.jsx)("p", {
	...
	if (e.length === 0 && !i) return Ue ? /* @__PURE__ */ (0, g.jsx)("div", {
		className: ec(N, x, ["btable-hero--reserved"]),
		"data-testid": "hero-hand",
		"aria-live": "polite",
		children: /* @__PURE__ */ (0, g.jsx)("div", {
			className: "btable-hero__hand-3d btable-hero__hand-3d--chrome-only",
	...
	}) : /* @__PURE__ */ (0, g.jsx)(tc, { className: x });
	let Ge = Ue && W && se && F === null && d !== null && d >= 0, Ke = (e, t) => T === t ? "trump" : D === t && (Oe || W) ? "muted" : I === t || U === t || H === t ? "default" : Oe && te.has(t) ? se && !Se.current ? "draw-recommended" : "draw-selected" : W && F === t ? "play-preselected" : Ge && d === t ? "play-recommended" : W && u && !u.includes(t) ? "muted" : "default", qe = we && r && !(W && o), Je = "none";
	W && r ? Je = "play" : Oe && r && !s ? Je = "draw-select" : qe && (Je = "peek");
	let Ye = te.size, Xe = Oe && !s && o;
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		className: ec(N, x, [
			...
			Xe ? "btable-hero--draw-actions" : "",
			Oe && o && !s || W && o ? "btable-hero--your-turn" : "",
			(Oe || W) && r && !o ? "btable-hero--waiting-turn" : "",
		...
		children: [
			/* @__PURE__ */ (0, g.jsxs)("p", {
				...
				children: [
					Ne,
					Oe && !s && o && " — tap cards to discard; red border marks your selection",
					W && o && " — tap a legal card to play",
					se && (Oe || W) && " — green outline marks suggested cards"
				]
			}),
			...
			/* @__PURE__ */ (0, g.jsx)("div", {
				...
				"aria-hidden": !Xe,
				children: Xe && /* @__PURE__ */ (0, g.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, g.jsx)("button", {
							...
							disabled: G,
							"aria-busy": G,
							onClick: () => Re([...te].sort((e, t) => e - t)),
							children: G ? "Drawing…" : `Draw${Ye > 0 ? ` (${Ye})` : ""}`
						}),
						/* @__PURE__ */ (0, g.jsx)("button", {
							type: "button",
...
function mc(e, t, n) {
	...
	return r.length < 2 || 5 - fc(e, r) != 1 ? [] : r.filter((t) => (e[t] ?? 0) === 0);
}
function hc(e, t, n, r) {
	return mc(t, n, r).includes(e);
}
function gc(e) {
...
function Pc(e = !1) {
	...
	return {
		...
		trumpBeatReadMs: Math.round(jc * t)
	};
}
function Fc(e) {
	let t = Pc(e.reducedMotion), n = e.trumpBeat ? t.trumpBeatReadMs : t.postTrickReadMs, r = Math.min(t.winnerRevealMs, n - 200), i = Math.max(200, n - r), a = t.trickSweepMs, o = t.nextLeadGapMs;
	return {
...
function Bc(e) {
	let t = Rc(e.prevTrick), n = e.playedCards?.filter((t) => t.trickNumber === e.trickNumber).map((e) => ({
		playerId: e.playerId,
		card: e.card
	})) ?? [];
...
function Hc(e) {
	let { prevTricks: t, nextTricks: n, prevTrick: r, playedCards: i } = e, a = Lc(e.participantIds, t, n), o = fc(t, a), s = fc(n, a);
	if (s <= o) return null;
	let c = Ic(t, n, a), l = r?.trickNumber ?? s, u = Bc({
		prevTrick: r,
		playedCards: i,
		trickNumber: l
	});
...
var Wc = "nbl-game-flow-debug", Gc = !1, Kc = null;
function qc() {
	if (Gc) return !0;
	if (typeof window > "u") return !1;
	try {
		return window.localStorage?.getItem(Wc) === "1" ? !0 : new URLSearchParams(window.location.search).has("gameFlowDebug");
	} catch {
		return !1;
	}
}
...
function Yc(e, t, n, r, i) {
	r.current = !1, e(!0), t("static"), n(null), i && qc() && Jc("TrickPlaySlot", "fly-complete", i);
}
function Xc({ play: e, index: t, presentationPhase: n, displayCount: r, playerName: i, leaderPlayerId: a = null, winnerPlayerId: o = null, instantPlace: s = !1 }) {
	...
	(0, l.useLayoutEffect)(() => {
		qc() && Jc("TrickPlaySlot", "play-enter", {
			playKey: y,
			index: t,
			instantPlace: s,
			isLanding: C
		...
		let a = Uc(), o = a ? 187 : 340, l = a ? 77 : 140;
		v.current = !0, p(J(i, n.getBoundingClientRect(), r.getBoundingClientRect())), d("pending"), qc() && Jc("TrickPlaySlot", "fly-start", {
			playKey: y,
			index: t,
			travelMs: o,
			settleMs: l
...
function Zc({ displayPlays: e = [], leaderPlayerId: t = null, winnerPlayerId: n = null, showWinnerTag: r = !1, presentationPhase: i = "live", playerNames: a = {}, variant: o = "live", instantTrickPlays: s = !1 }) {
	if ((0, l.useEffect)(() => {
		qc() && Jc("TrickRow", e.length === 0 ? "trick-empty" : "trick-cards", {
			count: e.length,
			phase: i
		});
	...
	return /* @__PURE__ */ (0, g.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, g.jsxs)("div", {
			...
			children: [r && c && /* @__PURE__ */ (0, g.jsxs)("div", {
				...
				children: e.map((r, o) => /* @__PURE__ */ (0, g.jsx)(Xc, {
					play: r,
					index: o,
...
function $c({ potMetrics: e, participantCount: t, trumpUpcard: n, trumpSuit: r, phase: i, enrollmentActive: a = !1, remainingDeckCount: o, trickDisplayPlays: s = [], trickLeadSuit: c = null, trickLeaderPlayerId: u = null, trickWinnerPlayerId: f = null, trickShowWinnerTag: p = !1, trickPresentationPhase: m = "live", trickEchoPlays: h = [], trickEchoWinnerId: v = null, trickEchoPhase: y = "live", showFinalTrickEcho: b = !1, playerNames: x = {}, anteAnimActive: S = !1, trumpRevealActive: C = !1, drawAnimPlayerId: w = null, drawAnimSubPhase: T = "done", drawDiscardCount: E = 0, settleAnimActive: D = !1, settleCarryOver: O = !1, potTick: k = 0, trumpReminderPulse: A = 0, hideCenterTrump: j = !1, showTrumpSuitReminder: M = !1, instantTrickPlays: ee = !1, peakTrickPlayCount: N = 0, discardPileCards: te = [] }) {
	...
	(0, l.useEffect)(() => {
		...
		if (R) {
			if (L || ne) {
				let e = window.setTimeout(() => z(null), 680);
	...
	let B = !!R && !j, re = M || !B && !!r && i === "play", ie = B ? `${R.rank}-${R.suit}` : "trump-slot", V = b || D && h.length > 0 && I === 0;
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, g.jsxs)("div", {
			...
			children: [
				...
				i === "draw" ? /* @__PURE__ */ (0, g.jsx)(Qc, { cards: te }) : null,
				/* @__PURE__ */ (0, g.jsxs)("div", {
...
function el({ label: e, value: t, accent: n, title: r }) {
...
function tl({ player: e, compact: t = !1 }) {
	...
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		...
		children: [n && /* @__PURE__ */ (0, g.jsxs)(g.Fragment, { children: [
			...
			e.apeClass && /* @__PURE__ */ (0, g.jsx)(el, {
				label: "Class",
				value: e.apeClass,
				title: "Ape Class"
			}),
			e.apeStatus && /* @__PURE__ */ (0, g.jsx)(el, {
				label: "Status",
				value: e.apeStatus,
				title: "Ape Status"
			})
		] }), e.sessionStreak != null && e.sessionStreak > 0 && /* @__PURE__ */ (0, g.jsx)(el, {
			label: "Streak",
...
var nl = 22, rl = 2 * Math.PI * nl;
function il({ progress: e, segment: t, reducedMotion: n = Uc() }) {
	let r = rl * (1 - Math.max(0, Math.min(1, e)));
...
function al({ player: e, region: t, handLane: n = "below", style: r, onToggleInHand: i, onPassEnrollment: a, onTrickDelta: o, onReaction: s }) {
							...
							children: [
								...
								/* @__PURE__ */ (0, g.jsxs)("div", {
									...
									children: [
										...
										e.turnCountdown && /* @__PURE__ */ (0, g.jsx)(il, {
...
function sl(e, t, n) {
	let r = new Map(e.map((e) => [e.playerId, e])), i = ol(e.map((e) => e.playerId), t);
...
function ul(e, t) {
	return e < 0 || e > 6 ? null : cl(t)[e] ?? null;
}
function dl(e, t, n) {
	let r = ul(e, t);
	return r ? {
...
function ml(e, t) {
	return e < 0 || e > 7 ? null : fl(t)[e] ?? null;
}
function hl(e, t, n) {
	let r = ml(e, t);
	return r ? {
...
function xl(e, t) {
	let n = yl(e.x, gl.min, gl.max), r = t === "portrait" ? _l : vl, i = yl(e.y, 8, r);
	return {
		...e,
		x: n,
		y: i
...
function Sl(e, t, n) {
	if (n.isMobile && n.orientation && ll(t)) {
		let t = dl(e, n.orientation, { isSelf: n.isSelf });
		if (t) return t;
	}
	if (n.isMobile && n.orientation && pl(t)) {
		let t = hl(e, n.orientation, { isSelf: n.isSelf });
		if (t) return t;
	}
	let r = Oc(e, t), i = n.isMobile && n.orientation ? xl(r, n.orientation) : r;
	return {
		...i,
		seatIndex: e,
		handLane: bl(i, {
...
function wl(e, t = "portrait") {
	if (ll(e)) {
		let e = dl(0, t, { isSelf: !0 });
		if (e) return e;
	}
	if (pl(e)) {
...
var Tl = 5e3, El = 1e3, Dl = 12e3, Ol = 4e3, kl = 4e3;
function Al(e = Uc()) {
...
function jl(e, t, n = Uc()) {
	let r = Al(n), i = Math.max(0, e), a = Math.max(0, t);
...
function Nl(e, t, n, r) {
	let i = Ml(e, t, n), a = Math.max(152, n);
	return {
...
function Ul({ aspect: e, enabled: t = !0, sessionKey: n }) {
	let r = (0, l.useRef)(null), i = (0, l.useRef)(0), a = (0, l.useRef)(n), { settings: o } = $s(), s = Rl();
	return (0, l.useLayoutEffect)(() => {
		...
		let l = c.closest(".btable-desktop__viewport") ?? c.closest(".table-play-overlay__main") ?? c.closest(".btable-session"), u = window.visualViewport, d = () => {
			let t = !!c.closest(".table-play-overlay"), n = typeof window < "u" && window.matchMedia("(orientation: portrait)").matches, r = Hl(c, s).getBoundingClientRect(), a = c.querySelector(".hand-panel")?.getBoundingClientRect(), l = t && s && n ? 100 : t && !s ? 120 : s ? 112 : 148, d = t && s && n || t && !s ? 200 : s ? 210 : 280, f = a?.height ?? 0, p = Nl(f, i.current, l, d);
			i.current = p.peak;
			...
			let S = Math.max(.85, Math.min(1.35, o.tableScale || 1)), C = t && s ? 1 : S, w = s ? Pl(e, { portrait: n }) : e, T = parseInt(getComputedStyle(c).getPropertyValue("--player-count").trim(), 10) || 4, E = t && s && !n, D = E ? {
				...Y({
					availWidth: b,
					availHeight: x,
					aspect: w,
			...
			if (c.style.setProperty("--stage-fit-width", `${Math.round(k)}px`), c.style.setProperty("--stage-fit-height", `${Math.round(A)}px`), c.style.setProperty("--stage-fit-scale", String(D.fitScale)), c.style.setProperty("--stage-effective-scale", String(j)), (c.closest(".btable-desktop__scale") ?? c.parentElement)?.style.setProperty("--stage-effective-scale", String(j)), localStorage.getItem("stageFitDebug") === "1") {
				let e = c.querySelector(".table-stage"), a = c.querySelectorAll(".bseat__avatar-wrap"), o = e ? X(e.getBoundingClientRect()) : null, l = X(document.documentElement.getBoundingClientRect()), u = [...a].filter((e) => !Z(X(e.getBoundingClientRect()), l, 1)).length;
...
function Wl({ handPresentation: e, handNumber: t, currentUserId: n, pileIndexRef: r, onDiscardCommitted: i }) {
...
function ql(e, t) {
	let n = Gl(`${e}@book${t}`), r = Kl(n, 0), i = Kl(n, 9), a = Kl(n, 17), o = r >= .5 ? 1 : -1, s = i >= .5 ? 1 : -1;
	return {
...
var Yl = /* @__PURE__ */ new Set(), Xl = /* @__PURE__ */ new Set(), Zl = F.drawDiscard;
function Ql(e, t) {
	return {
		midX: e * .42,
...
function eu() {
	for (let e of Xl) Qi.set(e, { clearProps: "opacity,transform,willChange,zIndex" });
	Xl.clear();
}
function tu(e) {
...
function ru(e = document) {
	for (let e of Yl) e.kill();
	Yl.clear(), tu(e), eu(), nu(e);
}
function iu() {
	for (let e of Yl) e.kill();
	Yl.clear(), eu();
...
function cu(e, t) {
	ra(t.root ?? document);
	let n = L(), r = t.root ?? document, i = t.host ?? (r instanceof HTMLElement ? r : document.body), a = $l(t.winnerPlayerId, r), o = n ? .06 : 140 / 1e3, s = I(Zl, n), c = n ? .03 : .05, l = [], u = (e) => {
		Yl.delete(d);
		for (let e of l) e.remove();
		eu(), e && su(t.winnerPlayerId, r), t.onComplete?.();
	}, d = Qi.timeline({
		onComplete: () => u(!0),
		onInterrupt: () => u(!1)
	});
	Yl.add(d), e.forEach((e, r) => {
		let u = ql(t.trickKey, t.bookIndex), f = ou(e, i);
		l.push(f), Xl.add(e), Qi.set(e, { opacity: 0 });
		let p = $i(f);
		Qi.set(f, {
			transformOrigin: "50% 50%",
			willChange: "transform,opacity",
	...
	return au(d, Math.min(480, Math.max(300, f))), d;
}
function lu() {
	return Yl.size > 0;
}
...
var du = new Set(["nextLeadReady", "live"]);
function fu({ trickPresentation: e, handNumber: t, sessionPhase: n = null, handComplete: r = !1, tableRootRef: i }) {
	...
	(0, l.useLayoutEffect)(() => {
		...
		if (e) {
			if (o.current !== t) {
				o.current = t, a.current = null, u(), ru(e);
				return;
			}
			(r || n != null && n !== "play") && (a.current = null, u(), ru(e));
		}
	}, [
		t,
		r,
...
function _u(e, t, n, r, i) {
	...
	let a = t.showRevealedTrumpAtHolder ? gu(r) : null;
	return {
...
function vu({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: l = !1, showTrumpSuitReminder: u = !1, trumpHolderPresentation: d, privateHandReady: f = !1, currentUserId: p = null, legalPlayIndices: m, recommendedPlayIndex: h, recommendedDiscardIndices: _ = [], handComplete: v = !1, actionFeedback: y, trickPresentation: b, handPresentation: x, microinteractions: S, instantTrickPlays: C = !1, turnCountdown: w = null, onToggleInHand: T, onPassEnrollment: E, onTrickDelta: D, onSubmitDraw: O, onPassDraw: k, onFoldDraw: A, onPlayCard: j, onReaction: M, onHeroUserActivity: ee }) {
	...
	let V = new Set(e.participantIds.filter((t) => hc(t, b.displayTricksByPlayer, e.participantIds, e.phase))), H = N.map((t) => {
		let r = b.displayTricksByPlayer[t.playerId] ?? 0, i = b.trickWinnerSeatId === t.playerId, a = b.suppressTurnPlayerId || x.suppressTurnIndicator, o = b.phase === "collectTrick" && i, s = x.enrollmentPulse[t.playerId], c = x.animatingDrawPlayerId === t.playerId, l = _u(t.playerId, d, e.trumpUpcard ?? null, t.holeCardCount ?? 0, t.isSelf);
		return {
			...t,
			...l,
	...
	}), ae = N.find((e) => e.isSelf), U = b.suppressTurnPlayerId || x.suppressTurnIndicator, oe = !!(p && e.drawCompletedIds?.includes(p));
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		ref: z,
		className: [
					...
					children: /* @__PURE__ */ (0, g.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, g.jsx)("div", {
								...
								children: te.map((e, t) => {
									let n = Sl(t, te.length, {
										isMobile: !1,
										isSelf: e.isSelf
									}), r = H.find((t) => t.playerId === e.playerId) ?? e;
									return /* @__PURE__ */ (0, g.jsx)("div", {
...
var bu = "(orientation: portrait)";
function xu() {
	let e = Rl(), [t, n] = (0, l.useState)(() => typeof window < "u" && window.matchMedia(bu).matches);
	return (0, l.useEffect)(() => {
		let e = window.matchMedia(bu), t = () => n(e.matches);
...
function Tu({ aspect: e, sessionKey: t }) {
	let n = (0, l.useRef)(null), r = (0, l.useRef)(0), i = (0, l.useRef)(t), a = xu(), { settings: o } = $s(), s = a === "mobile-portrait";
	return (0, l.useLayoutEffect)(() => {
		...
		let c = window.visualViewport, l = () => {
			let t = wu(a).getBoundingClientRect(), n = a.querySelector(".btable-mobile-hero-dock")?.getBoundingClientRect(), i = !!a.closest(".table-play-overlay"), l = s ? 104 : 92, u = s ? 210 : 168, d = Nl(n?.height ?? 0, r.current, l, u);
			r.current = d.peak;
			let f = d.height, p = parseInt(getComputedStyle(a).getPropertyValue("--player-count").trim(), 10) || 4, m = p <= 4, h = !s, g = (h && m ? Su("--mobile-fit-pad-x", 4) : Su("--mobile-fit-pad-x", 8)) + (h && i ? 4 : 12), _ = (h && m ? Su("--mobile-fit-pad-y", 2) : Su("--mobile-fit-pad-y", 6)) + (h && i ? 4 : 10), v = Su("--mobile-fit-gap", s ? 8 : 6), y = c, b = Math.min(t.width, y?.width ?? window.innerWidth), x = Math.min(t.height, y?.height ?? window.innerHeight);
			if (i) {
				let e = Cu(a);
				x = Math.max(140, x - e);
			}
...
function Eu({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: l = !1, showTrumpSuitReminder: u = !1, trumpHolderPresentation: d, privateHandReady: f = !1, currentUserId: p = null, legalPlayIndices: m, recommendedPlayIndex: h, recommendedDiscardIndices: _ = [], handComplete: v = !1, actionFeedback: y, trickPresentation: b, handPresentation: x, microinteractions: S, instantTrickPlays: C = !1, turnCountdown: w = null, onToggleInHand: T, onPassEnrollment: E, onTrickDelta: D, onSubmitDraw: O, onPassDraw: k, onFoldDraw: A, onPlayCard: j, onHeroUserActivity: M }) {
	let ee = xu() === "mobile-landscape" ? "landscape" : "portrait", N = t.map((e) => ({
		...e,
		isSelf: e.isSelf || p != null && e.playerId === p
	})), te = sl(N, e, p), P = te.filter((e) => !e.isSelf), F = te.find((e) => e.isSelf), ne = F ? wl(te.length, ee) : null, I = te.length, L = `btable--p${Math.min(8, Math.max(2, I))}`, R = yu(P.length, ee), z = Object.fromEntries(t.map((e) => [e.playerId, e.displayName])), B = Al(), re = e.sessionId, ie = Tu({
		aspect: R,
		sessionKey: re
	}), { cards: V, pileIndexRef: H, commitDiscardCards: ae } = Da({
		handNumber: e.handNumber,
		sessionPhase: e.phase,
		tableRootRef: ie
	});
	...
	let U = new Set(e.participantIds.filter((t) => hc(t, b.displayTricksByPlayer, e.participantIds, e.phase))), oe = N.map((t) => {
		let r = b.displayTricksByPlayer[t.playerId] ?? 0, i = b.trickWinnerSeatId === t.playerId, a = b.suppressTurnPlayerId || x.suppressTurnIndicator, o = b.phase === "collectTrick" && i, s = x.enrollmentPulse[t.playerId], c = x.animatingDrawPlayerId === t.playerId, l = _u(t.playerId, d, e.trumpUpcard ?? null, t.holeCardCount ?? 0, t.isSelf);
		return {
			...t,
			...l,
	...
	}), se = N.find((e) => e.isSelf), ce = b.suppressTurnPlayerId || x.suppressTurnIndicator, le = !!(p && e.drawCompletedIds?.includes(p));
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		ref: ie,
		className: [
					...
					children: /* @__PURE__ */ (0, g.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, g.jsxs)("div", {
								...
								"aria-label": "Players at the table",
								children: [P.map((e, t) => {
									let n = Cl(t, te.length, ee), r = oe.find((t) => t.playerId === e.playerId) ?? e;
									return /* @__PURE__ */ (0, g.jsx)("div", {
										className: `btable__seat-slot btable__seat-slot--${t}`,
										"data-seat-index": t + 1,
										children: /* @__PURE__ */ (0, g.jsx)(al, {
									...
									"data-seat-index": 0,
									children: /* @__PURE__ */ (0, g.jsx)(al, {
										player: oe.find((e) => e.playerId === F.playerId) ?? F,
										region: ne.region,
...
function Ou({ events: e, onDismiss: t }) {
	let n = [...e].reverse().find((e) => Du.has(e.kind));
	return (0, l.useEffect)(() => {
		if (!n) return;
...
function ku({ children: e }) {
	let { settings: t } = $s(), n = t.layoutMode === "tiled", r = Rl();
	return /* @__PURE__ */ (0, g.jsx)("div", {
		className: [
			"btable-desktop",
...
function Mu({ compact: e = !1 }) {
	let [t, n] = (0, l.useState)(() => gs()), [r, i] = (0, l.useState)(!1);
	(0, l.useEffect)(() => ys(n), []);
	let a = ss(), o = fs();
	function s(e) {
		_s({ soundEnabled: e });
...
function Lu({ session: e, potMetrics: t, participantIds: n }) {
...
function Wu(e, t, n) {
	for (let r of n.drawCompletedIds) if (!Gu(e, r) && !e.displayDrawCompletedIds.includes(r) && !t.drawCompletedIds.includes(r)) return r;
	return null;
}
function Gu(e, t) {
...
function qu(e, t) {
	if (t.phase !== "draw" || !Ku(e)) return null;
	let n = e.animatingDrawPlayerId, r = t.turnPlayerId;
	return !n || !r || t.drawCompletedIds.includes(r) || n === r && !t.drawCompletedIds.includes(n) ? null : (qc() && Jc("handPresentation", "fast-forward-stale-draw", {
		animating: n,
		turnId: r,
...
function Ju(e, t) {
	return !t || Gu(e, t) ? e.drawPresentationConsumedIds : [...e.drawPresentationConsumedIds, t];
}
function Yu(e, t) {
	return [...new Set([...e.drawPresentationConsumedIds, ...t])];
}
function Xu(e, t, n) {
	for (let r of t.actionOrder) if (t.participantIds.includes(r) && t.drawCompletedIds.includes(r) && !n.includes(r) && !Gu(e, r)) return r;
	return null;
}
function Zu(e, t, n, r) {
	qc() && Jc("handPresentation", "draw-candidate-resolve", {
		handNumber: e.handNumber,
...
function Qu(e, t, n) {
	qc() && Jc("handPresentation", `draw-receive-commit-${e}`, {
...
function $u(e, t) {
	...
	let r = e.displayDrawCompletedIds.includes(n) ? e.displayDrawCompletedIds : [...e.displayDrawCompletedIds, n], i = Ju(e, n), a = t == null ? e.prevSnapshot : {
		...t,
		drawCompletedIds: [...r]
	};
	return Qu("payload", e, {
...
function ed(e, t, n, r, i, a) {
	return Gu(e, n) ? (Zu(e, t, null, `consumed-skip:${n}:${a}`), e) : Ku(e) && e.animatingDrawPlayerId !== n ? (Zu(e, t, null, `in-flight-skip:${a}`), e) : (Zu(e, t, n, a), Hu(e, "drawPlayer", {
		animatingDrawPlayerId: n,
		drawAnimSubPhase: "discard",
		drawDiscardCount: r,
		drawReplaceCount: i,
		prevSnapshot: t,
		drawPresentationConsumedIds: Ju(e, n)
	}));
}
function td(e) {
	if (!e.pendingHandSettle || e.phase !== "play") return e;
	let t = e.handSettleSnapshot ?? e.prevSnapshot;
	return t ? Hu(e, "settle", {
		pendingHandSettle: !1,
		handSettleSnapshot: null,
		settleAnimActive: !0,
...
function rd(e, t, n, r) {
	...
	return i ? ed(e, t, i, n, r, "beginDrawSequence") : Hu(e, "drawPlayer", {
...
function id(e, t) {
	let n = ad(e, t);
	return qc() && (e.phase !== n.phase || e.handNumber !== n.handNumber || e.trumpRevealActive !== n.trumpRevealActive || t.type === "serverUpdate") && Jc("handPresentation", t.type, {
...
function ad(e, t) {
	switch (t.type) {
		case "reset": return Vu(t.snapshot);
		...
		case "watchdog": return e.pendingHandSettle && e.phase === "play" ? td(e) : Date.now() - e.phaseStartedAt < 12e3 ? e : od({
			...e,
			pendingSnapshot: e.pendingSnapshot ?? e.prevSnapshot
		});
		case "tryBeginHandSettle": return td(e);
		case "advancePhase": return od(e);
		case "serverUpdate": {
			let { snapshot: n, heroDrawDiscardCount: r = 0, heroDrawReplaceCount: i = 0 } = t, a = e.prevSnapshot ?? n;
			if (e.sessionKey !== n.sessionKey) {
				let e = Vu(n);
				return n.phase === "reveal" ? nd(e, n) : e;
			}
			...
			if (n.phase === "play" && e.phase !== "play") return Hu(e, "play", {
			...
			if (Ru(e.phase) && e.phase !== "drawPlayer" || e.phase === "drawPlayer" && e.drawAnimSubPhase !== "done") return {
				...e,
				pendingSnapshot: n
			};
			...
			let o = Uu(a, n), s = Object.keys(o).length > 0;
			...
			if (n.phase === "reveal" && a.phase !== "reveal" && (e.phase === "idle" || e.phase === "nextHandReset" || e.phase === "enrollment" || e.phase === "settle" || e.phase === "play")) return nd(e, n);
			if (n.phase === "draw" && a.enrollmentActive && !n.enrollmentActive && e.phase === "enrollment") {
				let t = !!n.trumpUpcard;
				return Hu(e, t ? "trumpReveal" : "ante", {
					trumpRevealActive: t,
					anteAnimActive: !0,
			...
			if (n.phase === "draw" && (e.phase === "decision" || a.phase === "decision") && e.drawPresentationConsumedIds.length === 0 && e.displayDrawCompletedIds.length === 0 && e.phase !== "drawPlayer" && e.phase !== "drawReady") return rd(e, n, 0, 0);
			if (n.phase === "draw") {
				let t = qu(e, n);
				t && (e = t);
				let o = Wu(e, a, n);
				if (o && e.phase !== "drawReady") {
					...
					if (!t && !Ku(e)) {
						...
						return ed(e, n, o, a, t ? i : a, "serverUpdate");
					}
					t ? Zu(e, n, null, "serverUpdate:animating-same-player") : Ku(e) && Zu(e, n, null, "serverUpdate:in-flight-other-player");
				} else o || Zu(e, n, null, "serverUpdate:no-candidate");
				if (n.drawCompletedIds.length === n.participantIds.length && n.participantIds.length > 0 && e.phase === "drawPlayer" && e.drawAnimSubPhase === "done") return Hu(e, "drawReady", { prevSnapshot: n });
			}
			return {
				...e,
				prevSnapshot: n,
...
function od(e) {
	...
	switch (e.phase) {
		case "handReset": return Hu(e, "ante", {
			anteAnimActive: !0,
			pendingSnapshot: null
		});
		case "ante": return e.trumpRevealActive || t?.trumpUpcard ? Hu(e, "trumpReveal", {
			trumpRevealActive: !0,
			anteAnimActive: !1,
			pendingSnapshot: null
		}) : t?.phase === "draw" ? rd(e, t, 0, 0) : Hu(e, "drawPlayer", {
			anteAnimActive: !1,
			pendingSnapshot: null
		});
		...
		case "drawPlayer": {
			...
			Qu("before", e);
			let n = e.animatingDrawPlayerId, r = $u(e, t);
			Qu("after", r);
			let i = t ?? r.prevSnapshot;
			if (i && r.displayDrawCompletedIds.length >= i.participantIds.length) return Hu(r, "drawReady", {
				...
				drawPresentationConsumedIds: Yu(r, r.displayDrawCompletedIds)
			});
			if (i) {
				let e = {
					...i,
					drawCompletedIds: [...r.displayDrawCompletedIds]
				}, t = Xu(r, i, r.displayDrawCompletedIds);
				if (Qu("after", r, {
					playerId: n,
					nextCompleted: r.displayDrawCompletedIds,
					nextChosen: t
				}), t) return Zu(r, i, t, "advancePhase:nextPlayer"), ed(r, e, t, 1, 1, "advancePhase:nextPlayer");
				Zu(r, i, null, "advancePhase:no-next-player");
			}
			return r;
		}
		case "drawReady": return Hu(e, "play", { pendingSnapshot: null });
		case "settle": return Hu(e, "nextHandReset", {
			settleAnimActive: !1,
			nextHandResetActive: !0,
			pendingSnapshot: null
		});
		case "nextHandReset": return t ? Vu(t) : Hu(e, "idle", { nextHandResetActive: !1 });
		default: return e;
	}
}
function sd(e) {
...
function cd(e, t = !1) {
	...
	switch (e.phase) {
		...
		case "drawPlayer": return e.drawAnimSubPhase === "done" && !e.animatingDrawPlayerId ? 0 : jl(e.drawAnimSubPhase === "receive" ? 0 : e.drawDiscardCount, e.drawAnimSubPhase === "receive" ? e.drawReplaceCount : 0, t);
...
function fd({ session: e, enrollmentActive: t, potAmount: n, handComplete: r, trickPipelineActive: i = !1, forceTrickHandEndDrain: a, heroCards: o = ud, enrolledIds: s = ld, declinedIds: c = ld, actionOrder: u }) {
	let d = (0, l.useMemo)(() => zu({
		...
		c,
		u
	]), [f, p] = (0, l.useReducer)(id, d, Vu), m = (0, l.useRef)([]), h = (0, l.useRef)([]), g = (0, l.useRef)(null), _ = (0, l.useRef)(f);
	_.current = f;
	let v = () => {
	...
	return (0, l.useEffect)(() => () => v(), []), (0, l.useEffect)(() => {
		let e = o.map((e) => `${e.rank}-${e.suit}`), t = dd(h.current, e);
		h.current = e, p({
			type: "serverUpdate",
			snapshot: d,
			heroDrawDiscardCount: t.discardCount,
			heroDrawReplaceCount: t.replaceCount
		}), qc() && Jc("useHandPresentation", "serverUpdate-effect", {
		...
		let e = Uc(), t = `${f.handNumber}:${f.phase}:${f.animatingDrawPlayerId ?? ""}:${f.drawAnimSubPhase}:${f.phaseStartedAt}`;
		if (g.current === t) {
			qc() && Jc("useHandPresentation", "advancePhase-timer-skip-duplicate", { phaseKey: t });
			return;
		}
		v();
		let n = cd(f, e);
		...
		g.current = t, qc() && Jc("useHandPresentation", "advancePhase-timer-armed", {
			phaseKey: t,
			delay: n,
			fromPhase: f.phase,
			drawAnimSubPhase: f.drawAnimSubPhase
			...
			if (e.handNumber !== r.handNumber || e.phase !== r.phase || e.animatingDrawPlayerId !== r.animatingDrawPlayerId || e.drawAnimSubPhase !== r.drawAnimSubPhase || e.phaseStartedAt !== r.phaseStartedAt) {
				qc() && Jc("useHandPresentation", "advancePhase-timer-stale", {
					armedAt: r,
					current: {
						handNumber: e.handNumber,
						phase: e.phase,
			...
			qc() && Jc("useHandPresentation", "advancePhase-timer", {
				fromPhase: r.phase,
				delay: n,
				animatingDrawPlayerId: r.animatingDrawPlayerId,
				drawAnimSubPhase: r.drawAnimSubPhase
			}), p({ type: "advancePhase" });
		}, n), y(() => p({ type: "watchdog" }), f.phase === "drawPlayer" || f.phase === "drawReady" ? Ol : Dl);
	}, [
		f.handNumber,
		f.phase,
		...
		let e = window.setTimeout(() => {
			let e = _.current;
			e.phase !== "play" || !e.pendingHandSettle || (qc() && Jc("useHandPresentation", "hand-end-convergence-force", { trickPipelineActive: !0 }), a?.(), p({ type: "tryBeginHandSettle" }));
		}, kl);
		return () => window.clearTimeout(e);
	}, [
		f.phase,
...
function yd(e) {
	let t = e?.currentHand ?? pd(), n = e?.liveEnrollment?.deal?.publicHand, r = n?.phase ?? null;
	if (md(t) && n && !hd(n)) return pd();
	if (hd(t) && hd(n)) {
		let e = t.phase === "reveal" || t.phase === "decision", r = n?.drawCompletedIds?.length ?? 0, i = t.drawCompletedIds?.length ?? 0, a = fc(n?.tricksByPlayer ?? {}, n?.participantIds ?? []), o = fc(t.tricksByPlayer ?? {}, t.participantIds ?? []);
		return e && n?.phase === "draw" && o === 0 && a === 0 && r > 0 && i === 0 ? t : _d(t, n);
	}
	if (hd(t)) return t;
	if (r === "draw" || r === "play" || r === "reveal" || r === "decision") {
		if (hd(n)) {
			let i = fc(n?.tricksByPlayer ?? {}, n?.participantIds ?? []);
			return md(t) && i === 0 && r === "draw" && !e?.liveEnrollment?.active ? pd() : n;
		}
		return n?.phase ? n : vd(t) ? t : md(t) ? pd() : t;
	}
	return r && n ? n : t;
}
function Q(e) {
...
function kd(e) {
	let t = e.session, n = t ? yd(t) : Od(), r = n.phase ?? null, i = n.participantIds ?? [], a = n.tricksByPlayer ?? {}, o = fc(a, i), s = i.length > 0 && pc(a, i), c = !!t?.pendingCoWinSettlement?.winnerIds?.length, l = t ? Q(t) : null, u = xd(r, n.handDecision ?? null), d = bd({
...
function Rd(e) {
	...
	return Pd.has(t.phase) ? t.turnPlayerId : null;
}
function zd(e, t, n) {
	let r = Nd - Math.max(0, n - t) % Nd;
	return {
		playerId: e,
		remainingMs: r,
		progress: r / Nd,
...
function Bd(e) {
	...
	return (0, l.useEffect)(() => {
		...
		let e = () => o(Date.now()), n = Uc() ? 250 : 100, i = window.setInterval(e, n);
		return () => window.clearInterval(i);
	}, [t, n]), {
		countdown: t && r.current != null ? zd(t, r.current, a) : null,
		reducedMotion: Uc()
	};
}
//#endregion
...
function Hd({ active: e, displayName: t }) {
	let [n, r] = (0, l.useState)(!1), i = Uc();
	return (0, l.useEffect)(() => {
		if (!e) {
			r(!1);
			return;
...
function Gd(e) {
	...
	let d = () => {
		...
		let e = c.current;
		if (e === 0) return;
		let t = Wd[Math.min(e - 1, Wd.length - 1)];
	...
	}, Ud), d) : (n("hidden"), i(0), d)), [e.activityKey, e.actionRequired]), (0, l.useEffect)(() => {
		if (t !== "pop") return;
		let e = Uc() ? 280 : 420;
...
function qd({ actionRequired: e, activityKey: t }) {
	let { phase: n, beat: r } = Gd({
		actionRequired: e,
		activityKey: t
	});
	if (n === "hidden") return null;
	let i = Kd(), a = Math.min(r, 5);
	return /* @__PURE__ */ (0, g.jsx)("div", {
		className: [
			"byour-turn",
...
function Zd(e) {
	...
	let c = Xd(e.phase), u = e.actionRequired && c != null && !e.hasUserInteracted;
	return (0, l.useEffect)(() => {
		...
		if (o.current != null && (window.clearInterval(o.current), o.current = null), !t || !u || Uc()) {
			i(!0);
			return;
		}
...
function Qd({ actionRequired: e, activityKey: t, phase: n, hasUserInteracted: r }) {
	let { visible: i, text: a, flashOn: o } = Zd({
		actionRequired: e,
		activityKey: t,
		phase: n,
		hasUserInteracted: r
...
function cf(e) {
	return Math.max(e.pendingResolution?.frozen.plays.length ?? 0, Rc(e.prevTrick).length, e.peakTrickPlays?.length ?? 0);
}
function lf(e, t) {
	let n = Rc(t.currentTrick), r = Rc(e.prevTrick), i = of(e, t, n), a = e.phase === "live" && !e.pendingResolution && (n.length < e.revealedCount && r.length >= e.revealedCount || n.length < i.length && r.length >= i.length), o = t.currentTrick?.trickNumber ?? null, s = e.prevTrick?.trickNumber ?? null, c = o != null && s != null && o !== s;
	return {
		...e,
...
function df(e, t) {
	let n = ff(e, t);
	if (qc()) {
		let r = Rc(e.prevTrick).length, i = Rc(n.prevTrick).length;
		(e.phase !== n.phase || e.revealedCount !== n.revealedCount || r !== i || !!e.pendingResolution != !!n.pendingResolution || t.type === "serverUpdate") && Jc("trickPresentation", t.type, {
			phase: `${e.phase} -> ${n.phase}`,
...
function ff(e, t) {
	switch (t.type) {
		case "reset":
		case "reinit": return rf(t.type === "reinit" ? t.snapshot.tricksByPlayer : e.displayTricksByPlayer, t.type === "reinit" ? t.snapshot.currentTrick : null);
		case "revealNextCard": {
		...
		case "forceHandEndDrain": {
			...
			let n = t.pendingServer, r = n?.tricksByPlayer ?? {}, i = Object.values(r).some((e) => (e ?? 0) > 0), a = i ? { ...r } : { ...t.displayTricksByPlayer }, o = Rc(n?.currentTrick).length;
			return {
				...t,
				phase: "live",
				frozenTrick: null,
				...
				peakTrickPlays: Rc(n?.currentTrick),
		...
		case "advancePhase": switch (e.phase) {
			...
			case "nextLeadReady": {
				let t = e.pendingServer, n = Rc(t?.currentTrick).length;
				return {
					...e,
					phase: "live",
					frozenTrick: null,
					...
					peakTrickPlays: Rc(t?.currentTrick),
...
function mf(e, t) {
	...
	return {
		...
		suppressTurnPlayerId: Nc(e.phase),
...
function hf({ phase: e, currentTrick: t, tricksByPlayer: n, participantIds: r, trumpSuit: i, playedCards: a, turnPlayerId: o, handComplete: s = !1 }) {
	let [c, u] = (0, l.useReducer)(df, n, (e) => rf(e, t)), d = (0, l.useRef)([]), f = (0, l.useRef)(null), p = (0, l.useRef)(/* @__PURE__ */ new Set()), m = (0, l.useRef)(!1), h = (0, l.useRef)(null), g = (0, l.useRef)(0), _ = (0, l.useRef)(!1), v = (0, l.useRef)(c);
	v.current = c;
	...
	(0, l.useEffect)(() => () => S(), []), (0, l.useEffect)(() => {
		...
		if (c || !b && !m.current && !l) {
			...
			}), qc() && Jc("useTrickPresentation", c ? "reinit-play-entry" : "reinit-idle", {
		...
		u({
			...
			trumpSuit: i,
			reducedMotion: Uc()
		}), qc() && Jc("useTrickPresentation", "serverUpdate-effect", {
			sessionPhase: e,
			trickNumber: t?.trickNumber,
		...
		f.current = e, S();
		let t = c.frozenTrick, n = Fc({
			trumpBeat: Vc(t.plays, t.leadSuit, i),
			reducedMotion: Uc()
		});
		...
		let t = Uc() ? 264 : 480, n = window.setTimeout(() => u({ type: "commitTrickResolution" }), t);
		return () => window.clearTimeout(n);
	}, [
		b,
		y,
		...
		if (!y || !t || b && !s) return;
		let n = Uc(), i = n ? 60 : 160, a = n ? 80 : 220, o = [], l = (e, t) => {
			o.push(window.setTimeout(e, t));
		};
		qc() && Jc("useTrickPresentation", "hand-end-drain-armed", {
			phase: c.phase,
		...
		return l(() => {
			let e = v.current;
			e.phase === "live" && !e.pendingResolution || (qc() && Jc("useTrickPresentation", "hand-end-drain-force", {
				phase: e.phase,
	...
	let T = () => {
		...
		h.current = window.setTimeout(() => {
			h.current = null, qc() && Jc("useTrickPresentation", "revealNextCard-timer", {
...
}, _f = gf, vf = /* @__PURE__ */ new Set(), yf = 0, bf = null;
function xf(e, t) {
...
function Tf(e) {
	let t = { ..._f }, n = bf ? Date.now() - bf.since : 0, r = {
		..._f,
		pipelineActive: !1,
		revealCatchUp: !1,
		handPresenting: !1,
		handPresentationPhase: "idle",
		peakPlayCount: _f.displayedPlayCount,
		motionGateActive: !1
	};
	yf = Date.now() + 1500, bf = null, qc() && Jc("trickAnimationBridge", "table-presentation-force-release", {
		source: e,
		blockedMs: n,
		from: t,
		to: r
...
function Ef(e = Date.now()) {
	...
	let n = e - bf.since;
	return n >= 4e3 ? (qc() && !bf.blockedLogged && Jc("trickAnimationBridge", "gate-force-release", {
		reason: t,
		blockedMs: n
	}), Tf("gate-timeout"), {
		blocked: !1,
		...
		softUnblock: !0,
		forceReleased: !0
	}) : n >= 3500 ? (qc() && !bf.blockedLogged && (Jc("trickAnimationBridge", "gate-soft-unblock", {
		reason: t,
		blockedMs: n
	}), bf.blockedLogged = !0), {
		blocked: !1,
		...
		softUnblock: !0,
		forceReleased: !1
	}) : (qc() && !bf.blockedLogged && (Jc("trickAnimationBridge", "gate-blocked", {
		reason: t,
		blockedMs: n
	}), bf.blockedLogged = !0), {
		blocked: !0,
...
function Of(e) {
	if (!xf(_f, e)) {
		qc() && Jc("trickAnimationBridge", "busy-state", {
			from: _f,
			to: e,
			busy: Cf(e),
			blockReason: Sf(e),
...
function jf() {
	return _f.pipelineActive || _f.revealCatchUp || _f.motionGateActive || _f.peakPlayCount > _f.displayedPlayCount && _f.peakPlayCount > 0;
}
function Mf() {
	return Cf(_f);
}
function Nf(e) {
	return vf.add(e), () => vf.delete(e);
}
//#endregion
...
function If({ session: e, players: t, splitSharePerWinner: n, currentUserId: r, isCoWinner: i, onAgreeSplit: a, onDeclineSplit: o, onCarryover: s }) {
	let c = e.pendingCoWinSettlement?.winnerIds ?? [], u = e.pendingCoWinSettlement?.votes ?? {}, [d, f] = (0, l.useState)(Pf), [p, m] = (0, l.useState)(!1), h = (0, l.useRef)(null), _ = (0, l.useRef)(!1), v = (0, l.useMemo)(() => `${c.join(",")}:${e.handNumber ?? 0}`, [c, e.handNumber]);
	(0, l.useEffect)(() => {
		h.current = Date.now(), _.current = !1, f(Pf), m(!1);
	}, [v]);
	...
	if ((0, l.useEffect)(() => {
		...
		let e = window.setInterval(() => {
			let e = h.current ?? Date.now(), t = Date.now() - e, n = Math.max(0, Pf - t);
			f(n), n <= 0 && !y && b();
		}, 100);
	...
	let x = Math.max(0, Math.ceil(d / 1e3)), S = c.map((e) => Ff(e, t)).join(" & "), C = (e) => {
	...
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, g.jsxs)("p", {
				...
				children: [gc(n), " each if all agree"]
			}),
...
function zf(e) {
	...
	let { trumpMergeActive: i, trumpMergedIntoHand: a } = e.handPresentation, o = hu({
...
var Bf = [], Vf = [], Hf = [];
function Uf({ session: e, players: t, potMetrics: n, mySessionNet: r, leaderLabel: i, showCoWinSettlement: a, splitPotEnabled: o = !1, rebuyEnabled: s = !1, splitSharePerWinner: c = 0, enrollmentActive: u = !1, currentUserId: d, heroCards: f = Vf, rawHeroCards: p = Vf, privateHandReady: m = !1, legalPlayIndices: h, recentBourreIds: _ = Hf, handComplete: v = !1, actionFeedback: y, actions: b }) {
	let { settings: x } = $s(), S = Rl(), [C, w] = (0, l.useState)(!1), T = e.participantIds.length, { events: E, dismissEvent: D, pushReaction: O } = Lu({
		session: e,
		potMetrics: n,
		participantIds: e.participantIds
	}), k = d != null && (e.pendingCoWinSettlement?.winnerIds || []).includes(d), A = hf({
		phase: e.phase,
		...
		heroCards: f,
		enrolledIds: e.handEnrollment?.enrolledIds ?? Bf,
		declinedIds: e.handEnrollment?.declinedIds ?? Bf,
		actionOrder: e.actionOrder ?? e.handEnrollment?.orderedPlayerIds ?? e.participantIds
	}), ee = nf(e.phase, e.trumpUpcard, A.displayPlays.length), N = wf(M.isPresenting, M.phase, e.phase);
	(0, l.useEffect)(() => {
		Of({
	...
	let te = Va(e.phase), P = (0, l.useMemo)(() => hu({
		...
		M.trumpMergeActive,
		M.trumpMergedIntoHand
	]), ne = F.displayCards, I = (0, l.useMemo)(() => !h?.length || F.indexMode === "effective" ? h : Lf(h, F.trumpDisabledIndex), [
		h,
		F.indexMode,
		...
		return t == null ? null : F.indexMode === "effective" ? t : Lf([t], F.trumpDisabledIndex)[0] ?? null;
	}, [
		h,
		f,
		e.trumpSuit,
		...
		let t = f.map(Ia), n = F.indexMode === "display" && F.trumpDisabledIndex != null ? Rf([F.trumpDisabledIndex], F.trumpDisabledIndex) : F.trumpDisabledIndex == null ? [] : [F.trumpDisabledIndex], r = Io(t, e.trumpSuit ?? "clubs", e.maxDrawDiscards ?? 4, e.remainingDeckCount ?? Infinity, n);
		return F.indexMode === "effective" ? r : Lf(r, F.trumpDisabledIndex);
	}, [
		e.phase,
		f,
		e.trumpSuit,
		...
		F.indexMode,
		F.trumpDisabledIndex
	]), z = A.suppressTurnPlayerId || M.suppressTurnIndicator, B = La(e.phase, u), re = z ? null : Wa(e.turnPlayerId, t), ie = t.find((e) => e.isSelf), V = d != null && e.participantIds.includes(d) && (e.phase === "draw" || e.phase === "play"), H = s && !e.isFinal && !V && !a && ie?.isOut === !0 && !!b.onRebuy, ae = !!(d && e.turnPlayerId === d) && !z, U = $d({
		currentUserId: d,
		enrollmentActive: u,
		selfPlayer: ie,
		session: e,
		suppressTurn: !!z,
		handComplete: v
	}), oe = U && !v && (u || e.phase === "decision") ? Ra(e.phase, u) : null, se = !oe && !z && !(re && te && A.phase === "live") ? za({
		phase: e.phase,
		enrollmentActive: u,
		isMyTurn: ae,
		handComplete: v,
	...
	let de = (0, l.useCallback)(() => {
		ue(!0);
	}, []), fe = U && !v && !le && (e.phase === "draw" || e.phase === "play"), { countdown: pe } = Bd({
		session: e,
		suppressTurn: !!z,
		handComplete: v
	}), me = P.showTrumpSuitReminder || !e.trumpUpcard && !!e.trumpSuit && e.phase === "play", he = (0, l.useMemo)(() => ({ ...A.displayTricksByPlayer }), [A.displayTricksByPlayer]), ge = (0, l.useMemo)(() => Object.fromEntries(t.map((e) => [e.playerId, Math.max(0, Number(e.bankroll) || 0)])), [t]), _e = Vd({
		turnPlayerId: e.turnPlayerId ?? null,
		dealerId: e.dealerId,
		...
		trickPhase: A.phase
	}), ve = !!ie?.playerId && (_ ?? []).includes(ie.playerId) && _e.bourreAlerts[ie.playerId] === "pulse", ye = (0, l.useRef)(0), be = (0, l.useRef)(0);
	(0, l.useEffect)(() => {
		_e.feedbackErrorPulse > ye.current && zs(), ye.current = _e.feedbackErrorPulse;
	}, [_e.feedbackErrorPulse]), (0, l.useEffect)(() => {
		_e.feedbackSuccessPulse > be.current && Bs(), be.current = _e.feedbackSuccessPulse;
	...
	let xe = (0, l.useCallback)((e) => {
		...
		S ? /* @__PURE__ */ (0, g.jsx)(Eu, { ...Ce }) : /* @__PURE__ */ (0, g.jsx)(vu, { ...Ce })
	] }), Te = (0, l.useRef)(!1);
	return (0, l.useEffect)(() => {
		Te.current = !1;
	}, [e.handNumber, e.sessionId]), (0, l.useEffect)(() => {
		if (e.phase !== "reveal" || !M.trumpMergedIntoHand || M.phase !== "drawPlayer" || Te.current || !b.onAdvanceReveal) return;
		...
		children: [
			y && y.status !== "idle" && /* @__PURE__ */ (0, g.jsx)("div", {
				...
				"aria-live": "polite",
				children: y.message
			}, y.status === "error" ? `feedback-error-${_e.feedbackErrorPulse}` : y.status === "success" ? `feedback-success-${_e.feedbackSuccessPulse}` : `feedback-${y.status}`),
			/* @__PURE__ */ (0, g.jsxs)("header", {
				...
				children: [
					...
					re && te && A.phase === "live" && /* @__PURE__ */ (0, g.jsx)("p", {
						className: ["btable-session__turn", ae ? "btable-session__turn--yours" : "btable-session__turn--waiting"].join(" "),
						"aria-live": "polite",
			...
			S ? /* @__PURE__ */ (0, g.jsx)(Au, { children: /* @__PURE__ */ (0, g.jsx)("div", {
				className: "btable-stage",
				children: we
			}) }) : /* @__PURE__ */ (0, g.jsx)(ku, { children: /* @__PURE__ */ (0, g.jsx)("div", {
				className: "btable-stage",
				children: we
			}) }),
			/* @__PURE__ */ (0, g.jsx)(Nu, {
			...
			a && !e.isFinal && o && /* @__PURE__ */ (0, g.jsx)(If, {
				session: e,
				players: t,
			...
			/* @__PURE__ */ (0, g.jsxs)("footer", {
				...
				children: [
					...
					r == null ? /* @__PURE__ */ (0, g.jsx)(g.Fragment, { children: "Shared pot and game state only · sign in to track your ledger" }) : /* @__PURE__ */ (0, g.jsxs)(g.Fragment, { children: ["Your session profit/loss ", vc(r)] })
				]
			})
		]
	});
...
var Wf = null, Gf = null;
function Kf(e, t) {
	Fs(), ra(e), Gf !== e && (Wf?.unmount(), Wf = (0, u.createRoot)(e), Gf = e), Wf.render(/* @__PURE__ */ (0, g.jsx)(Qs, { children: /* @__PURE__ */ (0, g.jsx)(Uf, { ...t }) }));
}
function qf() {
	Gf && ru(Gf), Wf?.unmount(), Wf = null, Gf = null, kf();
}
//#endregion
export { ru as clearWonTrickCollectionArtifacts, Ef as evaluateBotPresentationGate, Tf as forceReleasePresentationForBots, gs as getFeedbackPrefs, Sf as getTablePresentationBlockReason, Af as getTrickAnimationBusyState, wf as handPresentingBlocksBots, Fs as initGameFeedback, Mf as isTablePresentationBusy, Df as isTablePresentationBusyForBots, jf as isTrickAnimationBusy, Kf as mountTableSession, Rs as playBigWinFeedback, Is as playShuffleFeedback, Ls as playTrickWinFeedback, _s as saveFeedbackPrefs, ys as subscribeFeedbackPrefs, Nf as subscribeTrickAnimationBusy, qf as unmountTableSession };
