...
| GitHub Actions: Hosting deployed but Functions still old | Legacy workflow deployed Hosting first | Re-run **Deploy to Firebase** (Functions-first since PR deploy-order fix) or **Deploy Functions Only** then verify |
