...
/** Readability pause after last card before winner highlight (~500 ms). */
...
export const TRUMP_BEAT_READ_MS = 625;
...
/** Phases where turn/lead UI must stay suppressed (read + winner reveal only). */
