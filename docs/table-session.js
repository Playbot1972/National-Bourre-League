...
function Cv({ session: e, players: t, potMetrics: n, mySessionNet: r, leaderLabel: i, showCoWinSettlement: a, splitPotEnabled: o = !1, rebuyEnabled: s = !1, rebuyPurchase: c, splitSharePerWinner: u = 0, enrollmentActive: d = !1, currentUserId: f, authSignedIn: p, authReady: m = !0, heroCards: h = xv, rawHeroCards: _ = xv, privateHandReady: v = !1, legalPlayIndices: y, recentBourreIds: b = Sv, handComplete: x = !1, actionFeedback: S, actions: C, watchOnly: w = !1, watchOnlyMessage: T, playNowModeLabel: E, idleStatusBanner: D }) {
	let { settings: O } = Ld(), k = Nm(), [A, j] = (0, l.useState)(!1), M = rv({
		...
		potMetrics: n,
		participantIds: e.participantIds
	}), F = (0, l.useMemo)(() => [...ee].reverse().find((e) => e.kind === "big-pot") ?? null, [ee]), ne = f != null && (e.pendingCoWinSettlement?.winnerIds || []).includes(f), I = $_({
		phase: e.phase,
		handNumber: e.handNumber,
	...
	let z = (0, l.useMemo)(() => {
		...
		u,
		f
	]), { visible: V, manualContinueAllowed: H } = mv(a, z, B), ie = z_(e.phase, e.trumpUpcard, I.displayPlays.length), ae = cf(L.isPresenting, L.phase, e.phase), [U, oe] = (0, l.useState)(0);
	...
	let W = (0, l.useMemo)(() => ng({
		...
		L.trumpMergeActive,
		L.trumpMergedIntoHand
	]), se = G.displayCards, ce = (0, l.useMemo)(() => !y?.length || G.indexMode === "effective" ? y : _v(y, G.trumpDisabledIndex), [
		y,
		G.indexMode,
		...
		return t == null ? null : G.indexMode === "effective" ? t : _v([t], G.trumpDisabledIndex)[0] ?? null;
	}, [
		y,
		h,
		e.trumpSuit,
		...
		let t = h.map(Ns), n = G.indexMode === "display" && G.trumpDisabledIndex != null ? vv([G.trumpDisabledIndex], G.trumpDisabledIndex) : G.trumpDisabledIndex == null ? [] : [G.trumpDisabledIndex], r = Jc(t, e.trumpSuit ?? "clubs", e.maxDrawDiscards ?? 4, e.remainingDeckCount ?? Infinity, n);
		return G.indexMode === "effective" ? r : _v(r, G.trumpDisabledIndex);
	}, [
		e.phase,
		h,
		e.trumpSuit,
		...
		handComplete: x,
		watchOnly: w
	}), Se = (0, l.useMemo)(() => t.filter((e) => e.idleSitOut).map((e) => e.playerId), [t]), { countdown: Ce } = g_({
		session: e,
		suppressTurn: !!de,
		handComplete: x,
		sitOutPlayerIds: Se,
	...
	let we = W.showTrumpSuitReminder || !e.trumpUpcard && !!e.trumpSuit && e.phase === "play", Te = (0, l.useMemo)(() => ({ ...I.displayTricksByPlayer }), [I.displayTricksByPlayer]), Ee = (0, l.useMemo)(() => Object.fromEntries(t.map((e) => [e.playerId, Math.max(0, Number(e.bankroll) || 0)])), [t]), De = A_({
		turnPlayerId: e.turnPlayerId ?? null,
		dealerId: e.dealerId,
	...
	let Ae = (0, l.useCallback)((e) => {
		...
		onSubmitDraw: (e) => {
			...
			let t = G.indexMode === "display" ? vv(e, G.trumpDisabledIndex) : e;
		...
		onPlayCard: (e) => {
			...
			let t = vv([e], G.trumpDisabledIndex)[0];
	...
	return (0, l.useEffect)(() => {
		...
		children: [
			...
			V && !e.isFinal && !o && /* @__PURE__ */ (0, g.jsx)(cv, {
				session: e,
				players: t,
				potMetrics: n,
				splitSharePerWinner: u,
