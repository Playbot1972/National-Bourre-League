...
function of({ cards: e, phase: t, enrollmentActive: n = !1, isInHand: r = !1, isDealer: i = !1, signedIn: a = !1, isMyTurn: o = !1, drawCompleted: s = !1, maxDrawDiscards: c = 4, legalPlayIndices: u, recommendedPlayIndex: d = null, recommendedDiscardIndices: f = [], handComplete: p = !1, actionFeedback: m, onSubmitDraw: h, onPassDraw: _, onFoldDraw: v, onPlayCard: y, privateHandReady: b = !1, className: x = "", dealStaggerMs: S = 120, drawAnimSubPhase: C = null, drawDiscardCount: w = 0, drawReplaceCount: T = 0, currentUserId: E = null, revealedTrumpIndex: D = null, trumpMergeActive: O = !1, trumpDisabledIndex: k = null, handNumber: A = 0, trickNumber: j = null, turnPlayerId: M = null, tableRootRef: ee, pileIndexRef: N, onDiscardCommitted: P, onUserActivity: F, skipHeroDealMotion: I = !1 }) {
	...
	(0, l.useEffect)(() => {
		...
		(C === "done" || C === null) && be([]);
	}, [C]), (0, l.useEffect)(() => ($d(H !== null), () => $d(!1)), [H]), As(Se, {
		dealing: pe,
		dealStaggerMs: S,
		drawAnimSubPhase: C,
		drawDiscardCount: w,
	...
	if (!r && !n && !je) return /* @__PURE__ */ (0, g.jsx)(af, { className: x });
	if (je && r && e.length === 0) return p && n ? /* @__PURE__ */ (0, g.jsx)(af, { className: x }) : /* @__PURE__ */ (0, g.jsxs)("div", {
		className: rf(L, x),
		"aria-live": "polite",
		"data-testid": "hero-hand",
		children: [/* @__PURE__ */ (0, g.jsx)("p", {
	...
	if (e.length === 0 && !i) return rt ? /* @__PURE__ */ (0, g.jsx)("div", {
		className: rf(L, x, ["btable-hero--reserved"]),
		"data-testid": "hero-hand",
		"aria-live": "polite",
		children: /* @__PURE__ */ (0, g.jsx)("div", {
			className: "btable-hero__hand-3d btable-hero__hand-3d--chrome-only",
...
function ip({ potMetrics: e, participantCount: t, trumpUpcard: n, trumpSuit: r, phase: i, enrollmentActive: a = !1, remainingDeckCount: o, trickDisplayPlays: s = [], trickLeadSuit: c = null, trickLeaderPlayerId: u = null, trickWinnerPlayerId: f = null, trickShowWinnerTag: p = !1, trickPresentationPhase: m = "live", trickEchoPlays: h = [], trickEchoWinnerId: v = null, trickEchoPhase: y = "live", showFinalTrickEcho: b = !1, playerNames: x = {}, anteAnimActive: S = !1, trumpRevealActive: C = !1, drawAnimPlayerId: w = null, drawAnimSubPhase: T = "done", drawDiscardCount: E = 0, settleAnimActive: D = !1, settleCarryOver: O = !1, potTick: k = 0, trumpReminderPulse: A = 0, hideCenterTrump: j = !1, trumpMergeActive: M = !1, showTrumpSuitReminder: ee = !1, instantTrickPlays: te = !1, peakTrickPlayCount: N = 0, discardPileCards: P = [], currentUserId: F = null, onCardLanded: I }) {
	let L = Ns(i, a), R = u ?? ((m === "live" || m === "trickComplete") && s.length > 0 ? Jf(s, c ?? s[0]?.card.suit ?? null, r ?? null) : null), z = m !== "live" && m !== "nextLeadReady", B = s.length, V = B > 0 || N > B || te, [H, ne] = (0, l.useState)(n ?? null);
	(0, l.useEffect)(() => {
		if (n) {
			ne(n);
			return;
	...
	return /* @__PURE__ */ (0, g.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, g.jsxs)("div", {
			...
			children: [
				...
				i === "draw" ? /* @__PURE__ */ (0, g.jsx)(rp, { cards: P }) : null,
				/* @__PURE__ */ (0, g.jsxs)("div", {
...
function Fp(e, t) {
	let n = Np(e.x, Ap.min, Ap.max), r = t === "portrait" ? jp : Mp, i = Np(e.y, 8, r);
	return {
		...e,
		x: n,
		y: i
...
function Ip(e, t, n) {
	...
	let r = Rf(e, t), i = n.isMobile && n.orientation ? Fp(r, n.orientation) : r;
	return {
		...i,
		seatIndex: e,
		handLane: Pp(i, {
...
var zp = 1e3, Bp = 1e3, Vp = 12e3, Hp = 4e3, Up = Vf;
function Wp(e = Qf()) {
...
function xm({ steps: e, root: t, trumpHolderId: n = null, onStepComplete: r, onComplete: i }) {
	...
	e.forEach((e, i) => {
		...
		u.call(() => {
			...
			let i = _m(l);
			t.appendChild(i);
			let c = $i(i), { x: u, y: d } = na(c, l), p = f.left + f.width / 2, m = f.top + f.height / 2, h = c.left + c.width / 2, g = c.top + c.height / 2, _ = p - h, v = m - g, { midX: y, midY: b } = gm(_, v);
			J.set(i, {
				transformOrigin: "50% 80%",
				willChange: "transform,opacity",
				x: u,
...
function Sm({ session: e, heroCards: t, privateHandReady: n = !1, dealPresentationAllowed: r = !0, tableRootRef: i }) {
	let [a, o] = (0, l.useState)(!1), s = (0, l.useRef)(null), c = (0, l.useRef)(e.handNumber);
	return (0, l.useLayoutEffect)(() => {
		let t = i.current;
		t && c.current !== e.handNumber && (c.current = e.handNumber, s.current = null, bm(), ym(t), Q(!1), o(!1));
		...
		let p = pm(f, 5);
		if (!p.length) return;
		s.current = u, bm(), ym(a), a.classList.add("btable-wrap--clockwise-dealing"), o(!0), Q(!0);
		...
		return () => {
			window.cancelAnimationFrame(h), window.clearTimeout(g), bm(), a.classList.remove("btable-wrap--clockwise-dealing"), Q(!1), o(!1);
		};
	}, [
		e.handNumber,
		e.phase,
...
function Tm(e, t = {}) {
	...
	let d = R(I.trumpMerge), f = a * .45, p = o * .45 - Math.max(24, Math.hypot(a, o) * .18), m = J.timeline({
		onComplete: () => {
			s.remove(), J.set(r, { clearProps: "opacity" }), c && J.set(c, { clearProps: "opacity" }), J.set(n, { clearProps: "opacity" }), Cm = null, t.onComplete?.();
		},
		onInterrupt: () => {
			s.remove(), J.set(r, { clearProps: "opacity" }), c && J.set(c, { clearProps: "opacity" }), J.set(n, { clearProps: "opacity" }), Cm = null;
		}
	});
	return m.add(qo(s, {
		path: [
...
function Em({ tableRootRef: e, trumpMergeActive: t, isTrumpHolder: n, onComplete: r }) {
...
function km(e, t) {
	let n = Dm(`${e}@book${t}`), r = Om(n, 0), i = Om(n, 9), a = Om(n, 17), o = r >= .5 ? 1 : -1, s = i >= .5 ? 1 : -1;
	return {
...
var jm = /* @__PURE__ */ new Set(), Mm = /* @__PURE__ */ new Set(), Nm = I.drawDiscard;
function Pm(e, t) {
	return {
		midX: e * .5,
		midY: t * .5
...
function Im() {
	for (let e of Mm) J.set(e, { clearProps: "opacity,transform,willChange,zIndex" });
	Mm.clear();
}
function Lm(e) {
	let t = e instanceof Document ? e : e.ownerDocument ?? document;
...
function Wm(e, t) {
	Ko(t.root ?? document);
	let n = z(), r = t.root ?? document, i = t.host ?? (r instanceof HTMLElement ? r : document.body), a = Fm(t.winnerPlayerId, r), o = n ? .06 : 140 / 1e3, s = R(Nm, n), c = n ? .03 : .05, l = [], u = (e) => {
		jm.delete(d);
		for (let e of l) e.remove();
		Im(), e && Um(t.winnerPlayerId, r), t.onComplete?.();
	}, d = J.timeline({
		onComplete: () => u(!0),
		onInterrupt: () => u(!1)
	});
	jm.add(d), e.forEach((e, r) => {
		let u = km(t.trickKey, t.bookIndex), f = Hm(e, i);
		l.push(f), Mm.add(e), J.set(e, { opacity: 0 });
		let p = $i(f);
		J.set(f, {
			transformOrigin: "50% 50%",
			willChange: "transform,opacity",
		...
		let h = a.left + a.width / 2 + u.offsetX, g = a.top + a.height / 2 + u.offsetY, _ = p.left + p.width / 2, v = p.top + p.height / 2, y = h - _, b = g - v, { midX: x, midY: S } = Pm(y, b);
		d.to(f, {
			scale: .98,
			duration: o,
			ease: N
	...
	return Vm(d, Math.min(760, Math.max(300, f))), d;
}
function Gm() {
	return jm.size > 0;
}
...
var qm = new Set(["nextLeadReady", "live"]);
function Jm({ trickPresentation: e, handNumber: t, sessionPhase: n = null, handComplete: r = !1, tableRootRef: i, onTrickCollectionStart: a }) {
	...
	(0, l.useLayoutEffect)(() => {
		...
		if (s.current !== t) {
			if (c) return;
			s.current = t, o.current = null, d(), zm(a);
			return;
		}
		if (r || n != null && n !== "play") {
			if (c) return;
			o.current = null, d(), zm(a);
		}
	}, [
		t,
		r,
		...
		c.current = r;
		let s = i.current;
		if (!s || (n === "collectTrick" && qm.has(r) && (o.current = null, f(s)), r !== "collectTrick")) return;
		let l = e.trickWinnerSeatId, u = e.frozenTrick;
		if (!l || !u) return;
		let p = `${u.trickNumber}:${l}:${u.plays.length}`;
		if (o.current === p) return;
		o.current = p, d(), Bm(), Xm(s);
		let m = Km(s);
		if (!m.length) return;
		let h = Math.max(0, (e.displayTricksByPlayer[l] ?? 1) - 1), g = Am({
			playerId: l,
			handNumber: t,
...
function Zm({ trickPresentation: e, currentUserId: t = null, participantCount: n, trickNumber: r, sessionPhase: i = null }) {
...
function nh(e, t) {
	return eh(t) ? eh(e) ? th(t) >= th(e) ? t : e : t : e;
}
function rh(e) {
	let t = e?.phase ?? null;
...
function ih(e) {
	let t = e?.currentHand ?? Qm(), n = e?.liveEnrollment?.deal?.publicHand, r = n?.phase ?? null;
	if ($m(t) && n && !eh(n)) return Qm();
	if (eh(t) && eh(n)) {
		...
		return e && n?.phase === "draw" && o === 0 && a === 0 && r > 0 && i === 0 ? t : nh(t, n);
	}
	if (eh(t)) return t;
	if (r === "draw" || r === "play" || r === "reveal" || r === "decision") {
		if (eh(n)) {
			let i = bf(n?.tricksByPlayer ?? {}, n?.participantIds ?? []);
			return $m(t) && i === 0 && r === "draw" && !e?.liveEnrollment?.active ? Qm() : n;
		}
		return n?.phase ? n : rh(t) ? t : $m(t) ? Qm() : t;
	}
	return r && n ? n : t;
}
function ah(e) {
...
new Map(uh.map((e) => [dh(e.from, e.event), e.to]));
function fh(e) {
...
function hh(e) {
	let t = e.session, n = t ? ih(t) : mh(), r = n.phase ?? null, i = n.participantIds ?? [], a = n.tricksByPlayer ?? {}, o = bf(a, i), s = i.length > 0 && xf(a, i), c = !!t?.pendingCoWinSettlement?.winnerIds?.length, l = t ? ah(t) : null, u = sh(r, n.handDecision ?? null), d = oh({
...
function wh(e, t, n, r, i) {
	...
	let a = t.showRevealedTrumpAtHolder ? Ch(r) : null;
	return {
...
function Th({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: u = !1, showTrumpSuitReminder: d = !1, trumpHolderPresentation: f, privateHandReady: p = !1, currentUserId: m = null, legalPlayIndices: h, recommendedPlayIndex: _, recommendedDiscardIndices: v = [], handComplete: y = !1, actionFeedback: b, trickPresentation: x, handPresentation: S, microinteractions: C, instantTrickPlays: w = !1, turnCountdown: T = null, watchOnly: E = !1, bigPotEvent: D = null, onDismissTableEvent: O, onToggleInHand: k, onPassEnrollment: A, onTrickDelta: j, onSubmitDraw: M, onPassDraw: ee, onFoldDraw: te, onPlayCard: N, onReaction: P, onHeroUserActivity: F }) {
	...
	let le = new Set(e.participantIds.filter((t) => Cf(t, x.displayTricksByPlayer, e.participantIds, e.phase))), ue = I.map((t) => {
		let r = x.displayTricksByPlayer[t.playerId] ?? 0, i = x.trickWinnerSeatId === t.playerId, a = x.suppressTurnPlayerId || S.suppressTurnIndicator, o = a || E, s = x.phase === "collectTrick" && i, c = S.enrollmentPulse[t.playerId], l = S.animatingDrawPlayerId === t.playerId, u = wh(t.playerId, f, e.trumpUpcard ?? null, t.holeCardCount ?? 0, t.isSelf);
		return {
			...t,
			...u,
...
var Dh = "(orientation: portrait)";
function Oh() {
	let e = nm(), [t, n] = (0, l.useState)(() => typeof window < "u" && window.matchMedia(Dh).matches);
	return (0, l.useEffect)(() => {
		let e = window.matchMedia(Dh), t = () => n(e.matches);
...
function Mh({ aspect: e, sessionKey: t }) {
	let n = (0, l.useRef)(null), r = (0, l.useRef)(0), i = (0, l.useRef)(0), a = (0, l.useRef)(t), o = Oh(), { settings: s } = hd(), c = o === "mobile-portrait";
	return (0, l.useLayoutEffect)(() => {
		...
		let l = window.visualViewport, u = () => {
			if (ef()) return;
			let t = jh(o).getBoundingClientRect(), n = o.querySelector(".btable-mobile-hero-dock")?.getBoundingClientRect(), a = !!o.closest(".table-play-overlay"), u = c ? 104 : 92, d = c ? 210 : 168, f = qp(n?.height ?? 0, r.current, u, d);
			r.current = f.peak;
			let p = f.height, m = parseInt(getComputedStyle(o).getPropertyValue("--player-count").trim(), 10) || 4, h = m <= 4, g = !c, _ = (g && h ? kh("--mobile-fit-pad-x", 4) : kh("--mobile-fit-pad-x", 8)) + (g && a ? 4 : 12), v = (g && h ? kh("--mobile-fit-pad-y", 2) : kh("--mobile-fit-pad-y", 6)) + (g && a ? 4 : 10), y = kh("--mobile-fit-gap", c ? 8 : 6), b = l, x = Math.min(t.width, b?.width ?? window.innerWidth), S = Math.min(t.height, b?.height ?? window.innerHeight);
			if (a) {
				let e = Jp(Ah(o), i.current, 72);
...
function Nh({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: u = !1, showTrumpSuitReminder: d = !1, trumpHolderPresentation: f, privateHandReady: p = !1, currentUserId: m = null, legalPlayIndices: h, recommendedPlayIndex: _, recommendedDiscardIndices: v = [], handComplete: y = !1, actionFeedback: b, trickPresentation: x, handPresentation: S, microinteractions: C, instantTrickPlays: w = !1, turnCountdown: T = null, watchOnly: E = !1, bigPotEvent: D = null, onDismissTableEvent: O, onToggleInHand: k, onPassEnrollment: A, onTrickDelta: j, onSubmitDraw: M, onPassDraw: ee, onFoldDraw: te, onPlayCard: N, onHeroUserActivity: P }) {
	...
	let fe = new Set(e.participantIds.filter((t) => Cf(t, x.displayTricksByPlayer, e.participantIds, e.phase))), pe = I.map((t) => {
		let r = x.displayTricksByPlayer[t.playerId] ?? 0, i = x.trickWinnerSeatId === t.playerId, a = x.suppressTurnPlayerId || S.suppressTurnIndicator, o = a || E, s = x.phase === "collectTrick" && i, c = S.enrollmentPulse[t.playerId], l = S.animatingDrawPlayerId === t.playerId, u = wh(t.playerId, f, e.trumpUpcard ?? null, t.holeCardCount ?? 0, t.isSelf);
		return {
			...t,
			...u,
					...
					children: /* @__PURE__ */ (0, g.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, g.jsxs)("div", {
								...
								"aria-label": "Players at the table",
								children: [R.map((e, t) => {
									let n = Lp(t, L.length, F), r = pe.find((t) => t.playerId === e.playerId) ?? e;
									return /* @__PURE__ */ (0, g.jsx)("div", {
										className: `btable__seat-slot btable__seat-slot--${t}`,
										"data-seat-index": t + 1,
										children: /* @__PURE__ */ (0, g.jsx)(up, {
...
var Ph = new Set(["pot-cap", "hand-win"]);
function Fh({ events: e, onDismiss: t }) {
	let n = [...e].reverse().find((e) => Ph.has(e.kind));
	return (0, l.useEffect)(() => {
		if (!n) return;
...
function Wh({ session: e, potMetrics: t, participantIds: n }) {
...
function Xh(e) {
	...
	return e.phase === "reveal" ? fg(t, e) : t;
}
function Zh(e, t, n = {}) {
	return {
		...e,
...
function hg(e, t) {
	switch (t.type) {
		...
		case "serverUpdate": {
			...
			let o = Gh(a.trumpUpcard), s = Gh(n.trumpUpcard);
			...
			if (n.phase === "reveal" && e.phase === "ante" && !e.anteAnimActive && !e.trumpRevealActive) return fg(e, n);
			...
			if (n.phase === "reveal" && a.phase !== "reveal" && (e.phase === "idle" || e.phase === "nextHandReset" || e.phase === "enrollment" || e.phase === "settle" || e.phase === "play")) return fg(e, n);
...
function gg(e) {
	...
	switch (e.phase) {
		case "handReset": return Zh(e, "ante", {
			anteAnimActive: !0,
			pendingSnapshot: null
		});
		case "ante": return e.trumpRevealActive || t?.trumpUpcard ? Zh(e, "trumpReveal", {
			trumpRevealActive: !0,
			anteAnimActive: !1,
			pendingSnapshot: null
		}) : t?.phase === "draw" ? pg(e, t, 0, 0) : Zh(e, "drawPlayer", {
			anteAnimActive: !1,
			pendingSnapshot: null
		});
		...
		case "drawPlayer": {
			...
			sg("before", e);
			let n = e.animatingDrawPlayerId, r = cg(e, t);
			sg("after", r);
			...
			if (i) {
				let e = {
					...i,
					drawCompletedIds: [...r.displayDrawCompletedIds]
				}, t = ag(r, i, r.displayDrawCompletedIds);
				if (sg("after", r, {
					playerId: n,
					nextCompleted: r.displayDrawCompletedIds,
					nextChosen: t
				}), t) return og(r, i, t, "advancePhase:nextPlayer"), ug(r, e, t, 1, 1, "advancePhase:nextPlayer");
				og(r, i, null, "advancePhase:no-next-player");
			}
			return r;
		}
		case "drawReady": return Zh(e, "play", { pendingSnapshot: null });
		case "settle": return Zh(e, "nextHandReset", {
			settleAnimActive: !1,
			nextHandResetActive: !0,
			pendingSnapshot: null
		});
		case "nextHandReset": return t ? Xh(t) : Zh(e, "idle", { nextHandResetActive: !1 });
		default: return e;
	}
}
function _g(e) {
...
function Eg({ session: e, enrollmentActive: t, potAmount: n, handComplete: r, trickPipelineActive: i = !1, forceTrickHandEndDrain: a, heroCards: o = wg, enrolledIds: s = Cg, declinedIds: c = Cg, actionOrder: u }) {
	let d = e.participantIds.join(","), f = (e.drawCompletedIds ?? []).join(","), p = s.join(","), m = c.join(","), h = (u ?? e.participantIds).join(","), g = e.trumpUpcard ? `${e.trumpUpcard.rank}-${e.trumpUpcard.suit}` : "", _ = (0, l.useMemo)(() => Jh({
		...
		m,
		h
	]), v = Sg(e.sessionId, e.handNumber), y = _.phase ?? null, b = (0, l.useRef)(null), [x, S] = (0, l.useReducer)(mg, _, Xh), C = (0, l.useRef)([]), w = (0, l.useRef)([]), T = (0, l.useRef)(null), E = (0, l.useRef)(x);
	E.current = x;
	let D = () => {
	...
	(0, l.useEffect)(() => () => D(), []), (0, l.useEffect)(() => {
		...
		let t = b.current, n = o.map((e) => `${e.rank}-${e.suit}`), r = Tg(w.current, n);
		w.current = n, S({
			type: "serverUpdate",
			snapshot: _,
		...
		}, n), O(() => S({ type: "watchdog" }), x.phase === "drawPlayer" || x.phase === "drawReady" ? Hp : Vp);
	}, [
		x.handNumber,
		x.phase,
...
function Pg(e) {
	...
	return (0, l.useEffect)(() => {
		...
		countdown: t && r.current != null ? Ng(t, r.current, a) : null,
		reducedMotion: Qf()
	};
}
//#endregion
//#region src/table/feedback/turnTimerAudio.ts
var Fg = .48, Ig = 90, Lg = null, Rg = null;
function zg() {
	return Lg ||= new Gc.Howl({
		src: [`/sounds/${Zc.timer}`],
		loop: !0,
		volume: Fg,
		preload: !0
...
function Vg(e, t = {}) {
	...
	let i = t.fadeMs ?? Ig;
	if (i > 0 && e !== "overlap") {
		n.fade(Fg, 0, i, r), window.setTimeout(() => {
			n.stop(r);
		}, i + 20);
		return;
	}
...
function Hg(e) {
	...
	Rg != null && Vg("overlap", { fadeMs: 0 }), Jl("turn-timer-warning"), Ml.get().unlock();
	let t = zg().play();
	return typeof t == "number" ? (Rg = t, e.turnKey, e.turnKey, e.actorId, e.ringStartedAtMs, e.elapsedMs, !0) : !1;
}
//#endregion
...
function qg({ currentUserId: e = null, localActionPending: t = !1, ...n }) {
	let r = Mg(n), i = Ag({
		...n,
		activeActorId: r
	...
	(0, l.useEffect)(() => {
		if (!r) {
			u(), Bg() && Vg("turnChange"), s.current = !1, a.current = null, o.current = i;
			return;
		}
		if (i !== o.current || a.current == null) {
			u(), Bg() && Vg("turnChange"), s.current = !1, a.current = Date.now(), o.current = i;
			let e = a.current, t = i, n = Wg(e, Date.now()), l = () => {
				if (o.current !== t || s.current) return;
				let n = Gg(e, Date.now());
				Kg(n, s.current) && (s.current = !0, Hg({
					turnKey: t,
					actorId: r,
					ringStartedAtMs: e,
					elapsedMs: n
		...
		u(), Bg() && Vg("cleanup"), s.current = !1;
	}, []), (0, l.useEffect)(() => {
		!t || !Bg() || r == null || e == null || r !== e || (Vg("playerAction"), s.current = !1, u());
	}, [
		t,
		r,
		e
...
function Yg({ active: e, displayName: t }) {
...
function Qg(e) {
	...
	}, Xg), d) : (n("hidden"), i(0), d)), [e.activityKey, e.actionRequired]), (0, l.useEffect)(() => {
		if (t !== "pop") return;
		let e = Qf() ? 280 : 420;
...
function e_({ actionRequired: e, activityKey: t }) {
	let { phase: n, beat: r } = Qg({
		actionRequired: e,
		activityKey: t
	});
	if (n === "hidden") return null;
	let i = $g(), a = Math.min(r, 5);
	return /* @__PURE__ */ (0, g.jsx)("div", {
		className: [
			"byour-turn",
...
function t_({ actionFeedback: e, feedbackErrorPulse: t = 0, feedbackSuccessPulse: n = 0, turnLabel: r = null, isMyTurn: i = !1, showTurn: a = !1 }) {
...
function l_(e, t) {
	let n = qf(t.currentTrick), r = qf(e.prevTrick), i = o_(e, t, n), a = e.phase === "live" && !e.pendingResolution && (n.length < e.revealedCount && r.length >= e.revealedCount || n.length < i.length && r.length >= i.length), o = t.currentTrick?.trickNumber ?? null, s = e.prevTrick?.trickNumber ?? null, c = o != null && s != null && o !== s;
	return {
		...e,
...
function f_(e, t) {
	switch (t.type) {
		...
		case "forceHandEndDrain": {
			...
			for (let e = 0; e < 8 && t.phase !== "live"; e++) t = f_(t, { type: "advancePhase" });
			return t;
		}
...
function __({ phase: e, handNumber: t = 0, currentTrick: n, tricksByPlayer: r, participantIds: i, trumpSuit: a, playedCards: o, turnPlayerId: s, handComplete: c = !1 }) {
	let [u, d] = (0, l.useReducer)(d_, r, (e) => i_(e, n)), f = (0, l.useRef)([]), p = (0, l.useRef)(null), m = (0, l.useRef)(/* @__PURE__ */ new Set()), h = (0, l.useRef)(!1), g = (0, l.useRef)(null), _ = (0, l.useRef)(0), v = (0, l.useRef)(!1), y = (0, l.useRef)(t), b = (0, l.useRef)(u);
	b.current = u;
	...
	(0, l.useEffect)(() => () => w(), []), (0, l.useEffect)(() => {
		...
		v.current = S;
		let u = t !== y.current;
		if (y.current = t, u && t > 0) if (h_(b.current)) kd() && Ad("useTrickPresentation", "reinit-hand-number-deferred", {
			handNumber: t,
...
function y_(e, t) {
	return e.map((e) => v_(e, t)).join(" & ");
}
function b_(e, t) {
	return xf(e, t) ? t.filter((t) => (e[t] ?? 0) === 0) : [];
}
function x_(e) {
	let { tricksByPlayer: t, participantIds: n, players: r, pot: i, pendingVotes: a = {} } = e, o = wf(t, n), s = e.winnerIds?.length ? e.winnerIds : o.winnerIds, c = e.maxTricks ?? o.maxTricks, l = y_(s, r), u = b_(t, n), d = y_(u, r), f = Tf(i.maxWinThisHand), p = Tf(i.currentPot), m = i.carryIn > 0 ? Tf(i.carryIn) : null, h = `Pot this hand: ${p} (max win ${f})`;
	m && (h += ` — includes ${m} carried in`), i.limEnabled && i.overflow > 0 && (h += ` · LIM overflow ${Tf(i.overflow)} stays out of play`);
	let g = s.map((e) => {
		let n = t[e] ?? 0;
		return `${v_(e, r)} — ${n} trick${n === 1 ? "" : "s"}`;
...
function S_({ session: e, players: t, potMetrics: n, splitSharePerWinner: r, currentUserId: i, isCoWinner: a, manualContinueAllowed: o = !0, onSettle: s }) {
	let c = x_({
		tricksByPlayer: e.tricksByPlayer,
		participantIds: e.participantIds,
		players: t.map((e) => ({
...
var C_ = 3e3, w_ = 6e3;
function T_(e = "") {
	let t = String(e).trim().length, n = C_ + Math.min(t * 35, w_ - C_);
	return Math.max(C_, Math.min(n, w_));
}
//#endregion
...
function D_({ session: e, players: t, splitSharePerWinner: n, currentUserId: r, isCoWinner: i, resultMessage: a = "", manualContinueAllowed: o = !0, onAgreeSplit: s, onDeclineSplit: c, onCarryover: u }) {
	let d = e.pendingCoWinSettlement?.winnerIds ?? [], f = e.pendingCoWinSettlement?.votes ?? {}, p = (0, l.useMemo)(() => T_(a || "Tie — split the pot?"), [a]), [m, h] = (0, l.useState)(p), [_, v] = (0, l.useState)(!1), y = (0, l.useRef)(null), b = (0, l.useRef)(!1), x = (0, l.useMemo)(() => `${d.join(",")}:${e.handNumber ?? 0}`, [d, e.handNumber]);
	(0, l.useEffect)(() => {
	...
	let w = Math.max(0, Math.ceil(m / 1e3)), T = d.map((e) => E_(e, t)).join(" & "), E = o && !b.current, D = (e) => {
		!i || !E || (v(e), e ? s() : c());
	};
	return /* @__PURE__ */ (0, g.jsxs)("div", {
...
function O_(e, t, n) {
	let [r, i] = (0, l.useState)(!1), [a, o] = (0, l.useState)(!1), s = (0, l.useRef)(null), c = (0, l.useRef)(null), u = (0, l.useRef)(null), d = (0, l.useRef)(T_(n)), f = () => {
		c.current != null && (window.clearTimeout(c.current), c.current = null);
	};
	return (0, l.useEffect)(() => {
		if (f(), u.current !== t && (u.current = t, s.current = null, i(!1), o(!1), d.current = T_(n)), e) {
			if (s.current == null) {
				let e = Date.now();
				s.current = e, d.current = T_(n), i(!0), o(!1), kd() && Ad("tieResult", "shown", {
					proposalKey: t,
...
function M_(e, t) {
	return e.map((e) => A_(e, t)).filter((e) => e != null).sort((e, t) => e - t);
}
function N_(e) {
...
var P_ = [], F_ = [], I_ = [];
function L_({ session: e, players: t, potMetrics: n, mySessionNet: r, leaderLabel: i, showCoWinSettlement: a, splitPotEnabled: o = !1, rebuyEnabled: s = !1, splitSharePerWinner: c = 0, enrollmentActive: u = !1, currentUserId: d, heroCards: f = F_, rawHeroCards: p = F_, privateHandReady: m = !1, legalPlayIndices: h, recentBourreIds: _ = I_, handComplete: v = !1, actionFeedback: y, actions: b, watchOnly: x = !1, watchOnlyMessage: S, playNowModeLabel: C, idleStatusBanner: w }) {
	let { settings: T } = hd(), E = nm(), [D, O] = (0, l.useState)(!1), k = e.participantIds.length, { events: A, dismissEvent: j, pushReaction: M } = Wh({
		session: e,
		potMetrics: n,
		participantIds: e.participantIds
	}), ee = (0, l.useMemo)(() => [...A].reverse().find((e) => e.kind === "big-pot") ?? null, [A]), te = d != null && (e.pendingCoWinSettlement?.winnerIds || []).includes(d), N = __({
		phase: e.phase,
		handNumber: e.handNumber,
		...
		heroCards: f,
		enrolledIds: e.handEnrollment?.enrolledIds ?? P_,
		declinedIds: e.handEnrollment?.declinedIds ?? P_,
	...
	let L = (0, l.useMemo)(() => {
		...
		c,
		d
	]), { visible: z, manualContinueAllowed: B } = O_(a, L, R), V = r_(e.phase, e.trumpUpcard, N.displayPlays.length), H = zd(F.isPresenting, F.phase, e.phase), [ne, U] = (0, l.useState)(0);
	...
	let re = Fs(e.phase), ie = (0, l.useMemo)(() => Sh({
		...
		F.trumpMergeActive,
		F.trumpMergedIntoHand
	]), ae = W.displayCards, oe = (0, l.useMemo)(() => !h?.length || W.indexMode === "effective" ? h : j_(h, W.trumpDisabledIndex), [
		h,
		W.indexMode,
		...
		return t == null ? null : W.indexMode === "effective" ? t : j_([t], W.trumpDisabledIndex)[0] ?? null;
	}, [
		h,
		f,
		e.trumpSuit,
		...
		let t = f.map(Ms), n = W.indexMode === "display" && W.trumpDisabledIndex != null ? M_([W.trumpDisabledIndex], W.trumpDisabledIndex) : W.trumpDisabledIndex == null ? [] : [W.trumpDisabledIndex], r = zc(t, e.trumpSuit ?? "clubs", e.maxDrawDiscards ?? 4, e.remainingDeckCount ?? Infinity, n);
		return W.indexMode === "effective" ? r : j_(r, W.trumpDisabledIndex);
	}, [
		e.phase,
		f,
		e.trumpSuit,
		...
		W.indexMode,
		W.trumpDisabledIndex
	]), le = N.suppressTurnPlayerId || F.suppressTurnIndicator, ue = Ns(e.phase, u), de = x || le ? null : Rs(e.turnPlayerId, t), fe = t.find((e) => e.isSelf), pe = d != null && e.participantIds.includes(d) && (e.phase === "draw" || e.phase === "play"), me = !x && s && !e.isFinal && !pe && !z && fe?.isOut === !0 && !!b.onRebuy, he = bh({
		currentUserId: d,
		session: e,
		suppressTurn: !!le,
		handComplete: v,
		...
		handComplete: v,
		watchOnly: x
	}), ve = (0, l.useMemo)(() => t.filter((e) => e.idleSitOut).map((e) => e.playerId), [t]), { countdown: ye } = Pg({
		session: e,
		suppressTurn: !!le,
		handComplete: v,
		sitOutPlayerIds: ve,
	...
	let be = ie.showTrumpSuitReminder || !e.trumpUpcard && !!e.trumpSuit && e.phase === "play", xe = (0, l.useMemo)(() => ({ ...N.displayTricksByPlayer }), [N.displayTricksByPlayer]), Se = (0, l.useMemo)(() => Object.fromEntries(t.map((e) => [e.playerId, Math.max(0, Number(e.bankroll) || 0)])), [t]), Ce = Jg({
		turnPlayerId: e.turnPlayerId ?? null,
		dealerId: e.dealerId,
	...
	let De = (0, l.useCallback)((e) => {
		...
		onSubmitDraw: (e) => {
			...
			let t = W.indexMode === "display" ? M_(e, W.trumpDisabledIndex) : e;
		...
		onPlayCard: (e) => {
			...
			let t = M_([e], W.trumpDisabledIndex)[0];
		...
		E ? /* @__PURE__ */ (0, g.jsx)(Nh, { ...G }) : /* @__PURE__ */ (0, g.jsx)(Th, { ...G })
	] }), Ae = (0, l.useRef)(!1);
	return (0, l.useEffect)(() => {
		Ae.current = !1;
		...
		children: [
			...
			E ? /* @__PURE__ */ (0, g.jsx)(Lh, { children: /* @__PURE__ */ (0, g.jsxs)("div", {
				className: "btable-stage",
				children: [/* @__PURE__ */ (0, g.jsx)(t_, {
					actionFeedback: y,
			...
			}) }) : /* @__PURE__ */ (0, g.jsx)(Ih, { children: /* @__PURE__ */ (0, g.jsxs)("div", {
				className: "btable-stage",
				children: [/* @__PURE__ */ (0, g.jsx)(t_, {
					actionFeedback: y,
					feedbackErrorPulse: Ce.feedbackErrorPulse,
			...
			z && !e.isFinal && o && /* @__PURE__ */ (0, g.jsx)(D_, {
				session: e,
				players: t,
				splitSharePerWinner: c,
				currentUserId: d,
			...
			z && !e.isFinal && !o && /* @__PURE__ */ (0, g.jsx)(S_, {
				session: e,
				players: t,
				potMetrics: n,
				splitSharePerWinner: c,
...
var R_ = null, z_ = null;
function B_(e, t) {
	Ru(), Ko(e), z_ !== e && (R_?.unmount(), R_ = (0, u.createRoot)(e), z_ = e), R_.render(/* @__PURE__ */ (0, g.jsx)(md, { children: /* @__PURE__ */ (0, g.jsx)(L_, { ...t }) }));
}
function V_() {
	z_ && (zm(z_), um(z_)), R_?.unmount(), R_ = null, z_ = null, Wd(), wd(), Gd(), Td(), nf();
}
//#endregion
export { um as clearDrawFlyGhosts, zm as clearWonTrickCollectionArtifacts, Vd as evaluateBotPresentationGate, Bd as forceReleasePresentationForBots, gl as getFeedbackPrefs, Ld as getTablePresentationBlockReason, Kd as getTrickAnimationBusyState, zd as handPresentingBlocksBots, Ru as initGameFeedback, Jd as isTablePresentationBusy, Hd as isTablePresentationBusyForBots, qd as isTrickAnimationBusy, B_ as mountTableSession, Uu as playBigWinFeedback, Wu as playBourreFeedback, Gu as playBourrePrivatePunishmentFeedback, Xu as playCardSelectFeedback, Yu as playDeleteRoomFeedback, Vu as playDrawFeedback, Qu as playFoldFeedback, Ku as playGameStartFeedback, Ju as playOpenRoomFeedback, zu as playShuffleFeedback, Hu as playTrickWinFeedback, Zu as playUiButtonFeedback, _l as saveFeedbackPrefs, bl as subscribeFeedbackPrefs, Yd as subscribeTrickAnimationBusy, V_ as unmountTableSession };
