...
function fc(e, t) {
	...
	sc(n, i, oc[n], r) || tc(n, "ante-chip-play-failed", {
		handNumber: e,
		playerIndex: t,
		key: i
	});
...
function wf({ session: e, heroCards: t, privateHandReady: n = !1, handPresentationPhase: r, tableRootRef: i }) {
	...
	return (0, l.useLayoutEffect)(() => {
		...
		let p = hf(f, 5);
		if (!p.length) return;
		s.current = u, Sf(), xf(a), a.classList.add("btable-wrap--clockwise-dealing"), o(!0), El(!0), Gc({
			delayMs: 80,
			force: !0
		});
...
function Rf(e, t, n, r = {}) {
	...
	let o = Af(e), s = e.querySelector(".bpot__ante-pile");
	if (!o || !s) return !1;
	s.classList.add("bpot__ante-pile--active");
	let c = R(), l = Tf(a.length, c) / 1e3, u = L(160 / 1e3, c), d = q.timeline({ onComplete: () => {
...
function Bf({ phase: e, handNumber: t, anteAnimActive: n, participantIds: r, anteAmount: i, tableRootRef: a, onAntePresentationComplete: o }) {
	...
	return d.current = o, (0, l.useLayoutEffect)(() => {
		...
		if (s.length) return c(0), Rf(o, t, s, {
			onLand: (e, n) => {
				qc(t, n), c((e) => e + 1);
			},
			onComplete: () => {
