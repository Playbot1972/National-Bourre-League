...
function Gc({ cards: e, phase: t, enrollmentActive: n = !1, isInHand: r = !1, isDealer: i = !1, signedIn: a = !1, isMyTurn: o = !1, drawCompleted: s = !1, maxDrawDiscards: c = 4, legalPlayIndices: u, handComplete: d = !1, actionFeedback: f, onSubmitDraw: p, onPassDraw: m, onFoldDraw: h, onPlayCard: _, privateHandReady: v = !1, className: y = "", dealStaggerMs: b = 120, drawAnimSubPhase: x = null, currentUserId: S = null, revealedTrumpIndex: C = null, trumpMergeActive: w = !1, trumpDisabledIndex: T = null }) {
	...
	let me = t === "draw", he = t === "play", ge = E.cardScale === "lg" ? "md" : "sm", H = P || f?.status === "loading" || j !== null, _e = f?.status === "error" ? f.message : ne, ve = ls(t, n), ye = (0, l.useCallback)((e) => {
		H || T === e || (I(null), O((t) => {
			let n = new Set(t);
...
function sl(e, t) {
	let { rx: n, ry: r, outset: i } = nl(t), a = e / t * Math.PI * 2 + Math.PI / 2, o = Math.cos(a), s = Math.sin(a);
	return {
		x: 50 + n * o + o * i,
		y: 50 + r * s + s * i,
		region: rl(a)
...
function cl(e, t) {
	...
	if (n === 7) {
		if (e === 2 || e === 4 || e === 6) return al[e];
		if (e === 0 || e === 1 || e === 3 || e === 5) return ol[e];
	}
	return n >= 8 && (e === 1 || e === 7) ? il[e] : sl(e, n);
}
function ll(e) {
...
function Il(e) {
	...
	if (s <= o) return null;
	let c = Fl(t, n, r), l = i?.trickNumber ?? s, u = Z({
		prevTrick: i,
		playedCards: a,
		trickNumber: l
	});
...
function Wl(e, t, n, r) {
	let i = Ul(e, t, n), a = Math.max(152, n);
	return {
...
function ru({ aspect: e, enabled: t = !0, sessionKey: n }) {
	let r = (0, l.useRef)(null), i = (0, l.useRef)(0), a = (0, l.useRef)(n), { settings: o } = Hc(), s = Ql();
	return (0, l.useLayoutEffect)(() => {
		...
		let l = c.closest(".btable-desktop__viewport") ?? c.closest(".table-play-overlay__main") ?? c.closest(".btable-session"), u = window.visualViewport, d = () => {
			let t = !!c.closest(".table-play-overlay"), n = typeof window < "u" && window.matchMedia("(orientation: portrait)").matches, r = nu(c, s).getBoundingClientRect(), a = c.querySelector(".hand-panel")?.getBoundingClientRect(), l = t && s && n ? 100 : t && !s ? 120 : s ? 112 : 148, d = t && s && n || t && !s ? 200 : s ? 210 : 280, f = a?.height ?? 0, p = Wl(f, i.current, l, d);
			i.current = p.peak;
			let m = p.height, h = s && t ? 12 : s ? 18 : t && !s ? 16 : 28, g = $l("--stage-fit-pad-x", s ? 8 : 16) + h, _ = $l("--stage-fit-pad-y", s ? 6 : 12) + h, v = $l("--stage-fit-gap", s ? 8 : 12), y = u, b = Math.min(r.width, y?.width ?? window.innerWidth), x = Math.min(r.height, y?.height ?? window.innerHeight);
			if (t && s) {
				let e = tu(c);
			...
			let S = Math.max(.85, Math.min(1.35, o.tableScale || 1)), C = t && s ? 1 : S, w = s ? Gl(e, { portrait: n }) : e, T = parseInt(getComputedStyle(c).getPropertyValue("--player-count").trim(), 10) || 4, E = t && s && !n, D = E ? {
				...ql({
					availWidth: b,
					availHeight: x,
					aspect: w,
			...
			if (c.style.setProperty("--stage-fit-width", `${Math.round(k)}px`), c.style.setProperty("--stage-fit-height", `${Math.round(A)}px`), c.style.setProperty("--stage-fit-scale", String(D.fitScale)), c.style.setProperty("--stage-effective-scale", String(j)), (c.closest(".btable-desktop__scale") ?? c.parentElement)?.style.setProperty("--stage-effective-scale", String(j)), localStorage.getItem("stageFitDebug") === "1") {
				let e = c.querySelector(".table-stage"), a = c.querySelectorAll(".bseat__avatar-wrap"), o = e ? Yl(e.getBoundingClientRect()) : null, l = Yl(document.documentElement.getBoundingClientRect()), u = [...a].filter((e) => !Xl(Yl(e.getBoundingClientRect()), l, 1)).length;
...
function ou(e, t, n, r, i) {
	...
	let a = t.showRevealedTrumpAtHolder ? au(r) : null;
	return {
...
function su({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: l = !1, showTrumpSuitReminder: u = !1, trumpHolderPresentation: d, privateHandReady: f = !1, currentUserId: p = null, legalPlayIndices: m, handComplete: h = !1, actionFeedback: _, trickPresentation: v, handPresentation: y, microinteractions: b, onToggleInHand: x, onPassEnrollment: S, onTrickDelta: C, onSubmitDraw: w, onPassDraw: T, onFoldDraw: E, onPlayCard: D, onReaction: O }) {
	let k = t.map((e) => ({
	...
	})), A = yl(k, e, p), j = A.length, M = `btable--p${Math.min(8, Math.max(2, j))}`, N = ll(j), ee = Object.fromEntries(k.map((e) => [e.playerId, e.displayName])), te = Vl(), P = ru({
		aspect: N,
		...
		let r = v.displayTricksByPlayer[t.playerId] ?? 0, i = v.trickWinnerSeatId === t.playerId, a = v.suppressTurnPlayerId || y.suppressTurnIndicator, o = v.phase === "collectTrick" && i, s = y.enrollmentPulse[t.playerId], c = y.animatingDrawPlayerId === t.playerId, l = ou(t.playerId, d, e.trumpUpcard ?? null, t.holeCardCount ?? 0, t.isSelf);
		return {
			...t,
			...l,
...
var lu = "(orientation: portrait)";
function uu() {
	let e = Ql(), [t, n] = (0, l.useState)(() => typeof window < "u" && window.matchMedia(lu).matches);
	return (0, l.useEffect)(() => {
		let e = window.matchMedia(lu), t = () => n(e.matches);
...
function mu({ aspect: e, sessionKey: t }) {
	let n = (0, l.useRef)(null), r = (0, l.useRef)(0), i = (0, l.useRef)(t), a = uu(), { settings: o } = Hc(), s = a === "mobile-portrait";
	return (0, l.useLayoutEffect)(() => {
		...
		let c = window.visualViewport, l = () => {
			let t = pu(a).getBoundingClientRect(), n = a.querySelector(".btable-mobile-hero-dock")?.getBoundingClientRect(), i = !!a.closest(".table-play-overlay"), l = s ? 104 : 92, u = s ? 210 : 168, d = Wl(n?.height ?? 0, r.current, l, u);
			r.current = d.peak;
...
function hu({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], revealedTrumpIndex: o = null, trumpMergeActive: s = !1, trumpDisabledIndex: c = null, hideCenterTrump: l = !1, showTrumpSuitReminder: u = !1, trumpHolderPresentation: d, privateHandReady: f = !1, currentUserId: p = null, legalPlayIndices: m, handComplete: h = !1, actionFeedback: _, trickPresentation: v, handPresentation: y, microinteractions: b, onToggleInHand: x, onPassEnrollment: S, onTrickDelta: C, onSubmitDraw: w, onPassDraw: T, onFoldDraw: E, onPlayCard: D }) {
	let O = uu() === "mobile-landscape" ? "landscape" : "portrait", k = t.map((e) => ({
		...e,
		isSelf: e.isSelf || p != null && e.playerId === p
	})), A = yl(k, e, p), j = A.filter((e) => !e.isSelf), M = A.find((e) => e.isSelf), N = M ? Ol(A.length) : null, ee = A.length, te = `btable--p${Math.min(8, Math.max(2, ee))}`, P = cu(j.length, O), F = Object.fromEntries(t.map((e) => [e.playerId, e.displayName])), ne = Vl(), I = mu({
		aspect: P,
		sessionKey: `${e.sessionId}:${e.handNumber}`
...
function _u({ events: e, onDismiss: t }) {
	let n = [...e].reverse().find((e) => gu.has(e.kind));
	return (0, l.useEffect)(() => {
		if (!n) return;
...
function vu({ children: e }) {
	let { settings: t } = Hc(), n = t.layoutMode === "tiled", r = Ql();
	return /* @__PURE__ */ (0, g.jsx)("div", {
		className: [
			"btable-desktop",
...
function bu({ events: e, onDismiss: t }) {
...
function Eu({ session: e, potMetrics: t, participantIds: n }) {
...
function Iu(e, t, n, r) {
	...
	return i ? Pu(e, t, i, n, r) : ju(e, "drawPlayer", {
		displayDrawCompletedIds: [],
		prevSnapshot: t
	});
}
function Lu(e, t) {
	switch (t.type) {
		case "reset": return Au(t.snapshot);
		...
		case "watchdog": return Date.now() - e.phaseStartedAt < 12e3 ? e : e.pendingHandSettle && e.phase === "play" ? Fu(e) : Ru({
			...e,
			pendingSnapshot: e.pendingSnapshot ?? e.prevSnapshot
		});
		case "tryBeginHandSettle": return Fu(e);
		case "advancePhase": return Ru(e);
		case "serverUpdate": {
			let { snapshot: n, heroDrawDiscardCount: r = 0, heroDrawReplaceCount: i = 0 } = t, a = e.prevSnapshot ?? n;
			if (e.sessionKey !== n.sessionKey) return Au(n);
			if (n.phase === "play" && e.phase !== "play") return ju(e, "play", {
			...
			if (Du(e.phase) && e.phase !== "drawPlayer" || e.phase === "drawPlayer" && e.drawAnimSubPhase !== "done") return {
				...e,
				pendingSnapshot: n
			};
			...
			let o = Mu(a, n), s = Object.keys(o).length > 0;
			...
			if (n.phase === "reveal" && a.phase !== "reveal" && (e.phase === "idle" || e.phase === "nextHandReset" || e.phase === "enrollment")) return ju(e, "ante", {
			...
			if (n.phase === "draw" && a.enrollmentActive && !n.enrollmentActive && e.phase === "enrollment") {
				let t = !!n.trumpUpcard;
				return ju(e, t ? "trumpReveal" : "ante", {
					trumpRevealActive: t,
					anteAnimActive: !0,
					dealStaggerCount: Math.max(e.dealStaggerCount, n.participantIds.length),
					prevSnapshot: n,
			...
			if (n.phase === "draw" && (e.phase === "decision" || a.phase === "decision")) return Iu(e, n, 0, 0);
			if (n.phase === "draw") {
				let t = Nu(a, n);
				if (t && e.phase !== "drawReady") {
					let a = r > 0 || i > 0, o = a ? r : t === n.turnPlayerId ? 0 : 1;
					return Pu(e, n, t, o, a ? i : o);
				}
				if (n.drawCompletedIds.length === n.participantIds.length && n.participantIds.length > 0 && e.phase === "drawPlayer" && e.drawAnimSubPhase === "done") return ju(e, "drawReady", { prevSnapshot: n });
			}
			return {
				...e,
				prevSnapshot: n,
...
function Ru(e) {
	...
	switch (e.phase) {
		case "handReset": return ju(e, "ante", {
			anteAnimActive: !0,
			pendingSnapshot: null
		});
		case "ante": return e.trumpRevealActive || t?.trumpUpcard ? ju(e, "trumpReveal", {
			trumpRevealActive: !0,
			anteAnimActive: !1,
			pendingSnapshot: null
		}) : t?.phase === "draw" ? Iu(e, t, 0, 0) : ju(e, "drawPlayer", {
			anteAnimActive: !1,
			pendingSnapshot: null
		});
		...
		case "drawPlayer": {
			...
			if (i && r.length >= i.participantIds.length) return ju(e, "drawReady", {
			...
			if (i) {
				...
				if (t && i.drawCompletedIds.includes(t)) return Pu(e, i, t, 1, 1);
			}
			return {
				...e,
				displayDrawCompletedIds: r,
		...
		case "drawReady": return ju(e, "play", { pendingSnapshot: null });
		case "settle": return ju(e, "nextHandReset", {
			settleAnimActive: !1,
			nextHandResetActive: !0,
			pendingSnapshot: null
		});
		case "nextHandReset": return t ? Au(t) : ju(e, "idle", { nextHandResetActive: !1 });
		default: return e;
	}
}
function zu(e) {
...
function Bu(e, t = !1) {
	...
	switch (e.phase) {
		...
		case "drawPlayer": return Hl(e.drawAnimSubPhase === "receive" ? 0 : e.drawDiscardCount, e.drawAnimSubPhase === "receive" ? e.drawReplaceCount : 0, t);
...
function Wu({ session: e, enrollmentActive: t, potAmount: n, handComplete: r, trickPipelineActive: i = !1, heroCards: a = Hu, enrolledIds: o = Vu, declinedIds: s = Vu, actionOrder: c }) {
	let u = (0, l.useMemo)(() => Ou({
		...
		s,
		c
	]), [d, f] = (0, l.useReducer)(Lu, u, Au), p = (0, l.useRef)([]), m = (0, l.useRef)([]), h = (0, l.useRef)(""), g = () => {
	...
	return (0, l.useEffect)(() => () => g(), []), (0, l.useEffect)(() => {
		let e = a.map((e) => `${e.rank}-${e.suit}`), t = Uu(m.current, e);
		m.current = e, f({
			type: "serverUpdate",
			snapshot: u,
		...
		let e = Ll(), t = `${d.phase}:${d.animatingDrawPlayerId ?? ""}:${d.drawAnimSubPhase}:${d.phaseStartedAt}`;
		if (h.current === t) return;
		h.current = t, g();
		let n = Bu(d, e);
		n <= 0 || (_(() => f({ type: "advancePhase" }), n), _(() => f({ type: "watchdog" }), Bl));
	}, [
		d.phase,
...
function Ku({ active: e, displayName: t }) {
	let [n, r] = (0, l.useState)(!1), i = Ll();
	return (0, l.useEffect)(() => {
		if (!e) {
			r(!1);
			return;
...
function Yu(e) {
	...
	let d = () => {
		...
		let e = c.current, t = e === 0 ? qu : Ju[Math.min(e - 1, Ju.length - 1)];
...
function Zu({ actionRequired: e, activityKey: t }) {
	let { phase: n, beat: r } = Yu({
		actionRequired: e,
		activityKey: t
	});
	if (n === "hidden") return null;
	let i = Xu(), a = Math.min(r, 5);
	return /* @__PURE__ */ (0, g.jsx)("div", {
		className: [
			"byour-turn",
...
function nd(e, t) {
	let n = X(t.currentTrick), r = X(e.prevTrick), i = e.phase === "live" && !e.pendingResolution && n.length < e.revealedCount && r.length >= e.revealedCount;
	return {
		...e,
...
function id(e, t) {
	switch (t.type) {
		...
		case "revealNextCard": {
			...
			let t = e.pendingResolution?.frozen.plays.length ?? X(e.prevTrick).length;
...
function ad(e, t) {
	let n = X(t), r = e.pendingResolution?.frozen.plays ?? [], i = r.length > 0 ? r : n.length > 0 ? n : X(e.prevTrick), a = e.phase === "live" ? i.slice(0, Math.min(e.revealedCount, i.length)) : e.frozenTrick?.plays ?? [], o = e.phase === "live" || e.phase === "trickComplete" ? null : e.frozenTrick?.winnerId ?? null, s = e.showWinnerTag && (e.phase === "winnerReveal" || e.phase === "collectTrick");
	return {
		phase: e.phase,
		displayPlays: a,
		winnerPlayerId: o,
...
function od({ phase: e, currentTrick: t, tricksByPlayer: n, participantIds: r, trumpSuit: i, playedCards: a }) {
	let [o, s] = (0, l.useReducer)(id, n, (e) => ed(e, t)), c = (0, l.useRef)([]), u = (0, l.useRef)(null), d = (0, l.useRef)(/* @__PURE__ */ new Set()), f = o.phase !== "live" || !!o.pendingResolution, p = e === "play", m = (e) => {
		for (let t of e) {
			let e = gs(t);
	...
	(0, l.useEffect)(() => () => h(), []), (0, l.useEffect)(() => {
		...
		let t = o.frozenTrick, n = Pl({
			trumpBeat: Q(t.plays, t.leadSuit, i),
			reducedMotion: Ll()
		});
		...
		let t = Ll() ? 308 : 560, n = window.setTimeout(() => s({ type: "commitTrickResolution" }), t);
		return () => window.clearTimeout(n);
	}, [
		p,
		f,
	...
	return (0, l.useEffect)(() => {
		...
		let e = Ll() ? 308 : 560, t = window.setTimeout(() => s({ type: "revealNextCard" }), e);
...
function ud(e) {
	let { tricksByPlayer: t, participantIds: n, players: r, pot: i, pendingVotes: a = {} } = e, o = Xc(t, n), s = e.winnerIds?.length ? e.winnerIds : o.winnerIds, c = e.maxTricks ?? o.maxTricks, l = cd(s, r), u = ld(t, n), d = cd(u, r), f = Y(i.maxWinThisHand), p = Y(i.currentPot), m = i.carryIn > 0 ? Y(i.carryIn) : null, h = `Pot this hand: ${p} (max win ${f})`;
...
function dd({ session: e, players: t, potMetrics: n, splitSharePerWinner: r, currentUserId: i, isCoWinner: a, onSettle: o }) {
	let s = ud({
		tricksByPlayer: e.tricksByPlayer,
		participantIds: e.participantIds,
		players: t.map((e) => ({
...
function pd(e, t) {
	...
	let n = fd(t), r = e.findIndex((e) => fd(e) === n);
	return r >= 0 ? r : null;
}
function md(e, t) {
	return [...e];
...
function gd(e) {
	let t = !!(e.playerId && e.trumpHolderId && e.playerId === e.trumpHolderId), n = !!e.trumpUpcard, r = t && n ? pd(e.rawHeroCards, e.trumpUpcard) : null, i = !n && !!e.trumpSuit && e.phase === "play";
	...
	let { trumpRevealActive: a, trumpMergeActive: o, trumpMergedIntoHand: s } = e.handPresentation, c = iu({
...
var _d = [], vd = [], $ = [];
function yd({ session: e, players: t, potMetrics: n, mySessionNet: r, leaderLabel: i, showCoWinSettlement: a, splitSharePerWinner: o = 0, enrollmentActive: s = !1, enrollmentSecondsLeft: c = 0, currentUserId: u, heroCards: d = vd, rawHeroCards: f = vd, privateHandReady: p = !1, legalPlayIndices: m, recentBourreIds: h = $, handComplete: _ = !1, actionFeedback: v, actions: y }) {
	let { settings: b } = Hc(), x = Ql(), [S, C] = (0, l.useState)(!1), w = e.participantIds.length, { events: T, dismissEvent: E, pushReaction: D } = Eu({
		session: e,
		potMetrics: n,
		participantIds: e.participantIds
	}), O = u != null && (e.pendingCoWinSettlement?.winnerIds || []).includes(u), k = t.find((e) => e.isSelf && (e.canToggleInHand || e.canPassEnrollment)), A = od({
		phase: e.phase,
		...
		heroCards: d,
		enrolledIds: e.handEnrollment?.enrolledIds ?? _d,
		declinedIds: e.handEnrollment?.declinedIds ?? _d,
		actionOrder: e.handEnrollment?.orderedPlayerIds ?? e.participantIds
	}), M = ds(e.phase), N = j.phase === "decision" && M, ee = !!k && (fs(e.phase) || ps(e.phase) && N), te = !!k && !ee && !M, P = (0, l.useMemo)(() => iu({
		...
		j.trumpMergeActive,
		j.trumpMergedIntoHand
	]), ne = F.displayCards, I = (0, l.useMemo)(() => !m?.length || F.indexMode === "effective" ? m : md(m, F.trumpDisabledIndex), [
		m,
		F.indexMode,
		F.trumpDisabledIndex
	]), L = A.suppressTurnPlayerId || j.suppressTurnIndicator, re = ls(e.phase, s), R = L ? null : ms(e.turnPlayerId, t), z = t.find((e) => e.isSelf), ie = !!(u && e.turnPlayerId === u) && !L, ae = Qu({
		currentUserId: u,
		enrollmentActive: s,
		selfPlayer: z,
		session: e,
		...
		suppressTurn: !!L,
		handComplete: _
	}), oe = P.showTrumpSuitReminder || !e.trumpUpcard && !!e.trumpSuit && e.phase === "play", V = (0, l.useMemo)(() => ({ ...A.displayTricksByPlayer }), [A.displayTricksByPlayer]), se = (0, l.useMemo)(() => Object.fromEntries(t.map((e) => [e.playerId, Math.max(0, Number(e.bankroll) || 0)])), [t]), ce = Gu({
		turnPlayerId: e.turnPlayerId ?? null,
		dealerId: e.dealerId,
	...
	let fe = {
		...
		onSubmitDraw: (e) => {
			...
			let t = F.indexMode === "display" ? hd(e, F.trumpDisabledIndex) : e;
		...
		onPlayCard: (e) => {
			...
			let t = hd([e], F.trumpDisabledIndex)[0];
		...
		x ? /* @__PURE__ */ (0, g.jsx)(hu, { ...he }) : /* @__PURE__ */ (0, g.jsx)(su, { ...he })
	] }), H = (0, l.useRef)(!1);
	return (0, l.useEffect)(() => {
		H.current = !1;
		...
		children: [
			...
			x ? /* @__PURE__ */ (0, g.jsx)(yu, { children: /* @__PURE__ */ (0, g.jsx)("div", {
				className: "btable-stage",
				children: ge
			}) }) : /* @__PURE__ */ (0, g.jsx)(vu, { children: /* @__PURE__ */ (0, g.jsx)("div", {
				className: "btable-stage",
				children: ge
			}) }),
			/* @__PURE__ */ (0, g.jsx)(Su, {
			...
			a && !e.isFinal && /* @__PURE__ */ (0, g.jsx)(dd, {
				session: e,
				players: t,
				potMetrics: fe,
			...
			/* @__PURE__ */ (0, g.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, g.jsx)(xu, { compact: !0 }), r == null ? /* @__PURE__ */ (0, g.jsx)(g.Fragment, { children: "Shared pot and game state only · sign in to track your ledger" }) : /* @__PURE__ */ (0, g.jsxs)(g.Fragment, { children: ["Your session net ", Qc(r)] })]
			})
		]
	});
}
...
var bd = null, xd = null;
function Sd(e, t) {
	Tc(), Uo(e), xd !== e && (bd?.unmount(), bd = (0, u.createRoot)(e), xd = e), bd.render(/* @__PURE__ */ (0, g.jsx)(Vc, { children: /* @__PURE__ */ (0, g.jsx)(yd, { ...t }) }));
}
function Cd() {
	bd?.unmount(), bd = null, xd = null;
}
//#endregion
export { oc as getFeedbackPrefs, Tc as initGameFeedback, Sd as mountTableSession, Oc as playBigWinFeedback, Ec as playShuffleFeedback, Dc as playTrickWinFeedback, sc as saveFeedbackPrefs, lc as subscribeFeedbackPrefs, Cd as unmountTableSession };
