...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	function za(e) {
		...
		function l(e, t, n, r) {
			var a = n.type;
			return a === y ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === a || typeof a == "object" && a && a.$$typeof === D && Aa(a) === t.type) ? (t = i(t, n.props), La(t, n), t.return = e, t) : (t = gi(n.type, n.key, n.props, null, e.mode, r), La(t, n), t.return = e, t);
		}
		function u(e, t, n, r) {
	...
	function kc(e, t, n) {
		...
		if (s ? (o = o & 1 | 2, t.flags |= 128) : o &= 1, M(R, o), ac(e, t, r, n), r = I ? Ei : 0, !s && e !== null && e.flags & 128) a: for (e = t.child; e !== null;) {
	...
	function Mc(e, t, n) {
		switch (t.tag) {
			case 3:
				he(t, t.stateNode.containerInfo), Zi(t, L, e.memoizedState.cache), Gi();
				break;
			case 27:
			case 5:
				_e(t);
	...
	function zc(e, t, n) {
		...
		switch (Fi(t), t.tag) {
			...
			case 3: return n = t.stateNode, r = null, e !== null && (r = e.memoizedState.cache), t.memoizedState.cache !== r && (t.flags |= 2048), Qi(L), ge(), n.pendingContext && (n.context = n.pendingContext, n.pendingContext = null), (e === null || e.child === null) && (Wi(t) ? Pc(t) : e === null || e.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024, Ki())), U(t), null;
			case 26:
			...
			case 19:
				...
				if (i = (t.flags & 128) != 0, a = r.rendering, a === null) if (i) Rc(r, !1);
					...
					if (X !== 0 || e !== null && e.flags & 128) for (e = t.child; e !== null;) {
						if (a = po(e), a !== null) {
							...
							return M(R, R.current & 1 | 2), I && Mi(t, r.treeForkCount), t.child;
						}
						e = e.sibling;
					}
				...
				return r.tail === null ? (U(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Ae(), e.sibling = null, n = R.current, M(R, i ? n & 1 | 2 : n & 1), I && Mi(t, r.treeForkCount), e);
			case 22:
	...
	function Bc(e, t) {
		switch (Fi(t), t.tag) {
			...
			case 3: return Qi(L), ge(), e = t.flags, e & 65536 && !(e & 128) ? (t.flags = e & -65537 | 128, t) : null;
			case 26:
			case 27:
	...
	function Cu(e, t) {
		z = null, k.H = zs, t === wa || t === Ea ? (t = Ma(), Y = 3) : t === Ta ? (t = Ma(), Y = 4) : Y = t === rc ? 8 : typeof t == "object" && t && typeof t.then == "function" ? 6 : 1, Bl = t, q === null && (X = 1, Zs(e, Si(t, e.current)));
	}
	function wu() {
		var e = ao.current;
...
function vn(e, t) {
	let n = !!e.closest(".table-play-overlay"), r = e.closest(".table-play-overlay__main");
	if (n && t && r) {
		let t = e.closest(".btable-session");
		if (!t) return 0;
		let n = 0, r = t.querySelector(".btable-session__head"), i = t.querySelector(".btable-session__foot"), a = t.querySelector(".btable-session__settle");
		return r && (n += r.getBoundingClientRect().height), i && i.offsetParent !== null && (n += i.getBoundingClientRect().height), a && a.offsetParent !== null && (n += a.getBoundingClientRect().height), n + 4;
	}
	let i = e.closest(".btable-session");
	if (!i) return 0;
	let a = 0, o = i.querySelector(".btable-session__head"), s = i.querySelector(".btable-session__foot"), c = i.querySelector(".btable-session__settle");
	return o && (a += o.getBoundingClientRect().height), s && s.offsetParent !== null && (a += s.getBoundingClientRect().height), c && c.offsetParent !== null && (a += c.getBoundingClientRect().height), t && (a += 4), a;
}
function yn(e, t) {
...
function bn({ aspect: e, enabled: t = !0, sessionKey: n }) {
	let r = (0, l.useRef)(null), i = (0, l.useRef)(0), a = (0, l.useRef)(n), { settings: o } = kt(), s = gn();
	return (0, l.useLayoutEffect)(() => {
		...
		let l = c.closest(".btable-desktop__viewport") ?? c.closest(".table-play-overlay__main") ?? c.closest(".btable-session"), u = window.visualViewport, d = () => {
			let t = !!c.closest(".table-play-overlay"), n = typeof window < "u" && window.matchMedia("(orientation: portrait)").matches, r = yn(c, s).getBoundingClientRect(), a = c.querySelector(".hand-panel")?.getBoundingClientRect(), l = t && s && n ? 100 : t && !s ? 120 : s ? 112 : 148, d = t && s && n || t && !s ? 200 : s ? 210 : 280, f = a?.height ?? 0, p = ln(f, i.current, l);
			i.current = p.peak;
			let m = Math.min(t && s && f > 0 ? Math.max(f, l) : p.height, d), h = s ? 22 : t && !s ? 16 : 28, g = _n("--stage-fit-pad-x", s ? 8 : 16) + h, _ = _n("--stage-fit-pad-y", s ? 6 : 12) + h, v = _n("--stage-fit-gap", s ? 8 : 12), y = u, b = Math.min(r.width, y?.width ?? window.innerWidth), x = Math.min(r.height, y?.height ?? window.innerHeight);
			t && s && (x = Math.max(160, x - vn(c, s)));
			let S = Math.max(.85, Math.min(1.35, o.tableScale || 1)), C = s ? un(e, { portrait: n }) : e, w = t && s && !n, T = w ? {
				...dn({
					availWidth: b,
					availHeight: x,
					aspect: C,
			...
			c.classList.toggle("btable-wrap--landscape-row", w);
			let E = s || t, ee = E ? T.displayStageWidth : T.stageWidth, D = E ? T.displayStageHeight : T.stageHeight, O = t && !s ? S : s ? 1 : T.effectiveScale;
			if (c.style.setProperty("--stage-fit-width", `${Math.round(ee)}px`), c.style.setProperty("--stage-fit-height", `${Math.round(D)}px`), c.style.setProperty("--stage-fit-scale", String(T.fitScale)), c.style.setProperty("--stage-effective-scale", String(O)), (c.closest(".btable-desktop__scale") ?? c.parentElement)?.style.setProperty("--stage-effective-scale", String(O)), localStorage.getItem("stageFitDebug") === "1") {
		...
		m instanceof HTMLElement && f.observe(m);
...
function xn({ session: e, players: t, potMetrics: n, participantCount: r, enrollmentActive: i = !1, heroCards: a = [], privateHandReady: o = !1, currentUserId: s = null, legalPlayIndices: c, handComplete: l = !1, actionFeedback: u, trickPresentation: d, handPresentation: f, microinteractions: p, onToggleInHand: m, onTrickDelta: h, onSubmitDraw: _, onPassDraw: v, onPlayCard: y, onReaction: b }) {
	let x = [...t].sort((e, t) => e.isSelf ? -1 : t.isSelf ? 1 : e.displayName.localeCompare(t.displayName)), S = x.findIndex((e) => e.isSelf), C = S > 0 ? [...x.slice(S), ...x.slice(0, S)] : x, w = C.length, T = `btable--p${Math.min(8, Math.max(2, w))}`, E = zt(w), ee = Object.fromEntries(t.map((e) => [e.playerId, e.displayName])), D = sn(), O = bn({
		aspect: E,
...
function Cn({ events: e, onDismiss: t }) {
	let n = [...e].reverse().find((e) => Sn.has(e.kind));
	return (0, l.useEffect)(() => {
		if (!n) return;
...
function wn({ children: e }) {
	let { settings: t } = kt(), n = t.layoutMode === "tiled", r = gn();
	return /* @__PURE__ */ (0, g.jsx)("div", {
		className: [
			"btable-desktop",
...
function Tn({ events: e, players: t, onDismiss: n }) {
...
function jn({ session: e, potMetrics: t, participantIds: n }) {
...
function Bn(e, t, n, r) {
	...
	return i ? zn(e, t, i, n, r) : In(e, "drawPlayer", {
		displayDrawCompletedIds: [],
		prevSnapshot: t
	});
}
function Vn(e, t) {
	switch (t.type) {
		...
		case "serverUpdate": {
			...
			if (Mn(e.phase) && e.phase !== "drawPlayer" || e.phase === "drawPlayer" && e.drawAnimSubPhase !== "done") return {
				...e,
				pendingSnapshot: n
			};
			let o = Ln(a, n), s = Object.keys(o).length > 0;
			...
			if (n.phase === "draw" && a.enrollmentActive && !n.enrollmentActive && e.phase === "enrollment") {
				let t = !!n.trumpUpcard;
				return In(e, t ? "trumpReveal" : "ante", {
					trumpRevealActive: t,
					anteAnimActive: !0,
			...
			if (n.phase === "draw") {
				...
				if (n.drawCompletedIds.length === n.participantIds.length && n.participantIds.length > 0 && e.phase === "drawPlayer" && e.drawAnimSubPhase === "done") return In(e, "drawReady", { prevSnapshot: n });
			}
			return n.handComplete && n.phase === "play" && e.phase === "play" ? In(e, "settle", {
				settleAnimActive: !0,
...
function Hn(e) {
	...
	switch (e.phase) {
		case "handReset": return In(e, "ante", {
			anteAnimActive: !0,
			pendingSnapshot: null
		});
		case "ante": return e.trumpRevealActive || t?.trumpUpcard ? In(e, "trumpReveal", {
			trumpRevealActive: !0,
			anteAnimActive: !1,
			pendingSnapshot: null
		}) : t?.phase === "draw" ? Bn(e, t, 0, 0) : In(e, "drawPlayer", {
			anteAnimActive: !1,
			pendingSnapshot: null
		});
		case "trumpReveal": return t?.phase === "draw" ? Bn(e, t, 0, 0) : In(e, "drawPlayer", {
			trumpRevealActive: !1,
			pendingSnapshot: null
		});
		case "drawPlayer": {
			...
			if (i && r.length >= i.participantIds.length) return In(e, "drawReady", {
		...
		case "drawReady": return In(e, "play", { pendingSnapshot: null });
		case "settle": return In(e, "nextHandReset", {
			settleAnimActive: !1,
			nextHandResetActive: !0,
			pendingSnapshot: null
		});
		case "nextHandReset": return t ? Fn(t) : In(e, "idle", { nextHandResetActive: !1 });
		default: return e;
	}
}
function Un(e) {
...
function Jn({ session: e, enrollmentActive: t, potAmount: n, handComplete: r, heroCards: i = Kn, enrolledIds: a = Gn, declinedIds: o = Gn, actionOrder: s }) {
	let c = (0, l.useMemo)(() => Nn({
		...
		o,
		s
	]), [u, d] = (0, l.useReducer)(Vn, c, Fn), f = (0, l.useRef)([]), p = (0, l.useRef)([]), m = (0, l.useRef)(""), h = () => {
	...
	return (0, l.useEffect)(() => () => h(), []), (0, l.useEffect)(() => {
		let e = i.map((e) => `${e.rank}-${e.suit}`), t = qn(p.current, e);
		p.current = e, d({
			type: "serverUpdate",
			snapshot: c,
...
function nr({ phase: e, currentTrick: t, tricksByPlayer: n, participantIds: r, trumpSuit: i }) {
	let [a, o] = (0, l.useReducer)(er, n, (e) => Xn(e, t)), s = (0, l.useRef)([]), c = (0, l.useRef)(null), u = (0, l.useRef)(/* @__PURE__ */ new Set()), d = (e) => {
		for (let t of e) {
			let e = A(t);
...
function or(e) {
	let { tricksByPlayer: t, participantIds: n, players: r, pot: i, pendingVotes: a = {} } = e, o = Mt(t, n), s = e.winnerIds?.length ? e.winnerIds : o.winnerIds, c = e.maxTricks ?? o.maxTricks, l = ir(s, r), u = ar(t, n), d = ir(u, r), f = Nt(i.maxWinThisHand), p = Nt(i.currentPot), m = i.carryIn > 0 ? Nt(i.carryIn) : null, h = `Pot this hand: ${p} (max win ${f})`;
	m && (h += ` — includes ${m} carried in`), i.limEnabled && i.overflow > 0 && (h += ` · LIM overflow ${Nt(i.overflow)} stays out of play`);
	let g = s.map((e) => {
		let n = t[e] ?? 0;
		return `${rr(e, r)} — ${n} trick${n === 1 ? "" : "s"}`;
...
function sr({ session: e, players: t, potMetrics: n, splitSharePerWinner: r, currentUserId: i, isCoWinner: a, onSettle: o }) {
	let s = or({
		tricksByPlayer: e.tricksByPlayer,
		participantIds: e.participantIds,
		players: t.map((e) => ({
...
var cr = [], lr = [];
function ur({ session: e, players: t, potMetrics: n, mySessionNet: r, myHandContribution: i, leaderLabel: a, showCoWinSettlement: o, splitSharePerWinner: s = 0, enrollmentActive: c = !1, enrollmentSecondsLeft: u = 0, currentUserId: d, heroCards: f = lr, privateHandReady: p = !1, legalPlayIndices: m, handComplete: h = !1, actionFeedback: _, actions: v }) {
	let { settings: y } = kt(), b = gn(), [x, S] = (0, l.useState)(!1), C = e.participantIds.length, { events: w, dismissEvent: T, pushReaction: E } = jn({
		session: e,
		potMetrics: n,
		participantIds: e.participantIds
	}), ee = d != null && (e.pendingCoWinSettlement?.winnerIds || []).includes(d), D = t.find((e) => e.isSelf && e.canToggleInHand), O = nr({
		phase: e.phase,
		...
		handComplete: h,
		heroCards: f,
		enrolledIds: e.handEnrollment?.enrolledIds ?? cr,
		declinedIds: e.handEnrollment?.declinedIds ?? cr,
		actionOrder: e.handEnrollment?.orderedPlayerIds ?? e.participantIds
	}), ne = O.suppressTurnPlayerId || te.suppressTurnIndicator, ie = re(e.phase, c), k = ne ? null : oe(e.turnPlayerId, t), A = ae(e.phase), se = !!(d && e.turnPlayerId === d) && !ne, ce = !e.trumpUpcard && !!e.trumpSuit && e.phase === "play", le = (0, l.useMemo)(() => ({ ...O.displayTricksByPlayer }), [O.displayTricksByPlayer]), ue = Yn({
		turnPlayerId: e.turnPlayerId ?? null,
		dealerId: e.dealerId,
	...
	return (0, l.useEffect)(() => {
		...
		children: [
			...
			/* @__PURE__ */ (0, g.jsx)(wn, { children: /* @__PURE__ */ (0, g.jsxs)("div", {
			...
			o && !e.isFinal && /* @__PURE__ */ (0, g.jsx)(sr, {
				session: e,
				players: t,
				potMetrics: de,
			...
			/* @__PURE__ */ (0, g.jsxs)("footer", {
				...
				children: [/* @__PURE__ */ (0, g.jsx)(En, { compact: !0 }), r == null ? /* @__PURE__ */ (0, g.jsx)(g.Fragment, { children: "Shared pot and game state only · sign in to track your ledger" }) : /* @__PURE__ */ (0, g.jsxs)(g.Fragment, { children: [
...
var dr = null, fr = null;
function pr(e, t) {
	ft(), fr !== e && (dr?.unmount(), dr = (0, u.createRoot)(e), fr = e), dr.render(/* @__PURE__ */ (0, g.jsx)(Ot, { children: /* @__PURE__ */ (0, g.jsx)(ur, { ...t }) }));
}
function mr() {
	dr?.unmount(), dr = null, fr = null;
}
//#endregion
export { Je as getFeedbackPrefs, ft as initGameFeedback, pr as mountTableSession, ht as playBigWinFeedback, pt as playShuffleFeedback, mt as playTrickWinFeedback, Ye as saveFeedbackPrefs, Ze as subscribeFeedbackPrefs, mr as unmountTableSession };
